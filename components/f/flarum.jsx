...
</style><defs><linearGradient id="SVGxNQ7vgKV" x1="50%" x2="50%" y1="100%" y2="0%"><stop offset="0%" class="uphz-4baw"/><stop offset="100%" class="o_fqm04wh"/></linearGradient><linearGradient id="SVG8pHnxc4I" x1="50%" x2="50%" y1="0%" y2="100%"><stop offset="0%" class="pqpecwbqj"/><stop offset="100%" class="ztuc-udhu"/></linearGradient></defs><path fill="url(#SVGxNQ7vgKV)" class="iwu_1770q"/><path fill="url(#SVG8pHnxc4I)" class="x4cogdcio"/><path fill="url(#SVG8pHnxc4I)" class="qplyh503u"/>`,
		"fallback": "logos:flarum",
	});
}
