...
</style><g class="nrj6p8qat"><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="c8tpvpbrt"/><path class="ep4ucvyqx"/><path class="ccgk_xb3n"/><path class="n5-c_fbmx"/></g>`,
		"fallback": "iconmind:sbom-outline-regular",
	});
}
