...
</style><defs><radialGradient cx="59.17%" cy="15.556%" fx="59.17%" fy="15.556%" r="47.54%" id="ssvg-id-supportkita"><stop offset="0%" class="acveexbty"/><stop offset="100%" class="qu_8c7bwu"/></radialGradient></defs><path fill="url(#ssvg-id-supportkita)" class="erhppnbww"/>`,
		"fallback": "logos:supportkit",
	});
}
