...
</style><path class="ngpmpqbbo"/><path class="q7_6racbg"/><path class="l_xyl8gdb"/><path class="pltvod1_y"/>`,
		"fallback": "twemoji:face-with-steam-from-nose",
	});
}
