...
</style><g class="nrj6p8qat"><path class="zey5ebc0a"/><path class="r7dhdp-mq"/><path class="umr6jbb1c"/><path class="j7phtvv5f"/><path class="ceatt7y_b"/></g>`,
		"fallback": "iconmind:microtask-outline-regular",
	});
}
