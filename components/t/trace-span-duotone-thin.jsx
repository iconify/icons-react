...
</style><g class="hntgybcog"><path class="tvqildb1v"/><path class="ge02uk2xx"/><path class="uwn-88-lo"/><path class="crv4i00bu"/><path class="gxfvqwb6p"/><path class="mpqxuepwm"/><path class="lc1sr-eqo"/></g>`,
		"fallback": "iconmind:trace-span-duotone-thin",
	});
}
