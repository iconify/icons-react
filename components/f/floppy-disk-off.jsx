...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="t2bk_kbrv"/><path clip-rule="evenodd" class="rhm3nr4pu"/><path class="xedf9ccsf"/></g>`,
		"fallback": "pepicons-pop:floppy-disk-off",
	});
}
