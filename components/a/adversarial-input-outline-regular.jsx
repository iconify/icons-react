...
</style><g class="nrj6p8qat"><path class="iymet_cml"/><path class="vc5bmsqzd"/><path class="uhawluh-v"/><path class="w41b5cbwu"/></g>`,
		"fallback": "iconmind:adversarial-input-outline-regular",
	});
}
