...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="a5r0_s7lj"/><path class="wib5uabwc"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:loop-minus-circle-off",
	});
}
