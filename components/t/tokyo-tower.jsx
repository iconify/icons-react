...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="e26382krx"/><path class="go8d8xbng"/><path class="x_dohzbxr"/><path class="nrq4j3bnd"/><path class="cq8w_lb1f"/><path class="v4bzu2blw"/><path class="pbu0kib4w"/><path class="mdmuobbsd"/><path class="j8v_x7bxz"/><path class="tul_kj4rv"/><g class="brzn_0bpr"><path class="mn_7utkxt"/><path class="zj2o__b5x"/><path class="v4hfqds2r"/></g>`,
		"fallback": "openmoji:tokyo-tower",
	});
}
