...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.ihmsq2j2p {
  d: path("M6 21V9M18 11.5V15M15.5 3L20.5 8M20.5 3L15.5 8");
}
...
</style><g class="nrj6p8qat"><path class="ihmsq2j2p"/><path class="jmypdibrj"/></g>`,
		"fallback": "keyline-icons:git-pull-request-closed-fill",
	});
}
