...
</style><g class="hntgybcog"><path class="okud9xj_d"/><path class="amqvwsm7z"/><path class="zohykibek"/><path class="j6affxbcq"/><path class="nl66y9men"/></g>`,
		"fallback": "iconmind:statefulset-outline-thin",
	});
}
