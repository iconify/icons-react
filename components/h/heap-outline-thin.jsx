...
</style><g class="hntgybcog"><path class="a-v3knb-a"/><path class="bjo0kbbwk"/><path class="x4l5r-bat"/><path class="hrm50umfz"/><path class="lwlflab4b"/></g>`,
		"fallback": "iconmind:heap-outline-thin",
	});
}
