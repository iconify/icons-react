...
</style><g class="nrj6p8qat"><path class="dl2nz2boo"/><path clip-rule="evenodd" class="ympx8bc9r"/><path class="xw2-rqb8f"/></g>`,
		"fallback": "keyline-icons:table-cells-split-duotone",
	});
}
