...
.r32sm4drq {
  d: path("M240 88v96H48V72h176a16 16 0 0 1 16 16");
  opacity: var(--svg-opacity--0-2, 0.2);
}
</style><g class="cuyn6tgcc"><path class="r32sm4drq"/><path class="ast7ohbzr"/></g>`,
		"fallback": "ph:trolley-duotone",
	});
}
