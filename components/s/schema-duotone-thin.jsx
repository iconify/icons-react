...
</style><g class="hntgybcog"><path class="x15-b37rj"/><path class="jt094dn-t"/><path class="c4my-jbpv"/><path class="xios20bld"/><path class="ha2bk5bpt"/></g>`,
		"fallback": "iconmind:schema-duotone-thin",
	});
}
