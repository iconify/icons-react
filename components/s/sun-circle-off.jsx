...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="y3gjmeqpc"/><path class="tvegkiq6y"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:sun-circle-off",
	});
}
