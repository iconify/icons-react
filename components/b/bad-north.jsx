...
</style><path class="deq5xsb2x"/><circle class="hhs0td5jm"/><path class="edx63cb6g"/><path class="iurkcwz3h"/><path class="t8pot72id"/>`,
		"fallback": "arcticons:bad-north",
	});
}
