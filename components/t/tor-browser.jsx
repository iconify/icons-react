...
</style><defs><linearGradient id="SVGSYAajeNN" x1="50%" x2="50%" y1="100%" y2="0%"><stop offset="0%" class="euezyny1x"/><stop offset="100%" class="sci2_fjrw"/></linearGradient></defs><circle class="z0d5_ibur"/><path fill="url(#SVGSYAajeNN)" class="s4euzls6s"/><path fill="url(#SVGSYAajeNN)" transform="matrix(-1 0 0 1 140.5 0)" class="sq1tfvhki"/>`,
		"fallback": "logos:tor-browser",
	});
}
