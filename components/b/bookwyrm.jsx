...
</style><path class="mckwxjb0v"/><path class="z45racbwa"/><path class="bdjp-obhn"/><path class="yfj07tbfz"/><circle class="qez5pexvn"/><path class="a7jb20pla"/><path class="qvnadev6l"/>`,
		"fallback": "arcticons:bookwyrm",
	});
}
