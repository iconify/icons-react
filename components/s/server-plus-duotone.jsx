...
</style><g class="nrj6p8qat"><path class="ibfob3b8f"/><path class="aimqgdczn"/><path class="q-qndji8q"/></g>`,
		"fallback": "keyline-icons:server-plus-duotone",
	});
}
