...
</style><g class="hntgybcog"><path class="eig2f9b_m"/><path class="nhcnsbcub"/><path class="ic00xab8f"/><path class="vf7cpzbkg"/><path class="wue-zto0n"/></g>`,
		"fallback": "iconmind:headphones-duotone-thin",
	});
}
