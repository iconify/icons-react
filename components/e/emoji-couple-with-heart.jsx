...
</style><path class="e6m5tzbly"/><path class="aiye20bvh"/><path class="agcxyrbqz"/><path class="p8mgg-vdn"/>`,
		"fallback": "arcticons:emoji-couple-with-heart",
	});
}
