...
</style><path class="lilgt_v7n"/><path class="v14rkgb-e"/><path class="hus4d3gtc"/><path class="lyyspibig"/><path class="xn8b1hbpi"/><path class="nighzlb7s"/><path class="imxoxcbeq"/><path class="w2irxcbrk"/><path class="kr_8asb4h"/><path class="qnmec_jbd"/><path class="u02kzvcny"/><path class="tmki56pov"/><path class="fed7fjpvi"/><path class="qqtfvrblb"/><path class="h86fc2bnf"/><path class="ctbzdab_l"/>`,
		"fallback": "twemoji:woman-office-worker-dark-skin-tone",
	});
}
