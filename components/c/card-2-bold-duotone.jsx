...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path class="ad4x7oblk"/><path clip-rule="evenodd" class="vju4z7oep"/><path class="j9na07rou"/><path class="m0a5tpbcr"/><path class="o1cpgsbzo"/></g>`,
