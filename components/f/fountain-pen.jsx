...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ep_f5ybrc"/><path class="o97he-bzi"/><path class="u174xlzub"/><path class="e8vxz1far"/><path class="bx6zd5b-o"/><path class="cygn92x2h"/><path class="wb0k2xv3r"/><path class="f1pjwzbdo"/><path class="d3_z73k3j"/><path class="biftdhc6z"/><path class="jt8o77b6h"/><path class="m303-xbto"/>`,
		"fallback": "streamline-emojis:fountain-pen",
	});
}
