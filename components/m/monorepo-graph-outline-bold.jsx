...
</style><g class="s0phu2bbs"><path class="jrpnc2pnl"/><path class="swzjdoakn"/><path class="gp6zu7b7w"/><path class="vcu2yzb_j"/><path class="c8tpvpbrt"/><path class="a5a5iacnl"/></g>`,
		"fallback": "iconmind:monorepo-graph-outline-bold",
	});
}
