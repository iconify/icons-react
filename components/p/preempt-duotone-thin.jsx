...
</style><g class="hntgybcog"><path class="kta-v8eyv"/><path class="ntx9fibnq"/><path class="pxmcfjbnu"/><path class="bh4gsivfq"/><path class="wugddgejd"/></g>`,
		"fallback": "iconmind:preempt-duotone-thin",
	});
}
