...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="q0rquab4m"/><path class="cxnnz0b1p"/><path class="s353xd64o"/><circle class="z-itscb-x"/><circle class="crgxpcbmq"/><g class="org_7jb0n"><path class="hajfknb4m"/><circle class="b6k3tgccg"/></g><path class="nj-44yn_w"/><circle class="zv237tb5r"/><path class="r594d2bll"/><path class="hr6_0tnzh"/><ellipse class="r-mdnlbql"/>`,
		"fallback": "flat-color-icons:camera-identification",
	});
}
