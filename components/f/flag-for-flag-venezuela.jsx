...
</style><path class="w-3au5bfd"/><path class="mzjaklbwa"/><path class="v_z3tcb_y"/><path class="zq16gm9ok"/>`,
		"fallback": "emojione-v1:flag-for-flag-venezuela",
	});
}
