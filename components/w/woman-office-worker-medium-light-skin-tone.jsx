...
</style><path class="lilgt_v7n"/><path class="v14rkgb-e"/><path class="hus4d3gtc"/><path class="lyyspibig"/><path class="xn8b1hbpi"/><path class="nighzlb7s"/><path class="imxoxcbeq"/><path class="xxe056b0w"/><path class="ohzu0rbym"/><path class="v270jobwx"/><path class="c_wqnsznv"/><path class="tmki56pov"/><path class="kcz03n36z"/><path class="aoidqwb_m"/><path class="evj7xpb5p"/><path class="fai1m2bvy"/>`,
		"fallback": "twemoji:woman-office-worker-medium-light-skin-tone",
	});
}
