...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.b9h8_k21c {
  fill: none;
  stroke: currentColor;
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M32.827 24.526v2.183c0 .893-.724 1.617-1.617 1.617h0c-.447 0-.851-.18-1.144-.474");
}
...
.t5k0or6lb {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M32.827 21.857v2.669c0 .893-.724 1.617-1.617 1.617h0a1.617 1.617 0 0 1-1.618-1.617v-2.669");
}
...
</style><path class="i9clfwm2k"/><path class="b9h8_k21c"/><path class="t5k0or6lb"/><rect class="ty_qnh7mo"/><path class="qu188cbsw"/>`,
