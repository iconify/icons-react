...
</style><g class="hntgybcog"><path class="xfs8wlfhn"/><path class="ygr1bbcag"/><path class="b2n99wbku"/><path class="uy7nmfbhi"/></g>`,
		"fallback": "iconmind:lock-alert-outline-thin",
	});
}
