...
Browse all icons: [preview Unicons on Iconify](https://icon-sets.iconify.design/uil/)

## Installation

```bash
npm install github:iconify/icons-react#uil
```
...
```jsx
import SampleIcon from '@iconify-react/uil/arrow-circle-right';
...
```jsx
import SampleIcon from '@iconify-react/uil/chat-bubble-user';
...
```jsx
import SampleIcon from '@iconify-react/uil/edit-alt';
