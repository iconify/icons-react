...
</style><path class="gvg6xcbtb"/><path class="yw2a8mhug"/><path id="SVG3P1CZbeQ" class="xaooiibrb"/><use href="#SVG3P1CZbeQ" transform="translate(5.07)"/><path class="exhzmzydl"/>`,
		"fallback": "vscode-icons:file-type-vroom",
	});
}
