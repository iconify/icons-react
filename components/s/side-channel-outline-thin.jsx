...
</style><g class="hntgybcog"><path class="xfs8wlfhn"/><path class="iml3cbclx"/><path class="ckctb4ljv"/><path class="wxrq2_b_h"/><path class="ivqg9reic"/></g>`,
		"fallback": "iconmind:side-channel-outline-thin",
	});
}
