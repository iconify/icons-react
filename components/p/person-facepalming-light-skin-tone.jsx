...
</style><path class="xjd6l3p5r"/><path class="b__xj1bdq"/><path class="ajxgcybdc"/><ellipse class="gcufa2bhz"/><path class="zlioanbmh"/><path class="fj88vbc6w"/><path class="ei_1ngb6b"/><path class="uelg3yuuc"/><path class="ytaft7bol"/><path class="lfi4pgbmd"/><path class="zo5-9mdnb"/><path class="vp4l7jkbz"/><path class="gxnev5b2s"/><path class="mno-v7e9r"/><defs><path id="SVGudEVS6BX" class="zo56_0bpy"/></defs><use href="#SVGudEVS6BX" class="u46is_brm"/>`,
		"fallback": "noto-v1:person-facepalming-light-skin-tone",
	});
}
