...
Browse all icons: [preview Jam Icons on Iconify](https://icon-sets.iconify.design/jam/)

## Installation

```bash
npm install github:iconify/icons-react#jam
```
...
```jsx
import SampleIcon from '@iconify-react/jam/chevrons-square-up-right';
...
```jsx
import SampleIcon from '@iconify-react/jam/luggage-f';
...
```jsx
import SampleIcon from '@iconify-react/jam/rubber';
