...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="jjj7wqb2x"/><path class="m54tlsbie"/><path class="o0i9ywbxy"/><path class="oxl4gpt9o"/><path class="xfj18ccsg"/><g class="rpvb-o6bq"><path class="dewzj81_r"/><path class="fyd1iwvkf"/><path class="slwmpacou"/><path class="s9txnzoac"/><path class="wffccubix"/><path class="qtw74ob2i"/><path class="okq5gd7io"/></g>`,
		"fallback": "openmoji:bug",
	});
}
