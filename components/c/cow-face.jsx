...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="obeyg0bao"/><path class="f-2icjb3s"/><path class="oulxb_boa"/><path class="v9zd7im2r"/><path class="ma1wmibnc"/><path class="k0zmq-opt"/><path class="dcrl0dbdv"/><path class="nr0wsb-gq"/>`,
		"fallback": "openmoji:cow-face",
	});
}
