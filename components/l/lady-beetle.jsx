...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<ellipse class="tqcdsoh4h"/><ellipse class="i0333fbud"/><path class="n6cuv8bhy"/><ellipse class="g_bv2r-7z"/><path class="p45n56bfq"/><circle class="sgj4lac9m"/><circle class="bnk72cb2h"/><circle class="wgoainkts"/><circle class="b_vbndibo"/><circle class="n29ja5-0t"/><circle class="e00hyybiu"/><path class="artixtdso"/>`,
		"fallback": "openmoji:lady-beetle",
	});
}
