...
</style><g class="s0phu2bbs"><path class="jfvoq9bhn"/><path class="slz7u0oyn"/><path class="h7bcztycq"/><path class="pkaragbav"/></g>`,
		"fallback": "iconmind:migration-down-outline-bold",
	});
}
