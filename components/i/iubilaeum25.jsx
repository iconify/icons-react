...
</style><path class="s2hmp3u8i"/><path class="ll-p5np5z"/><path class="vwy-jozet"/><path class="bl5p_sy_s"/><path class="v6xnq3rpo"/><path class="o8ufljbln"/><path class="pju_4x2wv"/><path class="l57twacsi"/><ellipse class="z1gxp8eaf"/><ellipse class="q29nkbb-k"/><ellipse class="o617vjbgu"/><ellipse class="uul_k0y4q"/><path class="xknzb2b0i"/>`,
		"fallback": "arcticons:iubilaeum25",
	});
}
