...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="bvkc79bpm"><circle class="xy-e8bcsj"/><circle class="oo94-4crs"/><path class="xnkb47b9o"/><circle class="l8wsdgbip"/><circle class="dthqtrf0t"/><circle class="p-tplcb_f"/></g><circle class="ax4oe2b_j"/><g class="xktd_nb9m"><circle class="v0wvotb-g"/><circle class="aknqk7bxm"/></g><path class="w7v2i1xoz"/>`,
		"fallback": "flat-color-icons:binoculars",
	});
}
