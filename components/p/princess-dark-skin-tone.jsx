...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="hwtf52b2y"/><path class="kbuay5b_y"/><path class="jlaf5jb2q"/><path class="tj2_hylcq"/><path class="xet5mybbh"/><path class="sjv8lrb5m"/><path class="ixy0vklsb"/><path class="hniumccqz"/><path class="t_mrjsbkh"/><path class="xuv5lg21j"/>`,
		"fallback": "openmoji:princess-dark-skin-tone",
	});
}
