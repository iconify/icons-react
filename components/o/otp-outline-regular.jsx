...
</style><g class="nrj6p8qat"><path class="oh4p-ccfe"/><path class="it83nbbll"/><path class="a_lj6jt5i"/><path class="s4ceatb9m"/><path class="o3p_nrbww"/></g>`,
		"fallback": "iconmind:otp-outline-regular",
	});
}
