...
</style><g class="nrj6p8qat"><path class="pquf1ccxc"/><path class="qv4k8z3yq"/><path class="y0y0ccsoe"/><path class="c4e1y7wvc"/></g>`,
		"fallback": "iconmind:foreign-key-outline-regular",
	});
}
