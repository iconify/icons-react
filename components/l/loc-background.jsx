...
</style><g class="ft5dv1b6b"><g clip-path="url(#SVGHcSWxdhd)"><path class="mumfproca"/><path class="lmqoe6bel"/><path class="ww604zb1w"/><path class="v-rlbifku"/><path class="os-x9p34q"/><path class="n8yb0wb1h"/></g><defs><clipPath id="SVGHcSWxdhd"><path class="py7ktqbvf"/></clipPath></defs></g>`,
		"fallback": "token-branded:loc-background",
	});
}
