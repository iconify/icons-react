...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="t0miq4bvi"/><path class="gckzqt99c"/><path class="a9jxvcc4g"/><path class="lvyyhqkcc"/><path class="clcbfrbak"/><path class="i5l844bry"/><path class="pxt53ybyr"/><path class="o39cccc8r"/><path class="jkk3-2btj"/><path class="kc4b0t-4l"/>`,
		"fallback": "selfhst:pulseweaver",
	});
}
