...
</style><g class="hntgybcog"><path class="em3t3yypy"/><path class="eul_zebdq"/><path class="gwnaabclj"/><path class="rj_0p5bah"/></g>`,
		"fallback": "iconmind:cascade-delete-outline-thin",
	});
}
