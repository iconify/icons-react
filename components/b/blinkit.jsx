...
</style><circle class="uob9racrf"/><path class="qd5h3b0tj"/><circle class="qf_qmdb8f"/><path class="enn7qbbny"/><rect class="j3s9ivbxi"/>`,
		"fallback": "arcticons:blinkit",
	});
}
