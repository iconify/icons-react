...
</style><g class="s0phu2bbs"><path class="ni20md-jo"/><path class="j6o0shbiv"/><path class="uesvxd39h"/><path class="y059x9b5k"/></g>`,
		"fallback": "iconmind:mcp-server-check-outline-bold",
	});
}
