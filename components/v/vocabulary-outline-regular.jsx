...
</style><g class="nrj6p8qat"><path class="zrwkhybyf"/><path class="hg1j_lbce"/><path class="il4f-53br"/><path class="uv-0dacjj"/><path class="mf-afdped"/></g>`,
		"fallback": "iconmind:vocabulary-outline-regular",
	});
}
