...
</style><path class="v9erbbbht"/><path class="sawt_g-bm"/><path class="ywac3ibpj"/><path class="oproo5hcv"/>`,
		"fallback": "vscode-icons:folder-type-light-node-opened",
	});
}
