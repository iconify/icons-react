...
```bash
npm install github:iconify/icons-react#flat-ui
```
...
```jsx
import SampleIcon from '@iconify-react/flat-ui/map';
...
```jsx
import SampleIcon from '@iconify-react/flat-ui/graph';
