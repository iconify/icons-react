...
</style><g class="s0phu2bbs"><path class="oh4p-ccfe"/><path class="n-059ea3n"/><path class="llakqobuk"/><path class="knng32dgc"/></g>`,
		"fallback": "iconmind:extension-lead-outline-bold",
	});
}
