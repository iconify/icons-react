...
</style><g class="hntgybcog"><path class="viv5gg8xx"/><path class="cpvk0-0_c"/><path class="iszcsrkrx"/><path class="y__nh_wml"/></g>`,
		"fallback": "iconmind:sandbox-escape-outline-thin",
	});
}
