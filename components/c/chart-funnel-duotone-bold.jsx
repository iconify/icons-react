...
</style><g class="s0phu2bbs"><path class="leyp3bzem"/><path class="ev_ydexnh"/><path class="y0v_ii4rs"/><path class="mvnsiebhs"/><path class="i-508daov"/><path class="y31d99bmp"/></g>`,
		"fallback": "iconmind:chart-funnel-duotone-bold",
	});
}
