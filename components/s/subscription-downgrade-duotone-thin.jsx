...
</style><g class="hntgybcog"><path class="n7c_b1bsn"/><path class="a218-cpca"/><path class="tl2fjsrpp"/><path class="amujw3_wp"/></g>`,
		"fallback": "iconmind:subscription-downgrade-duotone-thin",
	});
}
