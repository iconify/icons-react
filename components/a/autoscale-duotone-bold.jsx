...
</style><g class="s0phu2bbs"><path class="bevpulxmu"/><path class="y5oq56bif"/><path class="cnllexbmp"/><path class="kvksesm4i"/><path class="fddkg0b5z"/><path class="jtvi3oeim"/></g>`,
		"fallback": "iconmind:autoscale-duotone-bold",
	});
}
