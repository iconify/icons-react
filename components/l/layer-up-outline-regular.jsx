...
</style><g class="nrj6p8qat"><path class="gqua-bbkg"/><path class="fo_ekznwu"/><path class="v1ku6ibql"/><path class="ltjpzfbzq"/></g>`,
		"fallback": "iconmind:layer-up-outline-regular",
	});
}
