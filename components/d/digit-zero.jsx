...
</style><linearGradient id="ssvg-id-digit-zeroa" gradientUnits="userSpaceOnUse" x1="64.01" y1="101.193" x2="64.01" y2="29.735"><stop offset=".485" class="fboms9lpk"/><stop offset="1" class="vlzxxcccm"/></linearGradient><path fill="url(#ssvg-id-digit-zeroa)" class="g-1p2pbnh"/>`,
		"fallback": "noto:digit-zero",
	});
}
