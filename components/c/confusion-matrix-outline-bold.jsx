...
</style><g class="s0phu2bbs"><path class="nzpsuduik"/><path class="ae-e09b3w"/><path class="h2-2dgnfu"/><path class="tip34zbqw"/><path class="o5ex3bb1u"/></g>`,
		"fallback": "iconmind:confusion-matrix-outline-bold",
	});
}
