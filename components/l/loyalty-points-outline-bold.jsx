...
</style><g class="s0phu2bbs"><path class="k6fi9qmtq"/><path class="ozi-k-boi"/><path class="yl27oobxu"/><path class="go6ln---p"/></g>`,
		"fallback": "iconmind:loyalty-points-outline-bold",
	});
}
