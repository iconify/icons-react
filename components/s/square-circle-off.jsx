...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="ncwv9v_mm"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:square-circle-off",
	});
}
