...
</style><path class="ppls1-bys"/><ellipse class="jgbt-uk1w"/><circle class="bkve3gbna"/><path class="tcoxd2bji"/><path class="h2d4a2bes"/><path class="vnnnf6x6y"/><ellipse class="ckddmxg2z"/><ellipse class="hosr3rphg"/><path class="ic-chkcsz"/><ellipse class="v1r7gdbxu"/><path class="mp6iiyzuc"/><ellipse class="gtei5vb8f"/><path class="qdwkkgb_a"/>`,
		"fallback": "arcticons:brain-test",
	});
}
