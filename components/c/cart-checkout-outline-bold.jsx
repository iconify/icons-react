...
</style><g class="s0phu2bbs"><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="xncmae_bi"/></g>`,
		"fallback": "iconmind:cart-checkout-outline-bold",
	});
}
