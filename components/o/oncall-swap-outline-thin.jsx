...
</style><g class="hntgybcog"><path class="d8z1r1beo"/><path class="wzx0dxb2r"/><path class="l7lvdwbxu"/><path class="kdybz_aht"/></g>`,
		"fallback": "iconmind:oncall-swap-outline-thin",
	});
}
