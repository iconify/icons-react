...
</style><g class="s0phu2bbs"><path class="d5czi6rdr"/><path class="azs8m69dm"/><path class="zm2dyvb-o"/><path class="gbpohbcrz"/></g>`,
		"fallback": "iconmind:event-forward-outline-bold",
	});
}
