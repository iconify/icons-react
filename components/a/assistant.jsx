...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="j8oiwjbra"><circle class="sccr_db_u"/><circle class="tg13ssbpj"/></g><path class="yza3csbyb"/><path class="y7_nj9bzh"/><g class="xd2f8cczg"><circle class="e4i5tr_5t"/><circle class="d224gi7rh"/></g><path class="kmy2-_vdg"/><g class="bvkc79bpm"><path class="i3o-wjc5j"/><circle class="sl0ihtmch"/></g>`,
		"fallback": "flat-color-icons:assistant",
	});
}
