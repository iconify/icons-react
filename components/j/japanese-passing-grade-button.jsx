...
</style><path class="xse-t8d2c"/><path class="bh2unrb8j"/><path class="shqsgobgw"/><path class="cipglxe8e"/>`,
		"fallback": "noto:japanese-passing-grade-button",
	});
}
