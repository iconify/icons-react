...
</style><path class="u7xiv-b3r"/><path class="s4cw8acuy"/><path class="th6evxbbw"/><path class="c8phknbxp"/><circle class="zkkrdvlxp"/><circle class="jzgmokbko"/>`,
		"fallback": "twemoji:flag-for-flag-rwanda",
	});
}
