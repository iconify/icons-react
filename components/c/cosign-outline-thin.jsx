...
</style><g class="hntgybcog"><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="opnv9et8e"/><path class="vnq8uj-tr"/><path class="djr1sx-jt"/></g>`,
		"fallback": "iconmind:cosign-outline-thin",
	});
}
