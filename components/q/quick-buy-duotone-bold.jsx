...
</style><g class="s0phu2bbs"><path class="a-gugwb5v"/><path class="rviuo_bhz"/><path class="c8ewb5pjd"/><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="uxtx6q9dp"/></g>`,
		"fallback": "iconmind:quick-buy-duotone-bold",
	});
}
