...
</style><g class="hntgybcog"><path class="ymw3aibdo"/><path class="tturp2djn"/><path class="maut9lbea"/><path class="vzsi2jzmx"/><path class="efnc6pc0s"/><path class="a0o0t-zvo"/></g>`,
		"fallback": "iconmind:community-outline-thin",
	});
}
