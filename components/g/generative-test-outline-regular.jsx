...
</style><g class="nrj6p8qat"><path class="nzpsuduik"/><path class="tcxfk34nj"/><path class="n3p0zmbop"/><path class="pyew6cbwi"/></g>`,
		"fallback": "iconmind:generative-test-outline-regular",
	});
}
