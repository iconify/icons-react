...
</style><g class="nrj6p8qat"><path class="n0n63pb2v"/><path class="g587irb4v"/><path class="hv3ppsbji"/><path class="hd5-m5bld"/><path class="ffipo4b5s"/><path class="h1j63eveo"/></g>`,
		"fallback": "iconmind:goroutine-dump-outline-regular",
	});
}
