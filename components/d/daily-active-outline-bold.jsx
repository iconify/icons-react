...
</style><g class="s0phu2bbs"><path class="zrwkhybyf"/><path class="j835zw5-z"/><path class="x-lsfmm-w"/><path class="uxng__c7k"/></g>`,
		"fallback": "iconmind:daily-active-outline-bold",
	});
}
