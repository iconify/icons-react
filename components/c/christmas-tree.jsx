...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<circle class="w5nhzmbey"/><circle class="mqqk3vlea"/><circle class="os2588bqt"/><circle class="hqokcpb7d"/><circle class="qxxdagisw"/><circle class="o-_l5ukpg"/><path class="t4d6mkbta"/><path class="m79lqcbzu"/><path class="v83e48b6z"/><circle class="i56sui_ub"/><circle class="rwp6zw6sg"/><circle class="esx3dhf0m"/><circle class="cr79w6zfa"/><circle class="d5nuadmto"/><circle class="gnvcvklmk"/><path class="ywscsac-l"/><path class="r5ez-wdka"/>`,
		"fallback": "openmoji:christmas-tree",
	});
}
