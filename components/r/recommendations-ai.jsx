...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uf63v_b0y"/><path class="iknjfgb4p"/><path class="g3qx3tbzy"/><path class="duzok6x2v"/><path class="t90zmkzfd"/><path class="na9tezbwd"/><path class="txm70ob3k"/><path class="wc4511xpz"/><path class="c0wvm7baf"/><path class="p52b0xb1m"/><path class="ys0tm_upc"/>`,
		"fallback": "gcp:recommendations-ai",
	});
}
