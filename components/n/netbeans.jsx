...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="pc7u31bbl"/><path class="fhrja1boe"/><path class="nfqfbactw"/><path class="t6mjbcbfp"/><path class="n499ohb4m"/><path class="sal6g5b7z"/><path class="y4dtpnbbn"/><path class="jcqhjnblz"/>`,
		"fallback": "devicon:netbeans",
	});
}
