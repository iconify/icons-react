...
</style><g class="s0phu2bbs"><path class="vizlgibdt"/><path class="im9sid5gw"/><path class="b2n99wbku"/><path class="uy7nmfbhi"/></g>`,
		"fallback": "iconmind:mail-alert-outline-bold",
	});
}
