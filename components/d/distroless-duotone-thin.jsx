...
</style><g class="hntgybcog"><path class="j14g7qigh"/><path class="a8i34bcjs"/><path class="ps2g__eqt"/><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="epou1mbuy"/></g>`,
		"fallback": "iconmind:distroless-duotone-thin",
	});
}
