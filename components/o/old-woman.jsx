...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="fx1wgomas"/><path class="awoa3lz-s"/><path class="eqcflcbmp"/><path class="y_8cdl7on"/><path class="xz0pf7boc"/><path class="g3o7nrbxy"/><path class="gt0iigzjr"/><path class="na8vr-bvk"/>`,
		"fallback": "openmoji:old-woman",
	});
}
