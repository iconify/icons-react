...
</style><g class="hntgybcog"><path class="lqcp5xb1v"/><path class="t3vzob-fn"/><path class="b8vrnftmo"/><path class="pz3wsjbwy"/></g>`,
		"fallback": "iconmind:trace-context-outline-thin",
	});
}
