...
</style><g class="cuyn6tgcc"><path class="rno7hacaa"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:circle-big-filled-circle-off",
	});
}
