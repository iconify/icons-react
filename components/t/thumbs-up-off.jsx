...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="pmbz7ybyu"/><path clip-rule="evenodd" class="qpi9zobie"/><path clip-rule="evenodd" class="hits4jilj"/><path clip-rule="evenodd" class="bav49m6_r"/><path clip-rule="evenodd" class="agli4yb5r"/><path clip-rule="evenodd" class="z7b8yjbyc"/><path clip-rule="evenodd" class="qb3j2c2lz"/><path clip-rule="evenodd" class="neqlgkbmb"/><path clip-rule="evenodd" class="f35oph3nh"/><path class="n07qkabsz"/></g>`,
		"fallback": "pepicons-pencil:thumbs-up-off",
	});
}
