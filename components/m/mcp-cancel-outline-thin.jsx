...
</style><g class="hntgybcog"><path class="ni20md-jo"/><path class="j6o0shbiv"/><path class="uesvxd39h"/><path class="lbfhe0cll"/></g>`,
		"fallback": "iconmind:mcp-cancel-outline-thin",
	});
}
