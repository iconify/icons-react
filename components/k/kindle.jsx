...
.bjbc3jj9o {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M24.855 24.504s.701.869.925.869s5.103-2.58 5.215-3.14m-10.828 6.532c.09-.084 2.644-1.444 2.644-1.444");
}
...
.el75ncb2q {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M6.944 37.03a56.3 56.3 0 0 1 9.696-.751c4.318 0 11.836 1.626 20.316 4.879");
}
...
.rmev1v27u {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M18.154 21.868c.477 1.907 3.673 5.453 3.673 5.453l3.365-3.294s-2.832-3.028-3.169-3.953s-.785-2.524-1.682-2.916s-4.458-2.243-4.458-2.243l-.673 1.233a11.73 11.73 0 0 0-5.13 9.673c0 6.561.756 8.804.756 8.804s4.85-1.037 6.589-2.888s2.742-2.972 2.742-2.972l.353-3.004");
}
