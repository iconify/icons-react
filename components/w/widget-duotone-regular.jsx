...
</style><g class="nrj6p8qat"><path class="zrr506boc"/><path class="jvtw6bbtb"/><path class="hmc8bdcww"/><path class="wr637lbfy"/><path class="rvbcncc6z"/><path class="htj7d_25n"/><path class="qux3mqb3d"/><path class="ljn9xlbjs"/><path class="xu9fnz9ia"/><path class="wr_ld5s1h"/></g>`,
		"fallback": "iconmind:widget-duotone-regular",
	});
}
