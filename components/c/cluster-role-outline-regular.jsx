...
</style><g class="nrj6p8qat"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="u7cagdche"/></g>`,
		"fallback": "iconmind:cluster-role-outline-regular",
	});
}
