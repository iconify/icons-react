...
</style><g class="nrj6p8qat"><path class="eqlzrbbhn"/><path class="e0ny3obuy"/><path class="dat-xhb8u"/><path class="iwoy52b7h"/><path class="um6qav7po"/><path class="xbz5-ab-d"/></g>`,
		"fallback": "iconmind:catalog-duotone-regular",
	});
}
