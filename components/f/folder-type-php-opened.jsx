...
</style><defs><radialGradient id="SVGlxZqEdbh" cx="-10.216" cy="31.126" r="13.788" gradientTransform="translate(26.52 -9.307)" gradientUnits="userSpaceOnUse"><stop offset="0" class="vc--wpv5i"/><stop offset=".5" class="irf8jsb_m"/><stop offset="1" class="c0xyygbvy"/></radialGradient></defs><path class="cachzne7o"/><path class="zpri73opd"/><ellipse fill="url(#SVGlxZqEdbh)" class="kj_s6eibc"/><ellipse class="wue3pub_m"/><path class="jfcd7jbyz"/><path class="uv18ldbti"/>`,
		"fallback": "vscode-icons:folder-type-php-opened",
	});
}
