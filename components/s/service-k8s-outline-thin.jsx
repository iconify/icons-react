...
</style><g class="hntgybcog"><path class="fozhwebbv"/><path class="uzmclv6tb"/><path class="m3ubefbgj"/><path class="z55just5o"/><path class="qjx5s3xna"/></g>`,
		"fallback": "iconmind:service-k8s-outline-thin",
	});
}
