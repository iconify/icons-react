...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="pcz37bc_h"/><path class="pfi577ili"/><path class="a67sm0ovf"/><path class="ecfdkf8zc"/><path class="t5h1hnlzm"/><path class="ydoteabql"/><path class="zj72lvbjh"/><path class="i0-5_tbsq"/><path class="v_c3kyb_d"/><path class="xn8k5-14y"/><path class="qnze_4q2i"/>`,
		"fallback": "streamline-emojis:kimono",
	});
}
