...
</style><g class="s0phu2bbs"><path class="cf6epupol"/><path class="riz4hpmhz"/><path class="os75_tbot"/><path class="rebfvp9ta"/></g>`,
		"fallback": "iconmind:task-steal-outline-bold",
	});
}
