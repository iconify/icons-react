...
</style><g class="s0phu2bbs"><path class="v8fbd0blu"/><path class="rqxmixb7d"/><path class="mut__fbgb"/><path class="krno6ds-i"/></g>`,
		"fallback": "iconmind:mcp-transport-outline-bold",
	});
}
