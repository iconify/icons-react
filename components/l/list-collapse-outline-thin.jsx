...
</style><g class="hntgybcog"><path class="dx3ubrb9h"/><path class="hbtmd5b0k"/><path class="rdidnh2az"/><path class="tc-ybhuxl"/></g>`,
		"fallback": "iconmind:list-collapse-outline-thin",
	});
}
