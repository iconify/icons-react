...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="kue3stb6i"/><path class="rf975mans"/><path class="no9mdgmge"/><path class="ho1wa2bsp"/><path class="u_3xg9bwv"/><path class="nhn5pra8d"/><path class="cpwwhmbzu"/><path class="v-6g4gbcc"/><path class="q04w-2rnx"/><path class="p5dgvdbkb"/><path class="reber1ehn"/><path class="csns_kk0v"/><path class="rec_4qp_r"/>`,
		"fallback": "streamline-emojis:meat-on-bone",
	});
}
