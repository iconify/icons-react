...
</style><path class="mkw3grhsz"/><circle class="u3psqrlzl"/><path class="vj4x39beg"/><path class="h518ptbug"/><path class="yrt_29b3g"/><path class="lcgu9mktw"/><path class="e9l-scbqy"/><path class="y5ugehbdm"/><path class="au3d2fbzm"/><path class="h8zucm-ap"/>`,
		"fallback": "noto:no-one-under-eighteen",
	});
}
