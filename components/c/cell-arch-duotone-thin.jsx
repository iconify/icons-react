...
</style><g class="hntgybcog"><path class="a8ql821se"/><path class="tp2e7cbwg"/><path class="o1h0nobjc"/><path class="b93edcc7a"/><path class="s-z5c8bxf"/><path class="w_mi5xczu"/><path class="jutdvybnj"/><path class="wumf77bxt"/><path class="wi71wvbqq"/><path class="bg56fj76r"/><path class="a6z1jcjqs"/><path class="ivqg9reic"/></g>`,
		"fallback": "iconmind:cell-arch-duotone-thin",
	});
}
