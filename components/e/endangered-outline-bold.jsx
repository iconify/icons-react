...
</style><g class="s0phu2bbs"><path class="wc595gblk"/><path class="aff9hemvj"/><path class="u36itk5tb"/><path class="m_erznomk"/><path class="tr__z6b9j"/></g>`,
		"fallback": "iconmind:endangered-outline-bold",
	});
}
