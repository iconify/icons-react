...
</style><g class="hntgybcog"><path class="n09nomjwg"/><path class="iedujiqkb"/><path class="n3p0zmbop"/><path class="a-9s6wb0y"/></g>`,
		"fallback": "iconmind:device-code-outline-thin",
	});
}
