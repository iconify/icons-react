...
</style><g class="nrj6p8qat"><path class="viv5gg8xx"/><path class="n-059ea3n"/><path class="llakqobuk"/><path class="fddkg0b5z"/></g>`,
		"fallback": "iconmind:namespace-quota-outline-regular",
	});
}
