...
</style><g class="s0phu2bbs"><path class="y4_6s7b5v"/><path class="wuvisubmw"/><path class="yk3ngthye"/><path class="yb0v0wbmi"/></g>`,
		"fallback": "iconmind:audit-books-outline-bold",
	});
}
