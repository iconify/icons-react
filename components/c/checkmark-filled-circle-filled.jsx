...
</style><g class="ft5dv1b6b"><defs><mask id="SVGwT4KJeMj"><path class="k5-vjlrin"/><path clip-rule="evenodd" class="hf6a9qbgm"/></mask></defs><circle mask="url(#SVGwT4KJeMj)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:checkmark-filled-circle-filled",
	});
}
