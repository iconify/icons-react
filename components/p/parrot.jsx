...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="y1n0krurj"/><path class="ex0labljx"/><path class="g259n0b9m"/><path class="o2hivdbfg"/><path class="by5e0kbvh"/><path class="fgitsliru"/><g class="brzn_0bpr"><path class="atai36bzb"/><path class="sv6qbu80q"/><path class="w0-9cybvx"/><path class="ptjmilbxg"/><path class="p2xjc_y7w"/></g>`,
		"fallback": "openmoji:parrot",
	});
}
