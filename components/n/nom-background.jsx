...
.qp_-5s9wa {
  fill: var(--svg-color--e1dfec, #e1dfec);
  d: path("M24 0H0v24h24z");
}
</style><g class="ft5dv1b6b"><g clip-path="url(#SVGHcSWxdhd)"><path class="qp_-5s9wa"/><path class="pl2jcfd-f"/><path class="lt3bw_bqo"/></g><defs><clipPath id="SVGHcSWxdhd"><path class="py7ktqbvf"/></clipPath></defs></g>`,
		"fallback": "token-branded:nom-background",
	});
}
