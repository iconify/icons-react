...
</style><g class="hntgybcog"><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="f9z-0cczq"/></g>`,
		"fallback": "iconmind:cart-remove-outline-thin",
	});
}
