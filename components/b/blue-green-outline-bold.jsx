...
</style><g class="s0phu2bbs"><path class="s0mwfjblf"/><path class="t1v31abzy"/><path class="xltmvtz1x"/></g>`,
		"fallback": "iconmind:blue-green-outline-bold",
	});
}
