...
</style><g class="s0phu2bbs"><path class="fa9joccbo"/><path class="dmqg6xbxr"/><path class="pwc0rzflc"/><path class="rhtl3vb5u"/><path class="hjz9frcqe"/></g>`,
		"fallback": "iconmind:lineage-table-outline-bold",
	});
}
