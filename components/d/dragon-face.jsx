...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ih8mfdk_s"/><path class="jyeec5btu"/><path class="qwrknpb3z"/><path class="rfrzpzbkt"/><path class="qsy_q0kch"/><circle class="k8mjr9rwp"/><circle class="b9zo1tbsj"/><circle class="i5_6bfdwy"/><circle class="j2ocwccgq"/><path class="hioilcw1b"/><path class="vrm622b9u"/><path class="l7b9k7bmq"/>`,
		"fallback": "openmoji:dragon-face",
	});
}
