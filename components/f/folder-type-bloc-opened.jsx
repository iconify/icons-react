...
</style><path class="bv2g70b9o"/><path class="ntuumre2a"/><path class="k8qxfilja"/><path class="imk-hfbnk"/><path class="g98vaobit"/>`,
		"fallback": "vscode-icons:folder-type-bloc-opened",
	});
}
