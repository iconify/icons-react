...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="bwft_fjyp"/><path class="xsiz0b9vk"/><path class="qh_oalb4n"/><path class="plzboqz4g"/><path class="kn7zefg6w"/><path class="vlxa4pbeq"/><path class="hzf7q7brv"/><path class="yx4pt2bkv"/><path class="ookqb53cn"/><path class="cjlycgoog"/><path class="b7t2cubbw"/><path class="ce6-kmbly"/>`,
		"fallback": "streamline-emojis:snail",
	});
}
