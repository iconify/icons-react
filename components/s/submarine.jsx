...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="au-25o3yc"/><path class="ybxz0zb7n"/><path class="uauj9e5aa"/><path class="rpp1k3bom"/><path class="j0xmmk0hs"/><path class="edz_rxbnl"/><path class="thq__7brm"/><path class="lozrq6j1m"/><circle class="v9vujspig"/><circle class="cul050x8l"/>`,
		"fallback": "openmoji:submarine",
	});
}
