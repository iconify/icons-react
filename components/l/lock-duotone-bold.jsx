...
</style><g class="s0phu2bbs"><path class="j7zm7nyun"/><path class="c07le3bhf"/><path class="a3b7rvb1p"/><path class="ltriwmbuu"/><path class="y1lnycw3l"/></g>`,
		"fallback": "iconmind:lock-duotone-bold",
	});
}
