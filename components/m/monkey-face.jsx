...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="mkyeehahd"/><path class="pbscpxb8w"/><circle class="mi0x-nbtx"/><path class="jdgwi2bav"/><circle class="jz98eg2_s"/><path class="bx1k6rn6e"/><path class="lm66ohk1f"/><path class="dx57-eo4k"/><path class="gft2ylihm"/>`,
		"fallback": "openmoji:monkey-face",
	});
}
