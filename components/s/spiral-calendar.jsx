...
</style><path class="fse693bvb"/><path class="bz5lmgbsm"/><path class="n6h-drfhg"/><g class="jeunsn1yj"><ellipse class="dga2keb1c"/><ellipse class="uix238gdr"/><ellipse class="ir6gnccla"/><ellipse class="rudr4xb9o"/><path class="nhqatg3ci"/></g><path class="ey9xvcc_u"/><path class="t-oyue0id"/><path class="ldz95bb4f"/><path class="ecwtzhbvc"/>`,
		"fallback": "emojione:spiral-calendar",
	});
}
