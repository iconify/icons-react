...
</style><g class="s0phu2bbs"><path class="vyks9vbfn"/><path class="mpjdm200q"/><path class="tkeq0bpvv"/><path class="xrw775b-m"/><path class="nzcu_ibws"/></g>`,
		"fallback": "iconmind:street-view-outline-bold",
	});
}
