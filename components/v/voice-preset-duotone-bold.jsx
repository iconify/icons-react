...
</style><g class="s0phu2bbs"><path class="t5v_djbzx"/><path class="xaldo7bxo"/><path class="jq9hovbrs"/><path class="yomctlb4k"/><path class="gdoir7bnl"/></g>`,
		"fallback": "iconmind:voice-preset-duotone-bold",
	});
}
