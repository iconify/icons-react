...
</style><g class="nrj6p8qat"><path class="d8z1r1beo"/><path class="wzx0dxb2r"/><path class="styxdpaok"/><path class="h857n5bhq"/><path class="y6kfzfgng"/></g>`,
		"fallback": "iconmind:lifecycle-outline-regular",
	});
}
