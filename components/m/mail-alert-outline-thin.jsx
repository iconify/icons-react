...
</style><g class="hntgybcog"><path class="vizlgibdt"/><path class="im9sid5gw"/><path class="b2n99wbku"/><path class="uy7nmfbhi"/></g>`,
		"fallback": "iconmind:mail-alert-outline-thin",
	});
}
