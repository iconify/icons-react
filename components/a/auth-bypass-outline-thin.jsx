...
</style><g class="hntgybcog"><path class="xfs8wlfhn"/><path class="iml3cbclx"/><path class="bgtolgbkt"/><path class="uqwi0oy1e"/></g>`,
		"fallback": "iconmind:auth-bypass-outline-thin",
	});
}
