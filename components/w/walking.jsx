...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="s4jnsub6m"/><path class="b1ts1tbte"/><path class="bnygg7bjs"/><path class="lbi3c6b9o"/><path class="djb31w5od"/><path class="x4v4hyb6u"/><path class="i0do7-e-k"/><path class="x4naur-qb"/><path class="ri6larizi"/><path class="ix2o61bvm"/><path class="cmsi69cvn"/><path class="r6zg02b7j"/><path class="i6wss2_ww"/>`,
		"fallback": "fxemoji:walking",
	});
}
