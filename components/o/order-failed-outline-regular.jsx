...
</style><g class="nrj6p8qat"><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="tcy4mac_h"/><path class="ps3lg_bgm"/></g>`,
		"fallback": "iconmind:order-failed-outline-regular",
	});
}
