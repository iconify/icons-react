...
</style><g class="nrj6p8qat"><path class="sjmvcxbpe"/><path class="l0v-b4kbr"/><path class="ug4kkubvk"/><path class="ipv0cebdm"/></g>`,
		"fallback": "iconmind:transform-outline-regular",
	});
}
