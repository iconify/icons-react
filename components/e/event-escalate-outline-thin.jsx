...
</style><g class="hntgybcog"><path class="d5czi6rdr"/><path class="azs8m69dm"/><path class="kgpu6-15k"/><path class="rfdwl-jei"/></g>`,
		"fallback": "iconmind:event-escalate-outline-thin",
	});
}
