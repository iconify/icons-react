...
</style><g class="s0phu2bbs"><path class="r1tpzrwqw"/><path class="ps2g__eqt"/><path class="hpthd_boc"/><path class="velnaj6mf"/><path class="epou1mbuy"/></g>`,
		"fallback": "iconmind:nullable-duotone-bold",
	});
}
