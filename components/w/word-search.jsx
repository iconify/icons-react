...
</style><rect transform="rotate(-45 24 24)" class="bma4tqtkq"/><path class="aa7tjib5b"/><rect class="jhy659bcz"/>`,
		"fallback": "arcticons:word-search",
	});
}
