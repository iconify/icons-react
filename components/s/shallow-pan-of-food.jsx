...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<circle class="d5mrnibft"/><circle class="bymj2hrfw"/><path class="eyzxcod8u"/><path class="f_v3qwbfo"/><circle class="tf3lzub4l"/><circle class="ssgsu6bwo"/><circle class="lxgvugbdm"/><path class="rw652k7oi"/><path class="wn4ofyaxi"/><g class="jxqi2jbpi"><circle class="rm5lbmyxt"/><path class="scze-y8qu"/><path class="k30cawb9f"/><path class="t-g-ryble"/><path class="nhadw2bjj"/></g>`,
		"fallback": "openmoji:shallow-pan-of-food",
	});
}
