...
</style><path class="mtuniib5h"/><path class="gz-b93cca"/><defs><path id="SVGHS5T6b0Y" class="jusagjbiu"/></defs><clipPath id="SVGmyL66ddH"><use href="#SVGHS5T6b0Y"/></clipPath><path clip-path="url(#SVGmyL66ddH)" class="rfzco7qkd"/><defs><use href="#SVGHS5T6b0Y" id="SVGN1cpRcQB"/></defs><clipPath id="SVGCNTilnCF"><use href="#SVGN1cpRcQB"/></clipPath><g clip-path="url(#SVGCNTilnCF)" class="j9_i7vu4q"><path class="qoq2pgbqk"/></g>`,
		"fallback": "noto:clapping-hands-medium-light-skin-tone",
	});
}
