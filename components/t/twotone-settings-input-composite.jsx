...
.zu0d4xbjc {
  fill: currentColor;
  d: path("M3 16c0 .55.45 1 1 1s1-.45 1-1v-2H3zm8 0c0 .55.45 1 1 1s1-.45 1-1v-2h-2zm8 0c0 .55.45 1 1 1s1-.45 1-1v-2h-2z");
  opacity: var(--svg-opacity--0-3, 0.3);
}
</style><path class="zu0d4xbjc"/><path class="gil2ri6ee"/>`,
		"fallback": "ic:twotone-settings-input-composite",
	});
}
