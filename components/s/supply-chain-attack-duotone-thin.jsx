...
</style><g class="hntgybcog"><path class="xmmrcy3kl"/><path class="mdbq_bc-v"/><path class="pf60fj32d"/><path class="g00uv-b-x"/><path class="koh8ckbdb"/><path class="k2mg4f2ls"/><path class="r2sn4nhez"/></g>`,
		"fallback": "iconmind:supply-chain-attack-duotone-thin",
	});
}
