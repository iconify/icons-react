...
</style><g class="s0phu2bbs"><path class="tzdfp4-do"/><path class="y6-r88b3l"/><path class="ufzn_r3vk"/><path class="avdamgajo"/><path class="jds7y1b0v"/></g>`,
		"fallback": "iconmind:anonymise-duotone-bold",
	});
}
