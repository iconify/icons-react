...
</style><g class="hntgybcog"><path class="awqg98bar"/><path class="es7m87c4x"/><path class="mqh2f6n-y"/><path class="om2raabrv"/><path class="eff8y6gxz"/></g>`,
		"fallback": "iconmind:battery-duotone-thin",
	});
}
