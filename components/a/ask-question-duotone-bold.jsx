...
</style><g class="s0phu2bbs"><path class="l0dayac0a"/><path class="i61s0l94t"/><path class="cu90avb1w"/><path class="l3ce2kb5n"/><path class="x5yyblbox"/></g>`,
		"fallback": "iconmind:ask-question-duotone-bold",
	});
}
