...
</style><g class="nrj6p8qat"><path class="sqmravmye"/><path class="hbdbg_bcy"/><path class="lyjarcbwz"/><path class="cspceacnq"/><path class="doxmgbcyh"/></g>`,
		"fallback": "iconmind:semantic-duotone-regular",
	});
}
