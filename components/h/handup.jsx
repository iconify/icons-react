...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="mfcyrxnef"/><path class="hxk7uerru"/><path class="n5935fbwh"/><path class="ojh_nnb_q"/><path class="k6usg_bkw"/><path class="sm2e77ywy"/><path class="fmemrccsy"/><path class="p_e99pbxd"/><path class="wid4v_b7y"/><path class="b85x0hber"/><path class="rcc1sq6ei"/><path class="ovof3bcis"/><path class="ngi511brl"/>`,
		"fallback": "fxemoji:handup",
	});
}
