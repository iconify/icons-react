...
</style><g class="hntgybcog"><path class="xfs8wlfhn"/><path class="ygr1bbcag"/><path class="htl7tccnk"/><path class="vqi6vft7m"/><path class="y0v87rbkg"/></g>`,
		"fallback": "iconmind:secret-k8s-outline-thin",
	});
}
