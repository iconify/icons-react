...
.zzbwvjbqa {
  stroke-opacity: 0.4;
  d: path("M16.5 10L16.5 6.5C16.5 4.0147 14.4853 2 12 2C9.5147 2 7.5 4.0147 7.5 6.5L7.5 7.5");
}
</style><g class="gp_8x1bzb"><path class="zzbwvjbqa"/><path class="qj8iipbgi"/><path clip-rule="evenodd" class="d-2r4nbvo"/></g>`,
		"fallback": "keyline-icons:unlock-sharp-duotone",
	});
}
