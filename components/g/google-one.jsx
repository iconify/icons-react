...
</style><defs><linearGradient id="SVGDvi8keKw" x1="50%" x2="50%" y1="100.777%" y2="-.04%"><stop offset="0%" class="l9ipdzgip"/><stop offset="100%" class="yivtvjbgh"/></linearGradient></defs><path class="e57iw56tc"/><path fill="url(#SVGDvi8keKw)" class="fxrlnxous"/><path class="bpij_gboz"/><path class="jn2if-b8v"/>`,
		"fallback": "logos:google-one",
	});
}
