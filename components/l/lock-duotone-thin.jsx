...
</style><g class="hntgybcog"><path class="j7zm7nyun"/><path class="c07le3bhf"/><path class="a3b7rvb1p"/><path class="ltriwmbuu"/><path class="y1lnycw3l"/></g>`,
		"fallback": "iconmind:lock-duotone-thin",
	});
}
