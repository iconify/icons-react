...
</style><g class="hntgybcog"><path class="zva0qcbrg"/><path class="xhii43btc"/><path class="gcalxb98a"/><path class="qtxvlht3c"/></g>`,
		"fallback": "iconmind:clipboard-list-outline-thin",
	});
}
