...
</style><path class="rujch7btn"/><path class="y4kbdibad"/><path class="q_f5ecc3f"/><path class="qp7b27bms"/>`,
		"fallback": "vscode-icons:folder-type-light-cursor-opened",
	});
}
