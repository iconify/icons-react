...
</style><g class="s0phu2bbs"><path class="murw5tb-p"/><path class="gfdpeof0d"/><path class="y_uork5-p"/><path class="okg0-qwlz"/><path class="n3p0zmbop"/><path class="b15_tib7k"/></g>`,
		"fallback": "iconmind:watercolour-outline-bold",
	});
}
