...
</style><g class="nrj6p8qat"><path class="xfs8wlfhn"/><path class="iml3cbclx"/><path class="kvu524b1m"/><path class="o81w35jwy"/><path class="yu9v0ekyz"/></g>`,
		"fallback": "iconmind:open-cors-outline-regular",
	});
}
