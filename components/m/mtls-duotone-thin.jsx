...
</style><g class="hntgybcog"><path class="z26heubln"/><path class="aq93qgbvy"/><path class="c9rt-wbve"/><path class="fddb2ca0n"/><path class="uk9xnrm3r"/><path class="xyp2pm_yf"/><path class="fkf_gcbra"/></g>`,
		"fallback": "iconmind:mtls-duotone-thin",
	});
}
