...
</style><path class="pc45o1b4t"/><path class="k3ahzac7l"/><defs><path id="SVGU67dBeQS" class="l439n0bap"/></defs><clipPath id="SVG617RIbte"><use href="#SVGU67dBeQS"/></clipPath><g clip-path="url(#SVG617RIbte)" class="zlqwn85jm"><path class="o4yqbwbdl"/></g><defs><use href="#SVGU67dBeQS" id="SVGCPeKAdMZ"/></defs><clipPath id="SVG3ABvZdad"><use href="#SVGCPeKAdMZ"/></clipPath><g clip-path="url(#SVG3ABvZdad)" class="j9_i7vu4q"><path class="oqad6y8ry"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="byeg-0b8a"><path class="s2_2_ccsc"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="lip7wrrrl"><path class="trz1g0bjh"/></g>`,
		"fallback": "noto:handshake-medium-light-skin-tone-medium-skin-tone",
	});
}
