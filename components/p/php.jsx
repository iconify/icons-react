...
</style><defs><radialGradient id="SVGCUqixdHg" cx=".837" cy="-125.811" r="363.057" gradientTransform="translate(76.464 81.918)scale(.463)" gradientUnits="userSpaceOnUse"><stop offset="0" class="vc--wpv5i"/><stop offset=".5" class="ydtw3pgom"/><stop offset="1" class="c0xyygbvy"/></radialGradient></defs><ellipse fill="url(#SVGCUqixdHg)" class="iewc59qta"/><ellipse class="sqe_5esuq"/><path class="u-ryxfycv"/><path class="al6s0hb4v"/>`,
		"fallback": "logos:php",
	});
}
