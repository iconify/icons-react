...
</style><path class="qfjz-2jgs"/><path class="kc1ole-jg"/><path class="ytaft7bol"/><path class="n9lxxfbsz"/><path class="nogz59bal"/><path class="i4l-8bc0d"/><path class="qq3otccfw"/><path class="v3349f6jz"/><path class="y2wl4gbnt"/><g class="az_6riylm"><path class="l8orqj4go"/><path class="etp434bjz"/></g><path class="bsxxv299t"/><defs><path id="SVGSNtVgdHr" class="xzf-9nlkm"/></defs><use href="#SVGSNtVgdHr" class="ega13mbxo"/>`,
		"fallback": "noto-v1:man-facepalming",
	});
}
