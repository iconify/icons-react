...
.ptsgpjzid {
  d: path("M216 144a32 32 0 1 1-32-32a32 32 0 0 1 32 32");
...
</style><g class="cuyn6tgcc"><path class="ptsgpjzid"/><path class="y_3rezxmf"/></g>`,
		"fallback": "ph:list-magnifying-glass-duotone",
	});
}
