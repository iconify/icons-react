...
</style><g class="s0phu2bbs"><path class="n7c_b1bsn"/><path class="wwnijrnro"/><path class="cxoq7xbon"/><path class="a218-cpca"/><path class="lgr612izs"/><path class="ync9d6bsc"/></g>`,
		"fallback": "iconmind:audience-claim-duotone-bold",
	});
}
