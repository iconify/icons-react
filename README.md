...
```bash
npm install github:iconify/icons-react#ion
```
...
```jsx
import SampleIcon from '@iconify-react/ion/code-download-sharp';
...
```jsx
import SampleIcon from '@iconify-react/ion/contrast-outline';
...
```jsx
import SampleIcon from '@iconify-react/ion/checkmark-done';
