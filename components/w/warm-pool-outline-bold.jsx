...
</style><g class="s0phu2bbs"><path class="xb1ky5bec"/><path class="wqu0yvyoz"/><path class="zvuby9blz"/><path class="v5srdkbdr"/><path class="sqsrstbfr"/></g>`,
		"fallback": "iconmind:warm-pool-outline-bold",
	});
}
