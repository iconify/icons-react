...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="sz2bxzd-p"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:bookmark-circle-off",
	});
}
