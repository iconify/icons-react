...
</style><path class="izo9k2b6e"/><path class="m8vyqgbsm"/><path class="sjozccqxx"/><path class="qsvtzfb7f"/><circle class="uxq0-lb9t"/>`,
		"fallback": "arcticons:samsung-print-service-plugin",
	});
}
