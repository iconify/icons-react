...
</style><path class="r909f-bgw"/><path class="bszgnpjnk"/><path class="j_og7lb9e"/><path class="l2ek_6b5i"/><circle class="k_01-tbtt"/>`,
		"fallback": "vscode-icons:file-type-light-trivy",
	});
}
