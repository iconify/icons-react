...
</style><path class="q3eqo4b2g"/><path class="rudfucc0e"/><path class="kcnmyjbug"/><path class="cl_m1rbnm"/><path class="esqehqb_m"/>`,
		"fallback": "arcticons:helakuru",
	});
}
