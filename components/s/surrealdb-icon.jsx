...
</style><defs><linearGradient id="SVGqJZyIdTu" x1="31.047%" x2="68.957%" y1="11.705%" y2="88.303%"><stop offset="0%" class="hqch13d3y"/><stop offset="100%" class="hke-fq0-t"/></linearGradient></defs><path fill="url(#SVGqJZyIdTu)" class="bdcyf2qdx"/>`,
		"fallback": "logos:surrealdb-icon",
	});
}
