...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="pap9frbjo"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:line-slant-down-circle-off",
	});
}
