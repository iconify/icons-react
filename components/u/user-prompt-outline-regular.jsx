...
</style><g class="nrj6p8qat"><path class="myekf3bzc"/><path class="cpvmwnddk"/><path class="vr5wd2g-l"/><path class="q1ha9bc_u"/></g>`,
		"fallback": "iconmind:user-prompt-outline-regular",
	});
}
