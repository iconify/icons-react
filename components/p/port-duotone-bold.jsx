...
</style><g class="s0phu2bbs"><path class="cvoep2bmy"/><path class="l5-femb1f"/><path class="pi39ped8z"/><path class="zrwkhybyf"/><path class="kjusc2eyp"/><path class="uxsptjbvt"/><path class="olup7y72x"/></g>`,
		"fallback": "iconmind:port-duotone-bold",
	});
}
