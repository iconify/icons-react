...
</style><g class="s0phu2bbs"><path class="uxyzhxvwz"/><path class="quv6fgbpo"/><path class="ezl2ndbvl"/><path class="oumlmtbql"/><path class="ap8hfz6rg"/></g>`,
		"fallback": "iconmind:pet-toy-outline-bold",
	});
}
