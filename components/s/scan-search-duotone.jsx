...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.if2h_hcma {
  d: path("M13.1213 13.1213L16 16");
}
...
</style><g class="nrj6p8qat"><path class="qjql2tbsq"/><path class="if2h_hcma"/><path clip-rule="evenodd" class="ki4iswmtp"/></g>`,
