...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="szfhazbkv"/><path class="v-btizb5f"/><path class="hzianib4c"/><circle class="zahy9l4ec"/><path class="v6gk7ab2u"/><path class="xcw8grw_c"/><path class="hrv5y2fzl"/><path class="gq0__kblq"/><path class="zuohnhbuh"/>`,
		"fallback": "flat-color-icons:print",
	});
}
