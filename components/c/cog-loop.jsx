...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="a0m25c sa_qfe"/><path class="a0m25c ks7-qg"/><path class="a0m25c upsr1h"/><path class="a0m25c htcv5v"/><path class="a0m25c es0rrs"/><path class="a0m25c m117nv"/><path class="a0m25c my4abk"/><path class="a0m25c b-rbwb"/>`,
		"fallback": "line-md:cog-loop",
	});
}
