...
</style><circle class="hzzz1jv6x"/><g class="n1mjunbsu"><path class="jq25ehbhr"/><path class="xpgxgacrc"/><path class="nhijxpb7z"/><path class="wmjgukcrx"/><path class="xuum2bd5u"/></g>`,
		"fallback": "emojione:flag-for-flag-saudi-arabia",
	});
}
