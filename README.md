...
```bash
npm install github:iconify/icons-react#vaadin
```
...
```jsx
import SampleIcon from '@iconify-react/vaadin/area-select';
...
```jsx
import SampleIcon from '@iconify-react/vaadin/file-picture';
...
```jsx
import SampleIcon from '@iconify-react/vaadin/plus-circle-o';
