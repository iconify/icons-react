...
</style><g class="s0phu2bbs"><path class="ni20md-jo"/><path class="j6o0shbiv"/><path class="uesvxd39h"/><path class="sfjortb-o"/><path class="y1lnycw3l"/></g>`,
		"fallback": "iconmind:mcp-server-alert-outline-bold",
	});
}
