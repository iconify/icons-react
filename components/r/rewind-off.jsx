...
</style><g class="cuyn6tgcc"><path class="xqtzudbty"/><path clip-rule="evenodd" class="ypp97vbjd"/><path class="vh7t-d01o"/><path clip-rule="evenodd" class="uhftw22-o"/><path class="xedf9ccsf"/></g>`,
		"fallback": "pepicons-pop:rewind-off",
	});
}
