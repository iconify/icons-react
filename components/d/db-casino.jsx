...
</style><path class="yyyqymv8p"/><path class="tw0q_abzo"/><rect class="mredrfbji"/><circle class="ajzzl5bvb"/><path class="gzbv6zd4p"/>`,
		"fallback": "arcticons:db-casino",
	});
}
