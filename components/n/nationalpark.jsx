...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="z50iju6nu"/><circle class="jyo_ax8rg"/><path class="qp0l8ubyh"/><path class="jdd22xs_v"/><path class="nrsb-aces"/><path class="dj206bbsl"/><path class="iq3aj57mz"/><path class="y-ofmcnoq"/><path class="i-sncdcal"/><path class="rogrk71jw"/>`,
		"fallback": "fxemoji:nationalpark",
	});
}
