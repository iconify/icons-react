...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ax4zolh9t"/><path class="tbwhv_b5h"/><path class="i_nbt2rmi"/><path class="u6n70a3qz"/><circle class="eeaesmcha"/><circle class="npo69vb-e"/><circle class="hvz3e_lyc"/><circle class="j3pcu_bdi"/><circle class="ffyjczbyd"/><circle class="ajjtr6bys"/>`,
		"fallback": "openmoji:microbe",
	});
}
