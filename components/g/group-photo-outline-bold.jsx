...
</style><g class="s0phu2bbs"><path class="cnjkjfbvs"/><path class="n-059ea3n"/><path class="xedmbxbzm"/><path class="olmwgycdy"/></g>`,
		"fallback": "iconmind:group-photo-outline-bold",
	});
}
