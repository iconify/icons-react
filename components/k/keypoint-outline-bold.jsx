...
</style><g class="s0phu2bbs"><path class="o72p0hsyz"/><path class="v7xfanbfw"/><path class="d8gf8fboh"/><path class="nt94z-wbn"/><path class="zo05kh48x"/><path class="vqk_j23jd"/></g>`,
		"fallback": "iconmind:keypoint-outline-bold",
	});
}
