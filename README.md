...
Browse all icons: [preview Rivet Icons on Iconify](https://icon-sets.iconify.design/rivet-icons/)

## Installation

```bash
npm install github:iconify/icons-react#rivet-icons
```
...
```jsx
import SampleIcon from '@iconify-react/rivet-icons/lightning';
...
```jsx
import SampleIcon from '@iconify-react/rivet-icons/credit-card-solid';
...
```jsx
import SampleIcon from '@iconify-react/rivet-icons/pause';
