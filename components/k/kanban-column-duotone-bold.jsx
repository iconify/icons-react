...
</style><g class="s0phu2bbs"><path class="yn64c1dsb"/><path class="ga6kn73cl"/><path class="v7weluf1f"/><path class="tkn_9lu9q"/><path class="k7cb-5bou"/><path class="jfxgqlb-n"/></g>`,
		"fallback": "iconmind:kanban-column-duotone-bold",
	});
}
