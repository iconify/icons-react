...
</style><g class="nrj6p8qat"><path class="j1dy6hbmb"/><path class="uj5coxtbu"/><path class="ko7uhih5e"/><path class="agce8nbhp"/><path class="jt2ihvbku"/><path class="svmab0t4v"/><path class="xpsk7ccmv"/><path class="moemtk9nb"/><path class="y0y0ccsoe"/></g>`,
		"fallback": "iconmind:connection-pool-duotone-regular",
	});
}
