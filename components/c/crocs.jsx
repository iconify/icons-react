...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="xqnyl1bgj"/><path class="o10ipcb8n"/><path class="reonmybgp"/><rect class="ubxl3kbvs"/><rect class="r305xkb7z"/><rect class="l2o50n6bz"/><rect class="dl7kghv7x"/><rect class="bmi6_2b-j"/><rect class="h7hh_1l3n"/><g class="jn8qy4bru"><path class="fptlbvblx"/><path class="b30163b4z"/></g>`,
		"fallback": "openmoji:crocs",
	});
}
