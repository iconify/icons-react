...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="oc68kwumn"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:grid-circle-off",
	});
}
