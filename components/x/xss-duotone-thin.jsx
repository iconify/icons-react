...
</style><g class="hntgybcog"><path class="c13n5ccfl"/><path class="k_2z93bzc"/><path class="n09nomjwg"/><path class="ibqum-bte"/><path class="cow3o_29e"/><path class="n3p0zmbop"/></g>`,
		"fallback": "iconmind:xss-duotone-thin",
	});
}
