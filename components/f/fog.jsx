...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="xbzo0vbim"/><path class="h1pcedcps"/><path class="e5qr8fb6r"/><path class="cbu9lvpfu"/><path class="d-o7uqb_k"/><path class="su6xcnrgr"/><path class="o877x-bvr"/><path class="tf2rp27ih"/><path class="gg8-pf67s"/><path class="cv8qxlq8e"/>`,
		"fallback": "openmoji:fog",
	});
}
