...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="xiaq5cb8j"/><path class="kbvlyv6-c"/><path class="ug76sacem"/><path class="it25fdkkr"/><path class="sdku3xckp"/><path class="oscgefb7t"/><path class="q_p8z2b7n"/><path class="dau0aabzj"/><path class="kd3z4acga"/>`,
		"fallback": "fxemoji:hospital",
	});
}
