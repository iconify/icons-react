...
</style><path class="xhdgozbzy"/><path class="mzqhyqjna"/><path class="ibw5xvbez"/><path class="ofcbpfbgq"/><path class="qviekhbcp"/>`,
		"fallback": "twemoji:umbrella-with-rain-drops",
	});
}
