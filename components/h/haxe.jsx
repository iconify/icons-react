...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="etl3xd4ro"/><path class="o4692-bvg"/><path class="vzr5szt8w"/><path class="ln1vbbb_d"/><path class="z5ogclbrk"/><path class="h3eh20y8f"/><path class="xfy02kb5p"/><path class="tz4viu23h"/><path class="d83gq8xis"/><path class="usn-mtblu"/>`,
		"fallback": "devicon:haxe",
	});
}
