...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="fjzxd6bpu"/><path class="v9yym9ysz"/><path class="xbzxqe5ja"/><path class="r6a89c4md"/><path class="qjahqebdt"/><path class="xab4_rbyy"/><path class="cbd4bob2o"/><path class="i5k3-lbni"/><path class="xkdap0b8b"/><path class="wmvkczb-x"/><path class="tbchrublz"/><path class="n6x32qbkr"/><path class="rprvj-g9d"/>`,
		"fallback": "openmoji:man-mechanic-medium-skin-tone",
	});
}
