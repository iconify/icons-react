...
</style><g class="s0phu2bbs"><path class="liom1epye"/><path class="m61z8ufvi"/><path class="gev0055ej"/><path class="jnfz-wh9g"/><path class="n10kxpbvp"/></g>`,
		"fallback": "iconmind:schema-diff-outline-bold",
	});
}
