...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.a8zlhmb2y {
  fill: currentColor;
  d: path("M7 12v7h13v-7l-6.5 3.33z");
...
</style><path class="kpd78hbge"/><path class="a8zlhmb2y"/><path class="d3ciaunii"/><path class="nvz5vg2ir"/>`,
		"fallback": "ic:twotone-mark-as-unread",
	});
}
