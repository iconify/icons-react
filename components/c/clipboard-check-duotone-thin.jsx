...
</style><g class="hntgybcog"><path class="kbaghgqhh"/><path class="s_o_4bc7h"/><path class="zva0qcbrg"/><path class="xhii43btc"/><path class="bpdfs5b6a"/></g>`,
		"fallback": "iconmind:clipboard-check-duotone-thin",
	});
}
