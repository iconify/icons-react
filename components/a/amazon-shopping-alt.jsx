...
</style><circle class="cpk0fnbgt"/><path class="mem18ybbx"/><path class="xhhfm4bls"/><rect class="rwqcrnbsz"/><path class="iyjlutbkj"/>`,
		"fallback": "arcticons:amazon-shopping-alt",
	});
}
