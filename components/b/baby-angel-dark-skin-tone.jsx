...
</style><path class="fddt2ibnu"/><circle class="zgp3pkd1y"/><path class="tlktkhbwi"/><path class="nt2-2yfmb"/><path class="wxadi7kjp"/>`,
		"fallback": "twemoji:baby-angel-dark-skin-tone",
	});
}
