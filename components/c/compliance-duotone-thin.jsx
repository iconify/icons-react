...
</style><g class="hntgybcog"><path class="kbaghgqhh"/><path class="t-wfn8s9t"/><path class="zva0qcbrg"/><path class="l0njnitvz"/><path class="o5uqjjbch"/></g>`,
		"fallback": "iconmind:compliance-duotone-thin",
	});
}
