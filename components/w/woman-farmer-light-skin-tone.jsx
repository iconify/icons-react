...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="z6a1l8x7b"/><path class="sn8ccsmky"/><path class="ted2x9b4x"/><path class="zxf1n92av"/><path class="fgsj3mb-u"/><path class="p0gn62biz"/><path class="r37-s52mk"/><path class="d9plkx-fy"/><path class="n1rkr7bxi"/><path class="vs-7kbcri"/><path class="b7hgdjd1n"/><path class="g_pisnbdf"/><path class="n2thj005d"/>`,
		"fallback": "openmoji:woman-farmer-light-skin-tone",
	});
}
