...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.bps0vnbab {
  fill: var(--svg-color--fbb041, #fbb041);
  d: path("M63.716 56.818a6.84 6.84 0 0 1-6.842 6.846H7.101a6.84 6.84 0 0 1-6.838-6.846V7.049A6.84 6.84 0 0 1 7.101.208h49.775a6.84 6.84 0 0 1 6.84 6.841z");
}

.d53_nmbzq {
  fill: var(--svg-color--85bde8, #85bde8);
  d: path("M.262 41.59h63.45V61.6H.262z");
}
