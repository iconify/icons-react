...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uymgdabjo"/><path class="clqaoybqa"/><path class="olt7jsboz"/><path class="khgxz9-2m"/><path class="bygepacgl"/><path class="py__cdbdo"/><path class="wt-c8gh6t"/><path class="jhdjnbcpn"/><path class="gey7r2b7m"/><path class="ujvkhtb4s"/><path class="or6hw-bxu"/><path class="zdagopbjx"/><path class="m2b-h3x9d"/>`,
		"fallback": "streamline-emojis:victory-hand-1",
	});
}
