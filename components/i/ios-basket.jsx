...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="qtp68xb2t"/><path class="iyktak7xc"/><path class="qx-yz_apy"/><path class="n_8i1fbwq"/><path class="y8sr8ccuc"/><path class="jek_v2g_q"/><path class="yq6n7ybra"/><path class="lqoki3bvs"/><path class="kmsg-abyy"/><path class="kk1e7tb-z"/><path class="xi0ty85fn"/>`,
		"fallback": "ion:ios-basket",
	});
}
