...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="yh58unu-v"/><path class="tu8gejrmi"/><path class="ykzn9acwh"/><path class="wudku7bxu"/><path class="da7hwvfza"/><path class="qdoivk1ha"/><path class="lj2hjwb6k"/><path class="zg_3zvbti"/><path class="o-lodidit"/><path class="vg6dkpbrn"/>`,
		"fallback": "devicon:pypi",
	});
}
