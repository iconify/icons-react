...
</style><g class="s0phu2bbs"><path class="o72p0hsyz"/><path class="vdjbxw5wp"/><path class="uwjz-dbef"/></g>`,
		"fallback": "iconmind:thumbnail-pick-outline-bold",
	});
}
