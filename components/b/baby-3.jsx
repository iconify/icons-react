...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="qe4t1tbur"/><path class="p3juhacpp"/><path class="yykln_bkc"/><path class="sqq56bc3o"/><path class="c3vf9uaxq"/><path class="h0py0dbrj"/><path class="lpa8ifwcz"/><path class="gp2xw_upy"/><path class="qcz2xjb2z"/><path class="y3ppc1b0j"/><path class="cm6cehb-s"/><path class="ghkupebiz"/>`,
		"fallback": "streamline-emojis:baby-3",
	});
}
