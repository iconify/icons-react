...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="psv_8pbss"/><path clip-rule="evenodd" class="oo_yzmb4t"/><path clip-rule="evenodd" class="wgoqhkium"/><path clip-rule="evenodd" class="gjufbsy8v"/><path class="a0gj-nbzv"/><path clip-rule="evenodd" class="nv-bqkb1x"/><path clip-rule="evenodd" class="dwbbcobye"/><path clip-rule="evenodd" class="kspoj7vnd"/></g>`,
		"fallback": "pepicons-print:truck-circle",
	});
}
