...
</style><g class="nrj6p8qat"><path class="r1tpzrwqw"/><path class="nhdf6_bjv"/><path class="hpthd_boc"/><path class="jsscmvi7f"/><path class="ysq-u10yt"/></g>`,
		"fallback": "iconmind:self-heal-duotone-regular",
	});
}
