...
```bash
npm install github:iconify/icons-react#garden
```
...
```jsx
import SampleIcon from '@iconify-react/garden/asterisk-stroke-12';
...
```jsx
import SampleIcon from '@iconify-react/garden/bookmark-fill-12';
...
```jsx
import SampleIcon from '@iconify-react/garden/moon-fill-12';
