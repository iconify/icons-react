...
</style><g class="s0phu2bbs"><path class="k6fi9qmtq"/><path class="ozi-k-boi"/><path class="ri_favbdz"/><path class="mqi2_ac9e"/></g>`,
		"fallback": "iconmind:currency-select-outline-bold",
	});
}
