...
</style><g class="nrj6p8qat"><path class="myekf3bzc"/><path class="cpvmwnddk"/><path class="rrxso7m3p"/><path class="tpi3f12bz"/></g>`,
		"fallback": "iconmind:session-count-outline-regular",
	});
}
