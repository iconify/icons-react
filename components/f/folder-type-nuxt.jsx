...
</style><path class="fzp2dn9du"/><g clip-path="url(#SVGHByoEeTK)"><path class="afkdrspjq"/></g><defs><clipPath id="SVGHByoEeTK"><path class="qx6m8obgw"/></clipPath></defs>`,
		"fallback": "vscode-icons:folder-type-nuxt",
	});
}
