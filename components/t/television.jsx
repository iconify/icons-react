...
</style><path class="ci3w3ifqo"/><path class="n6y2pccpj"/><circle class="neilyrbng"/><circle class="boeevwxic"/>`,
		"fallback": "emojione-monotone:television",
	});
}
