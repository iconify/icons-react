...
</style><path class="fddt2ibnu"/><circle class="aa38lcwip"/><path class="hgvj-zrvy"/><path class="ajg5_kqqw"/><path class="wxadi7kjp"/>`,
		"fallback": "twemoji:baby-angel-medium-dark-skin-tone",
	});
}
