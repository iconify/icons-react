...
.gfkqa2b0p {
  fill: var(--svg-color--4c6d8a, #4c6d8a);
...
</style><path class="gfkqa2b0p"/><path class="i26hz5b5d"/><path class="u01jo0bvo"/><path class="aflk2ou_p"/><path class="a0vbcybdh"/>`,
		"fallback": "vscode-icons:folder-type-dart",
	});
}
