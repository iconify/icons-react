...
</style><g class="s0phu2bbs"><path class="n48w5yb-p"/><path class="r7xk8o29f"/><path class="ibqum-bte"/><path class="cow3o_29e"/></g>`,
		"fallback": "iconmind:table-columns-split-outline-bold",
	});
}
