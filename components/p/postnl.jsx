...
</style><path class="j1v_u9btl"/><path class="lknrb06ha"/><rect class="epd9kstvr"/><path class="vwb7babhw"/><circle class="q38mcdvtx"/>`,
		"fallback": "arcticons:postnl",
	});
}
