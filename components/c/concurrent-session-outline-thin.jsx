...
</style><g class="hntgybcog"><path class="iymet_cml"/><path class="gwl0nvbom"/><path class="efcgw323v"/><path class="pbh8k3r0o"/><path class="jw1bp8juq"/></g>`,
		"fallback": "iconmind:concurrent-session-outline-thin",
	});
}
