...
</style><g class="hntgybcog"><path class="todxtrbsg"/><path class="rl2nbiksm"/><path class="og9kjwb4a"/><path class="p3ptowbul"/></g>`,
		"fallback": "iconmind:layer-down-outline-thin",
	});
}
