...
</style><g class="nrj6p8qat"><path class="acyg6nb1v"/><path class="ctdwryy5l"/><path class="d5_p0tpur"/><path class="ciwbnxb_b"/><path class="jnysnpbhj"/></g>`,
		"fallback": "iconmind:fork-outline-regular",
	});
}
