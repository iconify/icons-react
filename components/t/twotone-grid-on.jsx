...
.q431oachs {
  fill: currentColor;
  d: path("M10 10h4v4h-4zm0 6h4v4h-4zM4 4h4v4H4zm0 6h4v4H4zm0 6h4v4H4zM16 4h4v4h-4zm0 6h4v4h-4zm0 6h4v4h-4zM10 4h4v4h-4z");
  opacity: var(--svg-opacity--0-3, 0.3);
}
</style><path class="q431oachs"/><path class="niq007nnz"/>`,
		"fallback": "ic:twotone-grid-on",
	});
}
