...
</style><path class="c4c9yccvy"/><path class="voomntv7r"/><path class="bpi84tbyg"/><path class="m30ttsbcg"/><path class="vv475mbur"/>`,
		"fallback": "emojione:hammer",
	});
}
