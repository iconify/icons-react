...
</style><g class="s0phu2bbs"><path class="vo1-lv2pt"/><path class="oz3eccbug"/><path class="v9tp15bnh"/><path class="o3jwr8bmt"/><path class="fa5_klbta"/></g>`,
		"fallback": "iconmind:vat-return-outline-bold",
	});
}
