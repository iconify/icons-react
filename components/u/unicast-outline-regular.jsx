...
</style><g class="nrj6p8qat"><path class="k6fi9qmtq"/><path class="it83nbbll"/><path class="l0v-b4kbr"/><path class="d_yxl29go"/></g>`,
		"fallback": "iconmind:unicast-outline-regular",
	});
}
