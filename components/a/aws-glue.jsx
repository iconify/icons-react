...
</style><defs><linearGradient id="SVGusebDeuy" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="o1-idcc_z"/><stop offset="100%" class="rr6asqhtm"/></linearGradient></defs><path fill="url(#SVGusebDeuy)" class="tmbkaq7lv"/><path class="l81hfmbjk"/>`,
		"fallback": "logos:aws-glue",
	});
}
