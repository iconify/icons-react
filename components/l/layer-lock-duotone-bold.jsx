...
</style><g class="s0phu2bbs"><path class="kbqa6qgaw"/><path class="g40hmznrk"/><path class="eywlytabr"/><path class="jgql0jyyx"/><path class="ypui4ib8n"/></g>`,
		"fallback": "iconmind:layer-lock-duotone-bold",
	});
}
