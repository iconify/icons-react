...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<defs><path id="SVGbAUQKU6v" class="fh1xwbbbl"/></defs><g class="ft5dv1b6b"><use href="#SVGbAUQKU6v"/><use href="#SVGbAUQKU6v"/><path class="bq-t95byt"/><path class="dgyfe-b_i"/><path class="ntvryxjzn"/><path class="o1l-eibzl"/><path class="deztmt8gd"/><path class="hg--o58tf"/><path class="w2fo7nbhd"/><path class="n2ao97bce"/><path class="e66bwacla"/></g>`,
		"fallback": "streamline-ultimate-color:coffee-espresso-machine",
	});
}
