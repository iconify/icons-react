...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<defs><mask id="SVGEFuhhdeR"><path class="g_1xrq q7qpvx xizzfp"/><path class="ainywl g_1xrq nf43cj x36t0d"/><path class="g_1xrq q7qpvx x36t0d"/><circle class="nf43cj o3umjd"/></mask></defs><path mask="url(#SVGEFuhhdeR)" class="botfzx"/>`,
		"fallback": "line-md:map-marker-multiple-alt-filled-loop",
	});
}
