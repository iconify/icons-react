...
</style><g class="nrj6p8qat"><path class="c4my-jbpv"/><path class="qkea2dbiu"/><path class="g4lz7ob4p"/><path class="i4ksfdyrv"/></g>`,
		"fallback": "iconmind:query-cache-outline-regular",
	});
}
