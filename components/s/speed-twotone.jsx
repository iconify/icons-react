...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<defs><mask id="SVGK9crzczg"><path class="qw8_4v"/><path class="o4f3wc"/></mask></defs><path mask="url(#SVGK9crzczg)" class="lsejuv ydovum"/><path class="osyjhu ydovum"/>`,
		"fallback": "line-md:speed-twotone",
	});
}
