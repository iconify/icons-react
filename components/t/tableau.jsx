...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="fw083vbat"/><path class="e_zb-7beo"/><path class="t06aricwk"/><path class="qah69vldv"/><path class="ukjnooizv"/><path class="k1byq0bvi"/><path clip-rule="evenodd" class="qji9niyta"/><path class="c_-m2p8sf"/>`,
		"fallback": "thesvg-color:tableau",
	});
}
