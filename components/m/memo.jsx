...
</style><path class="ku125-uti"/><path class="q8nebdcjf"/><g class="q1tv0ue9d"><path class="zashw-bne"/><path class="x5iso_boj"/><path class="i27uwzb-a"/></g><path class="msfzd70ad"/><path class="snxg8tu2w"/><path class="bkj5vznzu"/><path class="btn6krd4j"/><path class="tbsx4yl4d"/><path class="rx83orbgv"/><path class="ylzd9hd0w"/><path class="bhlmi6btw"/>`,
		"fallback": "emojione:memo",
	});
}
