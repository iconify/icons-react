...
</style><path class="wlklw7j4l"/><defs><path id="SVGKWyaFZun" class="myeaa8bof"/></defs><clipPath id="SVGJDYcnGqI"><use href="#SVGKWyaFZun"/></clipPath><g clip-path="url(#SVGJDYcnGqI)" class="tcw5ljb1b"><path class="zkoo3518s"/></g><defs><use href="#SVGKWyaFZun" id="SVG6ObibegY"/></defs><clipPath id="SVGHoDwib4P"><use href="#SVG6ObibegY"/></clipPath><g clip-path="url(#SVGHoDwib4P)" class="t3q4o6ulj"><path class="hi_dlcbdf"/></g>`,
		"fallback": "noto:backhand-index-pointing-left",
	});
}
