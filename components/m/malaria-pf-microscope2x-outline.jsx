...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path class="i9p6gnbba"/><path clip-rule="evenodd" class="mrayr_b-i"/><path class="p1bdyjkjg"/><path clip-rule="evenodd" class="qtbpumbkm"/><path class="ag6or2e3i"/><path clip-rule="evenodd" class="i1j5o3bip"/><path class="cspock6kw"/><path clip-rule="evenodd" class="w_lbwnh_b"/><path clip-rule="evenodd" class="eedmhxbrq"/></g>`,
		"fallback": "healthicons:malaria-pf-microscope2x-outline",
	});
}
