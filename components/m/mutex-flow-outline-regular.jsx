...
</style><g class="nrj6p8qat"><path class="cn4r8yd4q"/><path class="zn5d9ob7n"/><path class="yxo79mbqo"/><path class="i9l-u8avp"/></g>`,
		"fallback": "iconmind:mutex-flow-outline-regular",
	});
}
