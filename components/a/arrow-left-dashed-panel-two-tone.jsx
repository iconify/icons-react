...
.qtmxsmhnj {
  d: path("M4 15.5H14M9 10L3.40208 15.1314C3.1859 15.3296 3.1859 15.6704 3.40208 15.8686L9 21");
}
</style><g class="nrj6p8qat"><path class="es1ry8oas"/><path class="qtmxsmhnj"/></g>`,
