...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="almky1j9k"/><path class="dbq485b4e"/><path class="ocif-h9bu"/><path class="juu6lxbqs"/><path class="s_f6m4b-b"/><path class="owomm5jgl"/><path class="uyqmi2imv"/><path class="pc5o0nowq"/><path class="dbh9tstmw"/><path class="uckm0oszt"/>`,
		"fallback": "streamline-emojis:fearful-face",
	});
}
