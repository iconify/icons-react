...
</style><g class="s0phu2bbs"><path class="lyk3lbb0z"/><path class="ksh4iaclj"/><path class="h0xx2obvc"/><path class="zpl29uvhf"/><path class="voz_x46if"/></g>`,
		"fallback": "iconmind:elt-outline-bold",
	});
}
