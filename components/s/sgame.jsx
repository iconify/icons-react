...
</style><path class="ztqpxqynn"/><path class="vjfvixzvo"/><path class="wmr_6onjs"/><path class="dqtdqdb0c"/><path class="fcl44ebjy"/>`,
		"fallback": "arcticons:sgame",
	});
}
