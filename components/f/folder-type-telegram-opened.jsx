...
</style><defs><linearGradient id="SVGde1AEdHM" x1="500" x2="500" y1="0" y2="992.583" gradientUnits="userSpaceOnUse"><stop offset="0%" class="od14k4bxt"/><stop offset="100%" class="n-o4sdbun"/></linearGradient></defs><path class="j4zkc7bbw"/><g transform="translate(11 11)scale(.019)" class="bi12bsetm"><circle fill="url(#SVGde1AEdHM)" class="lmk2kobiz"/><path class="q_l6jobnu"/></g>`,
		"fallback": "vscode-icons:folder-type-telegram-opened",
	});
}
