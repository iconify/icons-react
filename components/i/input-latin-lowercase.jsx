...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g clip-rule="evenodd" class="ivrt0wb5e"><path class="kt09dibct"/><path class="c_8wcib4r"/><path class="gpr7m5bhj"/><path class="rmvrof9sh"/></g><path class="naeprdbjc"/><path class="ey8adnbhg"/><path class="fw-r7u5mz"/><path class="lf0zjhoag"/><path class="jc3j16jmo"/><path class="bu9283b5n"/><path class="qo3pbihjv"/><path class="zz83y3gyo"/><path class="igf3spmgo"/>`,
		"fallback": "openmoji:input-latin-lowercase",
	});
}
