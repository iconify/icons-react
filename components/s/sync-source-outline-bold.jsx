...
</style><g class="s0phu2bbs"><path class="b_3lf0wwh"/><path class="j6vltz2ns"/><path class="pi15tzbod"/><path class="mi_m6achy"/></g>`,
		"fallback": "iconmind:sync-source-outline-bold",
	});
}
