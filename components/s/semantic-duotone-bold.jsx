...
</style><g class="s0phu2bbs"><path class="sqmravmye"/><path class="hbdbg_bcy"/><path class="lyjarcbwz"/><path class="cspceacnq"/><path class="doxmgbcyh"/></g>`,
		"fallback": "iconmind:semantic-duotone-bold",
	});
}
