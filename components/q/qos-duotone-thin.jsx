...
</style><g class="hntgybcog"><path class="np-7bibzi"/><path class="xcmlr3twl"/><path class="j2zusvb7j"/><path class="h1mhbbbek"/><path class="g_sn6dbji"/><path class="oxrxwybca"/><path class="bg96ko_da"/><path class="z9p0k9q-r"/></g>`,
		"fallback": "iconmind:qos-duotone-thin",
	});
}
