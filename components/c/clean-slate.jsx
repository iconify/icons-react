...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="d-q8_6bdy"/><path class="jotj22eow"/><path class="b8lf-lbgx"/><path class="d4-atmb_k"/><path class="f_ovi2aeo"/><path class="iwe3kjpvu"/><path class="z5pl81b9i"/>`,
		"fallback": "selfhst:clean-slate",
	});
}
