...
</style><g class="nrj6p8qat"><path class="qacyytb8p"/><path class="y249ggb8a"/><path class="k8z6rmbmi"/><path class="wskxlyzso"/><path class="kuxgvn7ri"/></g>`,
		"fallback": "iconmind:adapter-duotone-regular",
	});
}
