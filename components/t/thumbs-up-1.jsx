...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uymgdabjo"/><path class="kcfrept5s"/><path class="l_2jpmb8x"/><path class="q4_4dgbnf"/><path class="vqb07qbnc"/><path class="nj1d5sbah"/><path class="yhpmf1sit"/><path class="jjmwtcs7l"/><path class="cd6cqb4ga"/><path class="uqscxs9tt"/><path class="p4g1j0bvu"/><path class="n2d6zkbzl"/>`,
		"fallback": "streamline-emojis:thumbs-up-1",
	});
}
