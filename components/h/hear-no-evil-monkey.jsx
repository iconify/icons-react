...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="delknlbkn"/><circle class="fyul6pbtc"/><path class="z15cccc_m"/><path class="a692i-byw"/><path class="no2srq9sm"/><path class="mr07v9bgc"/><path class="dxuxuoh9r"/><path class="pcmq2dw0l"/><path class="tdk5bropo"/><circle class="v0eg2kbfe"/><circle class="y05uwv5ow"/><path class="wxh-f5bde"/><circle class="v_xwfg7vv"/><circle class="d9hvbu-7e"/><path class="x-ej1-1_p"/>`,
		"fallback": "openmoji:hear-no-evil-monkey",
	});
}
