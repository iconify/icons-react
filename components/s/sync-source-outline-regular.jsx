...
</style><g class="nrj6p8qat"><path class="b_3lf0wwh"/><path class="j6vltz2ns"/><path class="pi15tzbod"/><path class="mi_m6achy"/></g>`,
		"fallback": "iconmind:sync-source-outline-regular",
	});
}
