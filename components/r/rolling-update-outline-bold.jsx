...
</style><g class="s0phu2bbs"><path class="d8z1r1beo"/><path class="wzx0dxb2r"/><path class="lgr612izs"/><path class="ync9d6bsc"/></g>`,
		"fallback": "iconmind:rolling-update-outline-bold",
	});
}
