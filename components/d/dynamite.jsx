...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="e_a-8tb_c"/><defs><circle id="SVGifCBlePx" class="effisz2bi"/></defs><clipPath id="SVGtcVZrdEc"><use href="#SVGifCBlePx"/></clipPath><g clip-path="url(#SVGtcVZrdEc)"><path class="n7zlcfkio"/><path class="z4fwj_jnm"/><path class="g63w97btf"/><path class="j_0-kqx7c"/><path class="l_4ahqb7s"/><path class="a9yoro8pm"/><path class="x6go9dbvq"/><path class="lb7aqybrx"/><path class="q1jiwnbgd"/><path class="bgndw7b6g"/><path class="d82undbrl"/><path class="aeszb3bml"/><path class="za7fhdcoz"/></g>`,
		"fallback": "flat-ui:dynamite",
	});
}
