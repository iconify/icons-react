...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="h8dt7n_yi"/><path class="f3tr6_blh"/><path class="o1ar_gbsb"/><path class="ulf6gr64r"/><path class="berm0zb6c"/><path class="r90lj_b3g"/><path class="ieg66_vmf"/><path class="ll_w6f6ym"/><path class="h5e-3tb-s"/>`,
		"fallback": "ion:ios-flower",
	});
}
