...
</style><defs><path id="SVGYp4aOefB" class="f05bp1-8j"/></defs><use href="#SVGYp4aOefB" class="wok4wpqzw"/><clipPath id="SVGOyndMrMU"><use href="#SVGYp4aOefB"/></clipPath><path clip-path="url(#SVGOyndMrMU)" class="fhnw-xbgk"/><path class="vxnekltfn"/><path class="s9pvirbxy"/>`,
		"fallback": "noto-v1:dolphin",
	});
}
