...
</style><g class="s0phu2bbs"><path class="nzpsuduik"/><path class="vhnbtvbtn"/><path class="r5bn6xbek"/><path class="mqi2_ac9e"/></g>`,
		"fallback": "iconmind:page-scroll-outline-bold",
	});
}
