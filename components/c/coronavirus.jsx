...
</style><circle class="xm8sqtbrk"/><circle class="iyf1h2bfa"/><circle class="vac-ctl-h"/><circle class="l4w0sbbfw"/><circle class="zh9wqmvpl"/><circle class="bnpv4cbun"/><circle class="r4-9sedra"/><circle class="oqf_5qb9i"/><circle class="h2jq5fbwe"/><circle class="t238zrbfy"/><path class="rfznklbqt"/>`,
		"fallback": "arcticons:coronavirus",
	});
}
