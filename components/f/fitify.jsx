...
</style><path class="liq_uvbcf"/><path class="qqxgvfwxd"/><circle class="ecq2gowzv"/><path class="jb6ht7bra"/><path class="t70d0wirp"/>`,
		"fallback": "arcticons:fitify",
	});
}
