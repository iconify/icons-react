...
</style><defs><radialGradient id="SVGqKXmkdYQ" cx="-10.316" cy="31.126" r="13.788" gradientTransform="translate(26.52 -9.307)" gradientUnits="userSpaceOnUse"><stop offset="0" class="vc--wpv5i"/><stop offset=".5" class="irf8jsb_m"/><stop offset="1" class="c0xyygbvy"/></radialGradient></defs><path class="gw9vsx99t"/><ellipse fill="url(#SVGqKXmkdYQ)" class="xog_ilbax"/><ellipse class="yt-lbeksd"/><path class="y5x_geqsy"/><path class="qzzcr3boi"/>`,
		"fallback": "vscode-icons:folder-type-php",
	});
}
