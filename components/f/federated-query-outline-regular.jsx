...
</style><g class="nrj6p8qat"><path class="c_mfncbzl"/><path class="rj_yrybsf"/><path class="axg5c-q0a"/><path class="nzb-j6sxx"/><path class="k43ew0kyq"/></g>`,
		"fallback": "iconmind:federated-query-outline-regular",
	});
}
