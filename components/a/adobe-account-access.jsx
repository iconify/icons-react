...
</style><rect class="j3s9ivbxi"/><path class="b4xmp0bix"/><path class="fde1elbwd"/><path class="jnmr7bcjc"/>`,
		"fallback": "arcticons:adobe-account-access",
	});
}
