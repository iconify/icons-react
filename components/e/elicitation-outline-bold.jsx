...
</style><g class="s0phu2bbs"><path class="crp-16bgl"/><path class="yomctlb4k"/><path class="ctc5-4b5p"/><path class="eylqpv51p"/></g>`,
		"fallback": "iconmind:elicitation-outline-bold",
	});
}
