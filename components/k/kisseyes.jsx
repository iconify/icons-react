...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="h32t530tv"/><path class="n9cednr3v"/><path class="r91cheslv"/><path class="ny9s89b_w"/><path class="aqe9jzbbk"/><path class="y4t8fmb1h"/><path class="aj94ttbep"/><path class="civu94tjx"/><path class="jhorxltif"/><path class="jp6ft1czf"/>`,
		"fallback": "fxemoji:kisseyes",
	});
}
