...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<defs><mask id="SVGerhOJbwt"><path class="w7ycyt"/><path class="c5xdmn tt3b6d zxndow"/><path class="c5xdmn s9nboe zxndow"/><circle class="i7fxbk ywk93s"/><circle class="ex4uqx i7fxbk"/><circle class="i7fxbk znrilg"/><path class="c5xdmn i_5n8q oxx-om"/></mask></defs><path mask="url(#SVGerhOJbwt)" class="botfzx"/><path class="c5xdmn gd_4-q i_5n8q"/>`,
		"fallback": "line-md:mushroom-off-filled",
	});
}
