...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.aic4x5b0h {
  fill: var(--svg-color--ffab93, #ffab93);
  d: path("M57.24 24.22c.07 1.48 3.45 3.45 5.21 4.72s4.29 4.05 5.28 3.87c1.75-.31 1.62-7.74 1.27-11.05s-2.11-8.8-3.24-9.22s-4.05 3.79-4.79 4.93c-1.27 1.97-3.8 5.42-3.73 6.75");
}

.cec4fvbpy {
  fill: var(--svg-color--dedede, #dedede);
  d: path("M41.61 37.99c-.55 1.03-1.51 1.69-2.3 1.2s-.34-2.06.1-2.65s1.23-1.33 2.01-.84c.8.5.56 1.61.19 2.29");
}
