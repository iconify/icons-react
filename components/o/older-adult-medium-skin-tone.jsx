...
</style><path class="ykvgozb8x"/><path class="aq-7szbux"/><path class="sbpdpfbix"/><path class="c-ntt1b8g"/><path class="ut2d5ibrr"/>`,
		"fallback": "twemoji:older-adult-medium-skin-tone",
	});
}
