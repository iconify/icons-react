...
Browse all icons: **[Preview Bootstrap Icons](https://icon-sets.iconify.design/bi/)**

## Installation

```bash
npm install github:iconify/icons-react#bi
```
...
```jsx
import SampleIcon from '@iconify-react/bi/graph-up';
...
```jsx
import SampleIcon from '@iconify-react/bi/card-image';
...
```jsx
import SampleIcon from '@iconify-react/bi/code-slash';
