...
</style><g class="hntgybcog"><path class="z92okmbgh"/><path class="i4enr0m-s"/><path class="jrpnc2pnl"/><path class="r182r524c"/><path class="wz1gh1b4o"/></g>`,
		"fallback": "iconmind:prompt-template-duotone-thin",
	});
}
