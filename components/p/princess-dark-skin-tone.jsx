...
</style><path class="c4gldibut"/><path class="c8az14bqa"/><path class="agw7z_01y"/><path class="tz-4kebqz"/><path class="mf-6debwy"/><circle class="vxeh-o70a"/><path class="vbq18bipa"/><path class="sf0sfxlmu"/><circle class="qt-d8l05k"/><path class="xhiok0bor"/><path class="i8-gnnkyc"/><path class="tqilwbbyi"/><circle class="auab7e0qj"/><path class="obji9fbtz"/><g class="cluxj1brx"><path class="h79pu4bft"/><ellipse class="dkzw2si8o"/><path class="s0b0itbuy"/></g>`,
		"fallback": "emojione:princess-dark-skin-tone",
	});
}
