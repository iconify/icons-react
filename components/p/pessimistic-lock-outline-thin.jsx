...
</style><g class="hntgybcog"><path class="rqp8h2nfx"/><path class="cyvvfd0tv"/><path class="buvqhc29l"/><path class="pmuiqo95v"/></g>`,
		"fallback": "iconmind:pessimistic-lock-outline-thin",
	});
}
