...
</style><g class="s0phu2bbs"><path class="g00uv-b-x"/><path class="koh8ckbdb"/><path class="k2mg4f2ls"/><path class="un5tssbqw"/></g>`,
		"fallback": "iconmind:same-day-delivery-outline-bold",
	});
}
