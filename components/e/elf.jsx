...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="m0u3czblj"/><path class="gs03v_q9g"/><path class="vs4zh0bpe"/><path class="bmu0p_bfu"/><g class="x4u8pbwjc"><path class="wbrbhdb-b"/><path class="mfm66mb-f"/></g><path class="e92zz_b0k"/><path class="idh88ol5q"/><path class="vzob3pdol"/><path class="wshm-gqdu"/><circle class="tqw0884fe"/><path class="ts62ygwrs"/><path class="fr0hjibbj"/><path class="v898yxnlx"/>`,
		"fallback": "openmoji:elf",
	});
}
