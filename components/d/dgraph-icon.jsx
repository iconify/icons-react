...
</style><defs><linearGradient id="SVGfLRx2bhb" x1="0%" x2="100%" y1="50%" y2="50%"><stop offset="0%" class="tmoh0h5bl"/><stop offset="100%" class="id84a79ys"/></linearGradient></defs><path fill="url(#SVGfLRx2bhb)" class="yyyjnob9k"/>`,
		"fallback": "logos:dgraph-icon",
	});
}
