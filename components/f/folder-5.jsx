...
.r8fhdisqi {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M20.074 32.068c1.002.836 1.837 1.17 4.01 1.17h.334c2.004 0 3.675-1.67 3.675-3.676c0-2.005-1.67-3.675-3.675-3.675h-4.512v-5.848h8.187");
}
</style><path class="h0qgeuwow"/><path class="r8fhdisqi"/>`,
