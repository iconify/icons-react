...
</style><defs><linearGradient id="SVG5lqYietg" x1="50%" x2="50%" y1="0%" y2="100%"><stop offset="0%" class="tubblo3vt"/><stop offset="100%" class="a2xz_acbv"/></linearGradient></defs><path fill="url(#SVG5lqYietg)" class="r_67rzbkd"/><path class="ya6b79d8a"/>`,
		"fallback": "logos:apple-app-store",
	});
}
