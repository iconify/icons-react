# @iconify-react/devicon-plain

⚠️ This is an alternative repository. Main repository has moved to [GitLab](https://gitlab.com/iconify-icons/react/-/tree/devicon-plain).
**Devicon Plain**
...
```bash
npm install gitlab:iconify-icons/react#devicon-plain
```

or
```bash
npm install github:iconify/icons-react#devicon-plain
```
...
```jsx
import SampleIcon from '@iconify-react/devicon-plain/kotlin';
...
```jsx
import SampleIcon from '@iconify-react/devicon-plain/bulma';
...
```jsx
import SampleIcon from '@iconify-react/devicon-plain/logstash';
