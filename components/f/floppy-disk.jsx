...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="p_fgewbfz"/><path class="j5z5kxaej"/><path class="gw2zvbkjl"/><path class="undt93b5m"/><path class="jfczf31pd"/><path class="la_rxi13k"/><path class="aby058bon"/><path class="gcokxdbpe"/><path class="m_m-vchii"/><path class="t_3j55edj"/>`,
		"fallback": "streamline-emojis:floppy-disk",
	});
}
