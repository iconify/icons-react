...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="enr159rza"/><g class="e_raf5bng"><path class="ygbq0jubt"/><path class="ouu5_nsrf"/><path class="k0td-8bku"/></g><path class="r0pv2pucs"/><path class="ruewaub4d"/><path class="s4sui9lbl"/><path class="lqg0wwbfq"/><path class="zafc2c0gt"/><path class="nuw04vbko"/>`,
		"fallback": "openmoji:woman-shrugging-dark-skin-tone",
	});
}
