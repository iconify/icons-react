...
</style><defs><linearGradient id="SVGIvsZpeui" x2="1" y1="500.088" y2="500.088" gradientTransform="matrix(-45.12 188.295 188.295 45.12 -93712.597 -22304.936)" gradientUnits="userSpaceOnUse"><stop offset="0" class="cxqk8zbds"/><stop offset="1" class="l2k064n6d"/></linearGradient><linearGradient id="SVGVGVd6bfS" x2="1" y1="500.036" y2="500.036" gradientTransform="matrix(153.45 91.586 91.586 -153.45 -45608.455 77101.769)" gradientUnits="userSpaceOnUse"><stop offset="0" class="cxqk8zbds"/><stop offset="1"/></linearGradient></defs><path class="qh3zo5b9y"/><path class="xp_t88bbs"/><path class="oud57rkkt"/><path class="afexhcqto"/><path class="v99kihukf"/><path class="mpde6ubvh"/><path class="o5otz7bts"/><path fill="url(#SVGIvsZpeui)" class="x3x-yvb5g"/><path fill="url(#SVGVGVd6bfS)" class="uolg82rub"/>`,
		"fallback": "vscode-icons:folder-type-light-cypress-opened",
	});
}
