...
</style><g class="nrj6p8qat"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="fmv013bbw"/><path class="bxyszcb7e"/></g>`,
		"fallback": "iconmind:ablation-outline-regular",
	});
}
