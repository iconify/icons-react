...
import '../../css/k/kz-9cujbd.css';
import '../../css/i/iiipjrj7g.css';
import '../../css/g/ggpc0pvyr.css';
import '../../css/m/m4-rq0b8j.css';
import '../../css/t/ty0iq851h.css';
import '../../css/l/ljgygwhfo.css';
import '../../css/b/bgy-vfbix.css';
...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uyl23qbli"/><path class="kz-9cujbd"/><path class="iiipjrj7g"/><path class="ggpc0pvyr"/><path class="m4-rq0b8j"/><path class="ty0iq851h"/><path class="ljgygwhfo"/><path class="bgy-vfbix"/><path class="rie9cxbes"/><path class="gfmyjjb2n"/><path class="q34pwzq2k"/><path class="qlv4uxhmv"/><path class="kmoiy2bty"/><path class="dln7ycm5p"/><path class="el0ghgbew"/><path class="hrtw9spbr"/><path class="zxd_nibet"/><path class="h9iq_m70a"/>`,
		"fallback": "streamline-emojis:prince-2",
	});
}
