...
</style><g class="ft5dv1b6b"><defs><mask id="SVGFu4GlbfV"><path class="k5-vjlrin"/><path clip-rule="evenodd" class="b1hh0tx-e"/></mask></defs><circle mask="url(#SVGFu4GlbfV)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:heart-circle-filled",
	});
}
