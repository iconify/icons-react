...
</style><g class="nrj6p8qat"><path class="enrpg0aoq"/><path class="dfcdzc65k"/><path class="kwx_mgnfk"/><path class="aeyekmbly"/><path class="kdmnrabtq"/><path class="i98jgvxhu"/></g>`,
		"fallback": "iconmind:data-vault-outline-regular",
	});
}
