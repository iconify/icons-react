...
</style><g class="s0phu2bbs"><path class="yrm0q7bju"/><path class="wxaqw6igd"/><path class="r3yoejbzj"/><path class="d8z1r1beo"/><path class="wzx0dxb2r"/><path class="v9tp15bnh"/><path class="dvmrrybho"/></g>`,
		"fallback": "iconmind:repeat-duotone-bold",
	});
}
