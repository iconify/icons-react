...
</style><g class="z_7mkfbjc"><path class="x2l6lrbmp"/><path class="e-_4p_bxp"/><path class="ajnbemgkp"/><path class="nfza0mb9p"/><path class="egxbwtbuz"/><path class="otsbf12tu"/></g>`,
		"fallback": "vscode-icons:file-type-brew",
	});
}
