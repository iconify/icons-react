...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><g class="nctb2ac4r"><path class="p1m3_jb_z"/><path clip-rule="evenodd" class="s_fkl0bba"/><path class="k_-zi13sx"/><path clip-rule="evenodd" class="e06i41bqk"/><path clip-rule="evenodd" class="eniaalbyz"/></g><path clip-rule="evenodd" class="b4rvv77mk"/><path clip-rule="evenodd" class="u3s5p0b3s"/><path clip-rule="evenodd" class="bx5q0wb9m"/></g>`,
		"fallback": "pepicons:next-track-print",
	});
}
