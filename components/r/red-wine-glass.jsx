...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uyri__8fx"/><path class="i85pngovn"/><path class="trc_cb1yc"/><path class="uqheekb6z"/><path class="vel16u-9t"/><path class="j-prx2slx"/><path class="xstllqb9v"/><path class="wx_q2iltk"/><path class="qvp-j56qe"/><path class="ne99z7b7k"/><path class="sr0ukizpk"/>`,
		"fallback": "streamline-emojis:red-wine-glass",
	});
}
