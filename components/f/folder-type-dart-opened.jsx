...
</style><path class="lu9lo-olz"/><path class="i26hz5b5d"/><path class="u01jo0bvo"/><path class="aflk2ou_p"/><path class="a0vbcybdh"/>`,
		"fallback": "vscode-icons:folder-type-dart-opened",
	});
}
