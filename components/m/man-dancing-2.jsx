...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="p928ljbib"/><path class="z_p7_rbpw"/><path class="q_ofj8bpx"/><path class="qkk5e_94p"/><path class="phlycoujj"/><path class="my5_-ab6h"/><path class="m07299bvs"/><path class="wkqqc1bch"/><path class="ir736-b5n"/><path class="xlgkg9fut"/><path class="p_u9-ob-s"/><path class="ukbj9-z2l"/>`,
		"fallback": "streamline-emojis:man-dancing-2",
	});
}
