...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<circle class="clr-i-outline clr-i-outline-path-1 os_ncacwq"/><circle class="clr-i-outline clr-i-outline-path-2 sweyqnbwx"/><circle class="a0enb4j2q clr-i-outline clr-i-outline-path-3"/><circle class="clr-i-outline clr-i-outline-path-4 rluk9abvi"/><circle class="clr-i-outline clr-i-outline-path-5 q1-vaj8oz"/><circle class="clr-i-outline clr-i-outline-path-6 phz7lwb8a"/><path class="m2o3sh-9c"/>`,
		"fallback": "clarity:drag-handle-corner-line",
	});
}
