...
</style><defs><linearGradient id="SVGfnwjfeci" x1="17.42%" x2="56.516%" y1="21.86%" y2="97.437%"><stop offset="0%" class="b9t0jfbpc"/><stop offset="100%" class="i9wgweb5j"/></linearGradient></defs><path fill="url(#SVGfnwjfeci)" class="kn0yhqbqq"/><path class="ma3ee5bcl"/>`,
		"fallback": "logos:c-sharp",
	});
}
