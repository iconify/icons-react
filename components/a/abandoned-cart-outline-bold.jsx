...
</style><g class="s0phu2bbs"><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="lit20acsf"/><path class="olup7y72x"/></g>`,
		"fallback": "iconmind:abandoned-cart-outline-bold",
	});
}
