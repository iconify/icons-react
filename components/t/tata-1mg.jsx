...
</style><path class="nec760bny"/><path class="vvfv62k6q"/><rect transform="matrix(-1 0 0 -1 68.246 59.599)" class="skcp_6bwj"/><path class="lrs6dob5q"/>`,
		"fallback": "arcticons:tata-1mg",
	});
}
