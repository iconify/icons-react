...
</style><path class="v9erbbbht"/><path class="sawt_g-bm"/><path class="x3hdebb3q"/><path class="kqzryhbet"/>`,
		"fallback": "vscode-icons:folder-type-node-opened",
	});
}
