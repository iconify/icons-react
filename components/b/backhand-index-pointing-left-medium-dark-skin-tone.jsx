...
</style><path class="mor16ub6w"/><defs><path id="SVGKWyaFZun" class="myeaa8bof"/></defs><clipPath id="SVGJDYcnGqI"><use href="#SVGKWyaFZun"/></clipPath><g clip-path="url(#SVGJDYcnGqI)" class="k4qe_xbxk"><path class="zkoo3518s"/></g><defs><use href="#SVGKWyaFZun" id="SVG6ObibegY"/></defs><clipPath id="SVGHoDwib4P"><use href="#SVG6ObibegY"/></clipPath><g clip-path="url(#SVGHoDwib4P)" class="u0e24bcck"><path class="hi_dlcbdf"/></g>`,
		"fallback": "noto:backhand-index-pointing-left-medium-dark-skin-tone",
	});
}
