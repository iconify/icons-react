...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ieyn-bn4v"/><circle class="ijyrlebml"/><circle class="m7kn11b3a"/><path class="an4o2p2yb"/><path class="go0acxb1z"/><circle class="ig9gnw_ib"/><circle class="tgu38o2_j"/><circle class="me_wq-6vn"/><circle class="tr1m34oqy"/><circle class="holf0jzvb"/><path class="y8o3c_b5l"/>`,
		"fallback": "flag:cefta-1x1",
	});
}
