...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="k6s6p9r1w"/><defs><circle id="SVGifCBlePx" class="effisz2bi"/></defs><clipPath id="SVGtcVZrdEc"><use href="#SVGifCBlePx"/></clipPath><g clip-path="url(#SVGtcVZrdEc)"><path class="oiqdnp90t"/><path class="j3f6i8bmr"/><path class="wdy104bhr"/><path class="hnenyfb4h"/><path class="s1n88ybmv"/><path class="fhkbepiex"/><path class="avvl4wbts"/><path class="m-laajaqr"/><path class="s19l0d2yg"/><path class="i-7kxpc8x"/></g>`,
		"fallback": "flat-ui:support",
	});
}
