...
</style><path class="qk_l6_1ll"/><path class="akqw8lbej"/><path class="dfa4wobji"/><circle class="nd2jz9byc"/><path class="nj32fccgk"/><circle class="nb7r6x--w"/><path class="biup6s7bb"/><circle class="kl99ixafu"/><circle class="j0t9gzkrs"/><path class="fm01jb4np"/><path class="u82wlcc6b"/><circle class="s26jcik0z"/><path class="ypihxccmh"/>`,
		"fallback": "arcticons:cut-the-rope-2",
	});
}
