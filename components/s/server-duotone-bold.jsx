...
</style><g class="s0phu2bbs"><path class="cb89o3m_u"/><path class="g7y1om9dd"/><path class="w0cwozbjc"/><path class="olhk6j3ge"/><path class="e1vgu1brh"/><path class="jotdonbiv"/><path class="n2l08-bfj"/><path class="ccgk_xb3n"/></g>`,
		"fallback": "iconmind:server-duotone-bold",
	});
}
