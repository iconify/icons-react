...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ft5dv1b6b"><path class="iirm7nb1z"/><path class="py47nybev"/><path class="avg_ycbtp"/><path class="ibo6wjbzd"/><path class="w1te5nfvj"/><path class="xw2oaw26z"/><path class="lcjg95b6g"/><path class="a991vwssg"/></g>`,
		"fallback": "unjs:unenv",
	});
}
