...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.ba-zjvr9e {
  fill: currentColor;
  d: path("M2 8H8V20H5C3.34315 20 2 18.65685 2 17V8Z");
  stroke: none;
}
...
</style><g class="nrj6p8qat"><path class="ba-zjvr9e"/><path class="ef1982bwa"/></g>`,
		"fallback": "keyline-icons:table-pivot-fill",
	});
}
