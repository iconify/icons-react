...
</style><g class="hntgybcog"><path class="vmeffnbkw"/><path class="rv_spwblc"/><path class="vch9hc4be"/><path class="cc3l45wyt"/></g>`,
		"fallback": "iconmind:multi-package-duotone-thin",
	});
}
