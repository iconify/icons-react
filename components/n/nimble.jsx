...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="t3o4bublz"/><path class="f-a1o0b_o"/><path class="hu0jjp25c"/><path class="hywfbs4sg"/><path class="uahwao0ct"/><path class="m99gr1aku"/><path class="wr4a4yb7u"/>`,
		"fallback": "thesvg-color:nimble",
	});
}
