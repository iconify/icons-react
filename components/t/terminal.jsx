...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="hqd8fcboz"><path class="jw6_s00qn"/><path class="uhr2_rb0p"/><path class="yk6248rpk"/><path class="ce8o-4_9v"/><path class="m_j0b_h7n"/></g>`,
		"fallback": "gala:terminal",
	});
}
