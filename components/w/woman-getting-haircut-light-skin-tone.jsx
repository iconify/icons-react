...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="itzcweb2v"/><path class="vyf3e3wrd"/><path class="c495tabsx"/><path class="mleoe9bsc"/><path class="cg31-rbkj"/><circle class="ehmch7_7s"/><path class="teqn6kb3n"/><path class="bc2myz9nw"/><path class="zzcdjp8xu"/><path class="oq5hypb3h"/><circle class="cuo5qyo8p"/><path class="ye253ab5j"/><path class="txdx-_o3k"/><path class="rzj4c6xpp"/>`,
		"fallback": "openmoji:woman-getting-haircut-light-skin-tone",
	});
}
