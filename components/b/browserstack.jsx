...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ioyn42bjj"/><path class="g00-jfi-e"/><path class="w_i-pk3zl"/><path class="t_hmnnblg"/><path class="zv4mjlbgg"/><path class="il-1-3qiu"/><path class="kkknlsbaa"/><path class="cb24lsbio"/><path class="bl0unx-or"/><path class="y4xagog8i"/>`,
		"fallback": "thesvg-color:browserstack",
	});
}
