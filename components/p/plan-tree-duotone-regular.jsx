...
</style><g class="nrj6p8qat"><path class="vcsiwjg-w"/><path class="kkk3u9byv"/><path class="fwd-czbqw"/><path class="ffl_tubrp"/><path class="fl42iabgs"/><path class="s4opvo9pz"/><path class="siocq_7mf"/><path class="iic1bs66d"/></g>`,
		"fallback": "iconmind:plan-tree-duotone-regular",
	});
}
