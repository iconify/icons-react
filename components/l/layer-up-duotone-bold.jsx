...
</style><g class="s0phu2bbs"><path class="eu-8lebac"/><path class="k2xn4nbds"/><path class="gqua-bbkg"/><path class="fo_ekznwu"/><path class="v1ku6ibql"/><path class="ltjpzfbzq"/></g>`,
		"fallback": "iconmind:layer-up-duotone-bold",
	});
}
