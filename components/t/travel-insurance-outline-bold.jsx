...
</style><g class="s0phu2bbs"><path class="gs2u-ebtp"/><path class="ldyahhf1z"/><path class="a6z1jcjqs"/><path class="b6cdzhbpu"/></g>`,
		"fallback": "iconmind:travel-insurance-outline-bold",
	});
}
