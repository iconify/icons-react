...
</style><g class="s0phu2bbs"><path class="dt4wyoqho"/><path class="fz6e7vbzb"/><path class="dc0xg9bgf"/><path class="zqnyy8bad"/></g>`,
		"fallback": "iconmind:filter-metadata-outline-bold",
	});
}
