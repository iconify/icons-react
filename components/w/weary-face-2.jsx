...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="almky1j9k"/><path class="dbq485b4e"/><path class="ocif-h9bu"/><path class="juu6lxbqs"/><path class="s_f6m4b-b"/><path class="a3pmd3ssc"/><path class="kjuda_b1e"/><path class="ooiisgb-l"/><path class="hkx4dtb_t"/><path class="owomm5jgl"/><path class="dbh9tstmw"/><path class="fcjfu5bvx"/>`,
		"fallback": "streamline-emojis:weary-face-2",
	});
}
