...
</style><g class="nrj6p8qat"><path class="zva0qcbrg"/><path class="l0njnitvz"/><path class="o5uqjjbch"/></g>`,
		"fallback": "iconmind:compliance-outline-regular",
	});
}
