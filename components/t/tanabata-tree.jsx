...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="i3ban9bdq"/><path class="srhq1r8nh"/><path class="nxkqjbbny"/><path class="fw5i88kuv"/><path class="gletw6b2i"/><path class="nhee74bxr"/><path class="f_k83o35c"/><path class="fmduyhbdp"/><path class="nmwakwbjh"/><path class="luk8_mb_p"/>`,
		"fallback": "openmoji:tanabata-tree",
	});
}
