...
Browse all icons: [preview Simple Icons on Iconify](https://icon-sets.iconify.design/simple-icons/)

## Installation

```bash
npm install github:iconify/icons-react#simple-icons
```
...
```jsx
import SampleIcon from '@iconify-react/simple-icons/wise';
...
```jsx
import SampleIcon from '@iconify-react/simple-icons/framer';
...
```jsx
import SampleIcon from '@iconify-react/simple-icons/vuetify';
