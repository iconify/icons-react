...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="n66pgwe_n"><path class="e7c-0_wle"/><path class="eu7jsebdx"/><path class="kgd706bhv"/></g><path class="ogjjqkbjg"/><path class="mwv3f8bsf"/><path class="q4ngsac6i"/><circle class="khjujlbln"/><circle class="n4jlfim0c"/><circle class="i1ccl-bpt"/><circle class="a68xspu5q"/>`,
		"fallback": "openmoji:armchair",
	});
}
