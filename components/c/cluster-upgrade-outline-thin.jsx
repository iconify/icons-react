...
</style><g class="hntgybcog"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="lx4-k4b5b"/><path class="w269bwb_t"/></g>`,
		"fallback": "iconmind:cluster-upgrade-outline-thin",
	});
}
