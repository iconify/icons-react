...
</style><g class="ft5dv1b6b"><path class="gs-w_pi-l"/><path class="usvffmmwf"/><path class="iny1p0f4g"/><path class="z3uw5ubsb"/><path class="f4yp3qrlp"/><path class="c6n-j-bxp"/><path class="u34zgc3xu"/><path class="d8yirm7xt"/><path class="eb0nw_gqh"/><path class="judj5ubyt"/><path class="ty0wxbbal"/><path class="s967kxbpg"/><path class="lh0hpr9so"/></g>`,
		"fallback": "token-branded:zat",
	});
}
