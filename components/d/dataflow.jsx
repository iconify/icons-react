...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="z-xfx0--c"/><path class="rh8c3ebwc"/><path class="cno8mibya"/><path class="j-z6uxaiv"/><path class="lpq07b7vu"/><path class="kksfhgb6i"/><circle class="oy0lgf6kv"/><circle class="y5fqsh5vy"/><circle class="cx1sy1brb"/><circle class="sc___2b_y"/>`,
		"fallback": "gcp:dataflow",
	});
}
