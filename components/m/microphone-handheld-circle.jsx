...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="psv_8pbss"/><g class="xyjtgccot"><path class="y26lmdnag"/><path clip-rule="evenodd" class="nflamqbhb"/><path clip-rule="evenodd" class="uw7ggidkq"/><path clip-rule="evenodd" class="k27b_nswo"/><path clip-rule="evenodd" class="s7famcc7z"/><path class="qm9py3l9s"/></g><path clip-rule="evenodd" class="enqvvjben"/><path clip-rule="evenodd" class="xsehtwbux"/><path clip-rule="evenodd" class="br7ur5_ai"/><path clip-rule="evenodd" class="wl0u4j3zp"/><path clip-rule="evenodd" class="kspoj7vnd"/></g>`,
		"fallback": "pepicons-print:microphone-handheld-circle",
	});
}
