...
</style><path class="v06ptqhqx"/><path class="hkjoyjbsa"/><defs><path id="SVGd6cSpb5s" class="n33cq0nrh"/></defs><use href="#SVGd6cSpb5s" class="he4rs9y1v"/><path class="qn9v6fetm"/><path class="rm-tsubna"/><g class="a2yy6zb5x"><path class="de-x6cwkr"/><path class="uei2y7bbh"/></g>`,
		"fallback": "noto-v1:tram",
	});
}
