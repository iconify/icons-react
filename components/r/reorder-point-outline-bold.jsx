...
</style><g class="s0phu2bbs"><path class="vo1-lv2pt"/><path class="oz3eccbug"/><path class="y_2nr8hoa"/><path class="n8sqmebht"/></g>`,
		"fallback": "iconmind:reorder-point-outline-bold",
	});
}
