...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="n1lsf0bnc"><path class="v9ro0kb-j"/><path class="vj10jibgc"/><path class="h88dgdbrd"/><path class="h0h4l7ben"/><path class="u19pswbxr"/><path class="vknseeiwo"/><path class="xxwnpvbef"/><path class="a3q89tbcy"/><path class="n1d6a2bzd"/><path class="w842emmze"/><path class="b_-f2y-ql"/><path class="i58xt8b2k"/></g>`,
		"fallback": "thesvg:internlm",
	});
}
