...
</style><g class="hntgybcog"><path class="c-pcdbceg"/><path class="dn5wogbzl"/><path class="qxclf1btn"/><path class="olx0yluil"/></g>`,
		"fallback": "iconmind:rain-chance-outline-thin",
	});
}
