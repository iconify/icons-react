...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><g class="xyjtgccot"><path clip-rule="evenodd" class="po7s7xiew"/><path class="x_j240wtm"/><path clip-rule="evenodd" class="s39w8bbfl"/><path class="s89fw3bsp"/><path clip-rule="evenodd" class="v9xaop3ti"/><path clip-rule="evenodd" class="c9-3mdtjk"/></g><path clip-rule="evenodd" class="tffy9ff4c"/><path clip-rule="evenodd" class="e9q_f1bos"/><path clip-rule="evenodd" class="s6989_9xa"/><path class="mo5netbri"/></g>`,
		"fallback": "pepicons-print:studio-light-side-off",
	});
}
