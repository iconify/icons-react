...
</style><path class="mtuniib5h"/><path class="e1-9y2j1f"/><defs><path id="SVGHS5T6b0Y" class="jusagjbiu"/></defs><clipPath id="SVGmyL66ddH"><use href="#SVGHS5T6b0Y"/></clipPath><path clip-path="url(#SVGmyL66ddH)" class="vlzxmobpz"/><defs><use href="#SVGHS5T6b0Y" id="SVGN1cpRcQB"/></defs><clipPath id="SVGCNTilnCF"><use href="#SVGN1cpRcQB"/></clipPath><g clip-path="url(#SVGCNTilnCF)" class="lip7wrrrl"><path class="qoq2pgbqk"/></g>`,
		"fallback": "noto:clapping-hands-medium-skin-tone",
	});
}
