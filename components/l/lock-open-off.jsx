...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="dowozdblg"/><path class="azt7m7kqg"/><path clip-rule="evenodd" class="muiqxrbuk"/><path class="xedf9ccsf"/></g>`,
		"fallback": "pepicons-pop:lock-open-off",
	});
}
