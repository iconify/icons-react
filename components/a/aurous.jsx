...
</style><defs><linearGradient x1="0%" y1="50%" x2="100%" y2="50%" id="ssvg-id-aurousa"><stop offset="0%" class="d1qx3x3me"/><stop offset="9.876%" class="d1qx3x3me"/><stop offset="100%" class="pd_hnpbvz"/></linearGradient></defs><path fill="url(#ssvg-id-aurousa)" class="mcdt6_bmb"/>`,
		"fallback": "logos:aurous",
	});
}
