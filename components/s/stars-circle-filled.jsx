...
</style><g class="ft5dv1b6b"><defs><mask id="SVG4E7vGnin"><path class="k5-vjlrin"/><path class="s3b8ddbzu"/><path class="mk4dhpbck"/><path class="xm9ml9pvq"/></mask></defs><circle mask="url(#SVG4E7vGnin)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:stars-circle-filled",
	});
}
