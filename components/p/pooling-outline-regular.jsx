...
</style><g class="nrj6p8qat"><path class="tfto2zbdp"/><path class="xlz01ub4s"/><path class="ml5vh8o3m"/><path class="n_1n94xtx"/><path class="godgg2x3f"/></g>`,
		"fallback": "iconmind:pooling-outline-regular",
	});
}
