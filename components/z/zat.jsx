...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="jjuwgwbey"/><path class="e9ea7cciq"/><path class="r6c9quk4j"/><path class="xv73d7ewy"/><path class="t1jbhyxim"/><path class="imz_dtbyz"/><path class="sw2wj4e3r"/><path class="m8zcrsuse"/>`,
		"fallback": "token:zat",
	});
}
