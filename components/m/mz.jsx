...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="bi12bsetm"><path class="vywim1bhw"/><path class="btr15ibli"/><path class="laha_xb_b"/><path class="d-vh3-pat"/><path class="iyddsfksf"/><path class="olpciwlbb"/><path class="zaofa-9ru"/><path class="ynnxizqrl"/><path class="kjrhk4s6f"/><path class="uqj349byz"/></g>`,
		"fallback": "cif:mz",
	});
}
