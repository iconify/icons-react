...
Browse all icons: [preview Nonicons on Iconify](https://icon-sets.iconify.design/nonicons/)

## Installation

```bash
npm install github:iconify/icons-react#nonicons
```
...
```jsx
import SampleIcon from '@iconify-react/nonicons/kotlin-16';
...
```jsx
import SampleIcon from '@iconify-react/nonicons/vue-16';
...
```jsx
import SampleIcon from '@iconify-react/nonicons/npm-16';
