...
</style><g class="s0phu2bbs"><path class="vyks9vbfn"/><path class="ogtwkzbca"/><path class="eahy924ne"/><path class="zjleuacmi"/><path class="lxoo1ac9h"/></g>`,
		"fallback": "iconmind:tip-calc-outline-bold",
	});
}
