...
</style><g class="hntgybcog"><path class="y4_6s7b5v"/><path class="wuvisubmw"/><path class="p-mto4usm"/><path class="aqrpc1aqy"/><path class="ktzvm-xej"/></g>`,
		"fallback": "iconmind:book-sale-outline-thin",
	});
}
