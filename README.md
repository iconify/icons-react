...
Browse all icons: [preview PrestaShop Icons on Iconify](https://icon-sets.iconify.design/ps/)

## Installation

```bash
npm install github:iconify/icons-react#ps
```
...
```jsx
import SampleIcon from '@iconify-react/ps/bell';
...
```jsx
import SampleIcon from '@iconify-react/ps/girl';
...
```jsx
import SampleIcon from '@iconify-react/ps/home';
