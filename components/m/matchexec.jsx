...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="xo632jadu"/><path class="e08xtmbgj"/><path class="fakjnhbll"/><path class="v_asvpm5w"/><path class="heghy47zm"/><path class="f1x7_w9bf"/><path class="zadubp47c"/><path class="h95g6bcij"/><path class="dlja1acdj"/><path class="ct9syabsk"/><path class="vvwab49qt"/><path class="pkdt2zb3t"/><path class="py-4q6b8g"/><path class="fot4u_bbz"/>`,
		"fallback": "selfhst:matchexec",
	});
}
