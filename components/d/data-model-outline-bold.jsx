...
</style><g class="s0phu2bbs"><path class="c_mfncbzl"/><path class="rj_yrybsf"/><path class="vndgajb9z"/><path class="axg5c-q0a"/><path class="nzb-j6sxx"/></g>`,
		"fallback": "iconmind:data-model-outline-bold",
	});
}
