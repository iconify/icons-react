...
</style><g class="s0phu2bbs"><path class="xfs8wlfhn"/><path class="ygr1bbcag"/><path class="b2n99wbku"/><path class="uy7nmfbhi"/></g>`,
		"fallback": "iconmind:lock-alert-outline-bold",
	});
}
