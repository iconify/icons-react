...
</style><path class="mtuniib5h"/><path class="p6y-ez_0u"/><defs><path id="SVGHS5T6b0Y" class="jusagjbiu"/></defs><clipPath id="SVGmyL66ddH"><use href="#SVGHS5T6b0Y"/></clipPath><path clip-path="url(#SVGmyL66ddH)" class="z5060jb2k"/><defs><use href="#SVGHS5T6b0Y" id="SVGN1cpRcQB"/></defs><clipPath id="SVGCNTilnCF"><use href="#SVGN1cpRcQB"/></clipPath><g clip-path="url(#SVGCNTilnCF)" class="oadpy4acg"><path class="qoq2pgbqk"/></g>`,
		"fallback": "noto:clapping-hands-light-skin-tone",
	});
}
