...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.bjylg5bpj {
  stop-color: var(--svg-color--664bb5, #664BB5);
}

.eax-5zbjg {
  stop-color: var(--svg-color--7c47c1, #7C47C1);
}
