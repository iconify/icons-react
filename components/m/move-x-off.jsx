...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="yyi6dk9nd"/><path clip-rule="evenodd" class="my-7cbcik"/><path clip-rule="evenodd" class="wycqxob1l"/><path clip-rule="evenodd" class="g206auf7u"/><path clip-rule="evenodd" class="rzvd2bciv"/><path class="xedf9ccsf"/></g>`,
		"fallback": "pepicons-pop:move-x-off",
	});
}
