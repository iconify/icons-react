...
</style><g class="nrj6p8qat"><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="kq98nmbqp"/><path class="p5fzfqbvy"/><path class="y4a8ig_7t"/></g>`,
		"fallback": "iconmind:bundle-save-outline-regular",
	});
}
