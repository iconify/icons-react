...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uvu677iqn"/><path class="azr3igb0y"/><path class="dj25xqg3j"/><g class="doj9dq_jg"><path class="jvwd4hb0y"/><path class="x-yrcnb4x"/><path class="znx_wjbng"/><path class="chy_d5bro"/><path class="hbv_p_bae"/><path class="we6eiwlvt"/><path class="ldggkmb_j"/></g>`,
		"fallback": "openmoji:soft-ice-cream",
	});
}
