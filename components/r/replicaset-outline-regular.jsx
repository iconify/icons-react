...
</style><g class="nrj6p8qat"><path class="okud9xj_d"/><path class="ik93a37tn"/><path class="vjdmi0bfh"/><path class="mxzk029nb"/><path class="y0y0ccsoe"/></g>`,
		"fallback": "iconmind:replicaset-outline-regular",
	});
}
