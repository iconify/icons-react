...
</style><path class="ttiw-8c2x"/><path class="lvyhkkb3v"/><path class="fc3-t2blg"/><path class="lmyq05bqq"/><path class="um-yvnb_v"/>`,
		"fallback": "emojione:page-with-curl",
	});
}
