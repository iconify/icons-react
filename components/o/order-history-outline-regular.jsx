...
</style><g class="nrj6p8qat"><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="r1ix196dy"/><path class="lit20acsf"/><path class="u41hfsjfh"/></g>`,
		"fallback": "iconmind:order-history-outline-regular",
	});
}
