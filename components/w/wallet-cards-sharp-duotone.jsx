...
.yv2gvylve {
  ...
  d: path("M3 8L21 8L21 12L10 12L10 13C10 14.1046 9.1046 15 8 15C6.8954 15 6 14.1046 6 13L6 12L3 12Z");
}
</style><g class="cuyn6tgcc"><path class="yv2gvylve"/><path clip-rule="evenodd" class="fw8-r0bua"/></g>`,
