...
</style><g class="nrj6p8qat"><path class="knb00ei4h"/><path class="d_b1a31kv"/><path class="bk6uwfbvv"/><path class="slz7u0oyn"/><path class="d69_otb1b"/><path class="scs5jbhoc"/></g>`,
		"fallback": "iconmind:vector-upsert-outline-regular",
	});
}
