...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.bh-ozpb3p {
  fill: currentColor;
  d: path("m29.205 43.084l1.049 3.23h3.396l1.051-3.23l-2.748-1.996zm0 9.793l1.049 3.23h3.396l1.051-3.23l-2.748-1.996zm2.705-18.926c3.076 0 6.045-1.309 8.145-3.592a1.001 1.001 0 0 0-1.473-1.353c-1.723 1.871-4.154 2.945-6.672 2.945s-4.949-1.074-6.672-2.945a1 1 0 0 0-1.412-.061a1.003 1.003 0 0 0-.061 1.414a11.1 11.1 0 0 0 8.145 3.592");
}
...
</style><circle class="hq5hau5ws"/><circle class="k4ops4bkt"/><circle class="u7-c5ks7w"/><path class="lstsfzsuq"/><path class="bh-ozpb3p"/>`,
		"fallback": "emojione-monotone:snowman-without-snow",
	});
}
