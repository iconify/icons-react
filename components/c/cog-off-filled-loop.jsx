...
import '../../css/z/zpr47z.css';
import '../../css/b/botfzx.css';
import '../../css/x/xy1-ic.css';
...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<defs><mask id="SVGYpaAAb5W"><path class="l4o95v r1menc"/><path class="g26hbu mx963o"/><path class="bvcbdi g26hbu"/><path class="g26hbu u5kw3r"/><path class="g26hbu gl0rpz"/><path class="g26hbu v88fpx"/><path class="g26hbu q0e96w"/><path class="r1menc taf2xz zpr47z"/></mask></defs><path mask="url(#SVGYpaAAb5W)" class="botfzx"/><path class="r1menc taf2xz xy1-ic"/>`,
		"fallback": "line-md:cog-off-filled-loop",
	});
}
