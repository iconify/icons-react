...
</style><g class="nrj6p8qat"><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="js960j4-t"/><path class="f9z-0cczq"/></g>`,
		"fallback": "iconmind:cart-add-outline-regular",
	});
}
