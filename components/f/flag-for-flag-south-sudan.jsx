...
</style><path class="i43pbtgxu"/><path class="ykwb9xbol"/><path class="m5ry2-b3e"/><path class="xtn1_zhmg"/><path class="igm0eob1f"/><path class="y97okkbjr"/>`,
		"fallback": "emojione:flag-for-flag-south-sudan",
	});
}
