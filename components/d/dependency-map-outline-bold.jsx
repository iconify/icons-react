...
</style><g class="s0phu2bbs"><path class="mn-a1zb6m"/><path class="s25-orfog"/><path class="tdux9oy4s"/><path class="xh38rmboq"/><path class="n9q35emrt"/></g>`,
		"fallback": "iconmind:dependency-map-outline-bold",
	});
}
