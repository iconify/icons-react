...
</style><defs><linearGradient id="SVGyoFAClZP" x1="0%" x2="99.996%" y1="36.301%" y2="64.611%"><stop offset="0%" class="xgxshwb6j"/><stop offset="100%" class="jjq_szb_f"/></linearGradient><linearGradient id="SVGnuFxjeJW" x1="102.837%" x2="-5.655%" y1="70.777%" y2="28.962%"><stop offset="0%" class="eloaaccms"/><stop offset="100%" class="vc--wpv5i"/></linearGradient><linearGradient id="SVGX0cLLd2o" x1="49.941%" x2="23.669%" y1="69.215%" y2="32.86%"><stop offset="0%" class="eloaaccms"/><stop offset="100%" class="vc--wpv5i"/></linearGradient></defs><path fill="url(#SVGyoFAClZP)" class="rrk1jfd4z"/><path fill="url(#SVGnuFxjeJW)" class="mohhrcbzh"/><path fill="url(#SVGX0cLLd2o)" class="lma78cgdp"/>`,
		"fallback": "logos:apidog-icon",
	});
}
