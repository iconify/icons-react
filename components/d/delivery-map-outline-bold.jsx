...
</style><g class="s0phu2bbs"><path class="jrpnc2pnl"/><path class="xedmbxbzm"/><path class="bfi7-obrv"/><path class="taxmbub4q"/></g>`,
		"fallback": "iconmind:delivery-map-outline-bold",
	});
}
