...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="fx1wgomas"/><g class="e_raf5bng"><path class="z1bvcgb-s"/><path class="qpaeesbtl"/></g><path class="uhzg61i5x"/><path class="e7pouob5w"/><path class="l9uo37bcj"/><path class="e2kl36vzi"/><path class="moe9szbkp"/><path class="epy51nlfc"/><path class="qhpjt5bdq"/>`,
		"fallback": "openmoji:man-dark-skin-tone-beard",
	});
}
