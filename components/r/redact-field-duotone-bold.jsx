...
</style><g class="s0phu2bbs"><path class="z92okmbgh"/><path class="rm-a2rb5c"/><path class="jrpnc2pnl"/><path class="tjijmrbpe"/><path class="nl66y9men"/></g>`,
		"fallback": "iconmind:redact-field-duotone-bold",
	});
}
