...
</style><path class="g2pk2nb3s"/><path class="xerw7seku"/><rect class="b-76si4dn"/><path class="ly_jl04ok"/><circle class="icyifzbim"/><path class="i9clfwm2k"/>`,
		"fallback": "arcticons:secure-box",
	});
}
