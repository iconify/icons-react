...
</style><defs><linearGradient id="SVG9lZJOeza" x1="20.394%" x2="79.571%" y1="15.849%" y2="84.151%"><stop offset="21.45%" class="scz48_b_q"/><stop offset="70.67%" class="rce7frb1s"/><stop offset="100%" class="zj3txodxe"/></linearGradient></defs><path fill="url(#SVG9lZJOeza)" class="nqhs50ndr"/>`,
		"fallback": "logos:openjs-foundation-icon",
	});
}
