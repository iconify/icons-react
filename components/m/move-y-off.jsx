...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="j123cpb_j"/><path clip-rule="evenodd" class="dz5jqbb-p"/><path clip-rule="evenodd" class="zc6sbpbny"/><path clip-rule="evenodd" class="sblvz-9zq"/><path clip-rule="evenodd" class="b63v_-baa"/><path class="xedf9ccsf"/></g>`,
		"fallback": "pepicons-pop:move-y-off",
	});
}
