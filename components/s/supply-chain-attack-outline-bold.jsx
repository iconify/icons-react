...
</style><g class="s0phu2bbs"><path class="g00uv-b-x"/><path class="koh8ckbdb"/><path class="k2mg4f2ls"/><path class="r2sn4nhez"/></g>`,
		"fallback": "iconmind:supply-chain-attack-outline-bold",
	});
}
