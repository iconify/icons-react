...
</style><g class="s0phu2bbs"><path class="xrrcnmb6x"/><path class="c6ayt6bgs"/><path class="lv-mj3bxw"/><path class="oqq60ccjl"/><path class="e54_mjwsr"/></g>`,
		"fallback": "iconmind:map-step-outline-bold",
	});
}
