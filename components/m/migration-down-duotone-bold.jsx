...
</style><g class="s0phu2bbs"><path class="eqtg9zhcu"/><path class="zoomnj6dr"/><path class="jfvoq9bhn"/><path class="slz7u0oyn"/><path class="h7bcztycq"/><path class="pkaragbav"/></g>`,
		"fallback": "iconmind:migration-down-duotone-bold",
	});
}
