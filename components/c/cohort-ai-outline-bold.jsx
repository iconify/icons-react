...
</style><g class="s0phu2bbs"><path class="gvmyg7bww"/><path class="l0cxbsbji"/><path class="rckmicclj"/><path class="n-059ea3n"/><path class="llakqobuk"/><path class="ciz9k0bxi"/></g>`,
		"fallback": "iconmind:cohort-ai-outline-bold",
	});
}
