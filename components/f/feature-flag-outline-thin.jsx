...
</style><g class="hntgybcog"><path class="fh3izxbmu"/><path class="veni6hbgn"/><path class="k5-wjdk7l"/><path class="u_41jqbcx"/></g>`,
		"fallback": "iconmind:feature-flag-outline-thin",
	});
}
