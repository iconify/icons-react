...
</style><g class="s0phu2bbs"><path class="dngdujbqm"/><path class="nc3tobbpg"/><path class="pdc4gobyf"/><path class="n708z7b3q"/><path class="g2aaxgb5s"/></g>`,
		"fallback": "iconmind:harm-category-outline-bold",
	});
}
