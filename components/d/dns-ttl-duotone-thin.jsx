...
</style><g class="hntgybcog"><path class="mrirfwb4r"/><path class="h34zmbbby"/><path class="k6nj2fbya"/><path class="ermdcdc5z"/><path class="rllhknboo"/></g>`,
		"fallback": "iconmind:dns-ttl-duotone-thin",
	});
}
