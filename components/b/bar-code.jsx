...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="rggfaqb6e"><path class="ymlwzebvx"/><path class="fp4e3zzqn"/><path class="teudbxb4d"/><path class="uvi531g1y"/><path class="njkfqpz6o"/><path class="nujez7bff"/><path class="w28a8obbv"/><path class="opgynudhx"/><path class="vk1lm9bax"/><path class="l2ejtc74t"/><path class="l2v-al33k"/><path class="u7kunxbis"/><path class="s9as9vnso"/></g>`,
		"fallback": "icon-park:bar-code",
	});
}
