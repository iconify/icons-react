...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="whoymcc2g"/><path class="mfek-bc0u"/><path class="etbn_9g3x"/><path class="xnyt-gbyi"/><path class="i9utmfjdp"/><path class="pn1pf-bcx"/><path class="pedudjbxi"/><path class="ew8j1xirr"/><path class="f83xbublz"/><path class="jfmsn6b5v"/><path class="lcj_p3bpc"/><path class="r7_mk7bfk"/>`,
		"fallback": "openmoji:rubber-duck-in-water",
	});
}
