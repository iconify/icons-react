...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="xlz197fth"/><path class="mxa-l7_tk"/><path class="ygxadpg2c"/><path class="sk5suy1km"/><path class="uua325t4g"/><path class="q_tznac0a"/><path class="od8y7gbaf"/><path class="fhxhqwh7s"/>`,
		"fallback": "fxemoji:construct",
	});
}
