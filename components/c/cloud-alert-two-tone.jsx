...
</style><g class="nrj6p8qat"><path class="vevmidywk"/><path class="qn_vlfbra"/><path class="j_rl4l5tj"/></g>`,
		"fallback": "keyline-icons:cloud-alert-two-tone",
	});
}
