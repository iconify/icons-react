...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="dmpg2-rsi"/><path class="gjs9lwb-j"/><path class="c-_tkqb4t"/><path class="jpnbaccbm"/><path class="y4mwoeb3g"/><path class="yjnvwob6l"/><path class="cjtkwy7-o"/><path class="azbongbwp"/><path class="vtx-7wb5e"/><path class="t45115b0h"/>`,
		"fallback": "fxemoji:fireengine",
	});
}
