...
</style><g class="cuyn6tgcc"><path class="q5jsyf-yl"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:grab-handle-circle-off",
	});
}
