...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.dyy3dz4-x {
  fill: var(--svg-color--7aa1dc, #7aa1dc);
