...
</style><g class="s0phu2bbs"><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="ts5ij9bsc"/><path class="hu1l55dbx"/></g>`,
		"fallback": "iconmind:image-promote-outline-bold",
	});
}
