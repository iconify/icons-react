...
</style><g class="nrj6p8qat"><path class="bdvf6t_rz"/><path class="qyt_1qaov"/><path class="oq9ztqbxu"/><path class="mhqlqeb7x"/><path class="hgon-pbwq"/><path class="q7dxcnbil"/></g>`,
		"fallback": "iconmind:pollen-high-outline-regular",
	});
}
