...
</style><g class="hntgybcog"><path class="a218-cpca"/><path class="b6gnpqbjb"/><path class="nzb-j6sxx"/><path class="rnyye8dag"/></g>`,
		"fallback": "iconmind:client-secret-outline-thin",
	});
}
