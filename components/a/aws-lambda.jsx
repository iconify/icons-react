...
</style><defs><linearGradient id="SVGeyciVcvH" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="pkxkyybrw"/><stop offset="100%" class="sl1qm9b9s"/></linearGradient></defs><path fill="url(#SVGeyciVcvH)" class="tmbkaq7lv"/><path class="iht-r9pzo"/>`,
		"fallback": "logos:aws-lambda",
	});
}
