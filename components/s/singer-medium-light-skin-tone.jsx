...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="bd1e2hbvg"/><path class="kil03bb1o"/><path class="vuykdxb-n"/><path class="q8obiybgk"/><circle class="y_tx2rbdz"/><path class="zpvwazb3b"/><path class="qpvm45bif"/><path class="avc3-xbey"/><circle class="cjq716bgw"/><path class="awk6nwmpm"/><path class="ilpzvutts"/><path class="a6n8x1bco"/><path class="txzkjbbte"/><path class="br-hcccfh"/><path class="hzqkvlbtn"/><path class="dn02afsqr"/>`,
		"fallback": "openmoji:singer-medium-light-skin-tone",
	});
}
