...
</style><g class="s0phu2bbs"><path class="a-gugwb5v"/><path class="rviuo_bhz"/><path class="c8ewb5pjd"/><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="o7-7k5bqs"/><path class="kl5egs07h"/></g>`,
		"fallback": "iconmind:subscribe-product-duotone-bold",
	});
}
