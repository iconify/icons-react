...
</style><g class="nrj6p8qat"><path class="qnpznt65u"/><path class="p1zm8jh9k"/><path class="hh7m_9dhg"/><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="l4henmbwb"/><path class="wv-y1zfrk"/></g>`,
		"fallback": "iconmind:cluster-autoscaler-duotone-regular",
	});
}
