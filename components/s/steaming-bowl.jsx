...
</style><path class="h65gexbqr"/><path class="hoydlibhl"/><path class="qrdxyibqz"/><ellipse class="gio9bsbyv"/><path class="p5-go-c_c"/><path class="tuwknxs3o"/><path class="elun2cbjo"/>`,
		"fallback": "twemoji:steaming-bowl",
	});
}
