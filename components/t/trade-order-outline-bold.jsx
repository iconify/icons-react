...
</style><g class="s0phu2bbs"><path class="dx3ubrb9h"/><path class="hbtmd5b0k"/><path class="yqc0twwou"/><path class="y71fx-j7v"/><path class="tcu89np8z"/></g>`,
		"fallback": "iconmind:trade-order-outline-bold",
	});
}
