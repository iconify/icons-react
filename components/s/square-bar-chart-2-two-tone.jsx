...
</style><g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="i5lvicvhn"/><path class="dfvafvs5r"/></g>`,
		"fallback": "keyline-icons:square-bar-chart-2-two-tone",
	});
}
