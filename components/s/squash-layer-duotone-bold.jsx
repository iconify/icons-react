...
</style><g class="s0phu2bbs"><path class="j14g7qigh"/><path class="a8i34bcjs"/><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="kgpu6-15k"/><path class="rfdwl-jei"/></g>`,
		"fallback": "iconmind:squash-layer-duotone-bold",
	});
}
