...
import '../../css/v/vzqlqwbqi.css';
import '../../css/t/tkp7tfbat.css';
...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ypy_i9bod"/><path class="r-d226bjg"/><path class="kq4vz60zh"/><path class="v_wxcsboi"/><path class="vzqlqwbqi"/><path class="tkp7tfbat"/><path class="wg4j894xd"/><path class="ezntoi8ae"/><path class="m7drilfeg"/><path class="niusl-mpj"/><path class="o3eax4big"/><path class="jqm-azb6c"/><path class="urpjjnb7q"/><path class="k5gf3cblr"/><path class="xh33b4bdy"/><path class="qoqrw8azq"/>`,
		"fallback": "openmoji:construction-worker-medium-light-skin-tone",
	});
}
