...
</style><g class="ft5dv1b6b"><defs><mask id="SVGAdmKHDzJ"><path class="k5-vjlrin"/><g class="ivjvz2eii"><path class="k6uj9ziot"/><path clip-rule="evenodd" class="g-ura4bog"/></g></mask></defs><circle mask="url(#SVGAdmKHDzJ)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:umbrella-circle-filled",
	});
}
