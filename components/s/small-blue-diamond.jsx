...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.bl1cip_3f {
  stop-color: var(--svg-color--4171cd, #4171CD);
}
