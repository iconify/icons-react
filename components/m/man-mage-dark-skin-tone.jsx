...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ed-idh1qq"/><path class="oychbz_cf"/><path class="of8mm1j3i"/><path class="iv-4shggh"/><path class="x6o_f8bzm"/><path class="ahz0upblx"/><path class="jm2b_bckj"/><path class="vmsia2b0q"/><path class="d5d9zrb0b"/><path class="wywwqb07d"/><path class="wkz0_n5gi"/><path class="q3aj0vory"/><path class="leg2aibbb"/>`,
		"fallback": "openmoji:man-mage-dark-skin-tone",
	});
}
