...
</style><path class="qfjz-2jgs"/><path class="pzkud_bvh"/><path class="ytaft7bol"/><path class="n9lxxfbsz"/><path class="x5shv0bzz"/><path class="r20eijbzz"/><path class="m7j07k2ro"/><path class="ua0omz97y"/><g class="orswx5bnm"><path class="l8orqj4go"/><path class="etp434bjz"/></g><path class="tb1dcszgj"/><defs><path id="SVGSNtVgdHr" class="xzf-9nlkm"/></defs><use href="#SVGSNtVgdHr" class="ega13mbxo"/><path class="r_4mz-bwl"/><path class="noijc7bti"/>`,
		"fallback": "noto-v1:man-facepalming-dark-skin-tone",
	});
}
