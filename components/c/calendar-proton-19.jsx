...
</style><path class="my8bybbld"/><circle class="a47tlvveb"/><path class="oa5nyu_fd"/><path class="f6_7b22_l"/><path class="wtoegrbgv"/><path class="orx8z1bik"/>`,
		"fallback": "arcticons:calendar-proton-19",
	});
}
