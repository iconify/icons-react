...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path class="riqupybve"/><path clip-rule="evenodd" class="lzttk4b4v"/><path class="crowf5bqr"/><path class="mcdsu022o"/><path class="dy1fr3e2o"/><path class="xp1wxg51f"/></g>`,
