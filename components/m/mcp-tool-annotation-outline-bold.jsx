...
</style><g class="s0phu2bbs"><path class="ni20md-jo"/><path class="j6o0shbiv"/><path class="uesvxd39h"/><path class="gffdk79ec"/></g>`,
		"fallback": "iconmind:mcp-tool-annotation-outline-bold",
	});
}
