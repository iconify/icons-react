...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="e3p1ybc1b"><path class="f_tp7_bag"/><path class="u4hptimql"/><path class="b2l3kn09f"/><path class="up60uxl-k"/><path class="xfbdf4b6k"/><path class="ukum0bb7n"/><path class="vrj_30buj"/><path class="w-9z52mov"/><path class="upvn38bfl"/></g>`,
		"fallback": "icon-park:softball",
	});
}
