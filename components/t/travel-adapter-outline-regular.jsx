...
</style><g class="nrj6p8qat"><path class="ve9ccmbqn"/><path class="ffipo4b5s"/><path class="h1j63eveo"/><path class="zkgvk4bog"/><path class="qw7b_6b1t"/></g>`,
		"fallback": "iconmind:travel-adapter-outline-regular",
	});
}
