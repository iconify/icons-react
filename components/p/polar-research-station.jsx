...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="bdirzf98q"/><path class="rh9pxgogm"/><path class="oic1cjbmz"/><path class="qvfk07byz"/><path class="qbiv0hbkw"/><path class="jeccd6bua"/><path class="w0-9f3bnr"/><path class="kz7_uzdef"/><path class="v-qlenojr"/><path class="t9zzwo-da"/><g class="rpvb-o6bq"><path class="ap8-btr4b"/><path class="s0wewrmcz"/><path class="q-8o0mdjd"/><path class="evlkz5bfv"/><path class="bmgo7ybjd"/><path class="w82e1qblm"/></g>`,
		"fallback": "openmoji:polar-research-station",
	});
}
