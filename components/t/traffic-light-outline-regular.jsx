...
</style><g class="nrj6p8qat"><path class="pexn--ntk"/><path class="oiu-3i4pj"/><path class="fozhwebbv"/><path class="xedmbxbzm"/><path class="u7m7z6ojw"/></g>`,
		"fallback": "iconmind:traffic-light-outline-regular",
	});
}
