...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="bd1e2hbvg"/><path class="kil03bb1o"/><path class="vuykdxb-n"/><path class="q8obiybgk"/><circle class="y_tx2rbdz"/><path class="zpvwazb3b"/><path class="dbayl6o4n"/><path class="x4ipp83jx"/><circle class="cjq716bgw"/><path class="awk6nwmpm"/><path class="ilpzvutts"/><path class="a6n8x1bco"/><path class="txzkjbbte"/><path class="br-hcccfh"/><path class="hzqkvlbtn"/><path class="dn02afsqr"/>`,
		"fallback": "openmoji:singer-light-skin-tone",
	});
}
