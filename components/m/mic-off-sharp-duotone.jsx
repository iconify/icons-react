...
.wnohalbyc {
  stroke-opacity: 0.4;
  d: path("M16.4246 16.4246C15.2187 17.4094 13.6783 18 12 18M12 18C8.134 18 5 14.866 5 11L5 10M12 18L12 22M7 22L17 22");
}
</style><g class="gp_8x1bzb"><path class="uz0j13afx"/><path class="wnohalbyc"/><path class="ahhqo1b4s"/></g>`,
		"fallback": "keyline-icons:mic-off-sharp-duotone",
	});
}
