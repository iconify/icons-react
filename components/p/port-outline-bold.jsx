...
</style><g class="s0phu2bbs"><path class="zrwkhybyf"/><path class="kjusc2eyp"/><path class="uxsptjbvt"/><path class="olup7y72x"/></g>`,
		"fallback": "iconmind:port-outline-bold",
	});
}
