...
</style><g class="s0phu2bbs"><path class="n7c_b1bsn"/><path class="txqgcyphc"/><path class="a218-cpca"/><path class="e5k2eotmk"/><path class="ei5j_bckv"/></g>`,
		"fallback": "iconmind:token-introspect-duotone-bold",
	});
}
