...
</style><g class="hntgybcog"><path class="b-_pqoidx"/><path class="fj_yfcb-v"/><path class="b1osgvbqx"/><path class="eyvjmxk-i"/><path class="ulh849bsj"/><path class="qh6hkcycj"/></g>`,
		"fallback": "iconmind:test-e2e-duotone-thin",
	});
}
