...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="p8j8r5b7r"/><g class="k9pq-abme"><path class="wgi6stbor"/><path class="hn1-zdavx"/><path class="vfgesksmk"/></g><path class="zf3gldbzw"/><path class="f8beoc-ou"/><path class="f939kc9wm"/><path class="us4_au4yp"/><path class="sm-3czmoo"/><path class="cfxd2bcnj"/><path class="rh0i7-b5z"/>`,
		"fallback": "openmoji:man-shrugging-medium-skin-tone",
	});
}
