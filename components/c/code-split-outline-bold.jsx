...
</style><g class="s0phu2bbs"><path class="wf6zu9b6f"/><path class="rj_yrybsf"/><path class="zghf_z23i"/></g>`,
		"fallback": "iconmind:code-split-outline-bold",
	});
}
