...
</style><path class="bpn-oncsg"/><path class="pk07sfbhl"/><path class="u7es78bok"/><path class="kmhnvub0y"/>`,
		"fallback": "emojione:flag-for-flag-venezuela",
	});
}
