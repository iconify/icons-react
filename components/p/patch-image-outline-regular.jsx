...
</style><g class="nrj6p8qat"><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="ts5ij9bsc"/><path class="zm2dyvb-o"/></g>`,
		"fallback": "iconmind:patch-image-outline-regular",
	});
}
