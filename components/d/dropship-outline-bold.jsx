...
</style><g class="s0phu2bbs"><path class="g00uv-b-x"/><path class="koh8ckbdb"/><path class="k2mg4f2ls"/><path class="j82qv6hym"/><path class="b7rizdb8r"/></g>`,
		"fallback": "iconmind:dropship-outline-bold",
	});
}
