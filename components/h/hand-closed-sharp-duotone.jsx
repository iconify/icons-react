...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.aq4_sdbix {
  d: path("M9.8959 6.4988L9.8959 8.4634M13.3303 6.6762L13.3303 8.4634M16.7648 7.4633L16.7648 9.0931M6.937 10.297L7.1798 12.8668");
}
...
</style><g class="gp_8x1bzb"><path class="pk93sbcbd"/><path class="aq4_sdbix"/></g>`,
