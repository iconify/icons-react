...
</style><path class="eag9hqbqo"/><path class="oidobqp0j"/><path class="g3zhasblb"/><path class="vag1xti6h"/>`,
		"fallback": "vscode-icons:file-type-photoshop2",
	});
}
