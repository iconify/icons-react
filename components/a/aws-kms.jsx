...
</style><defs><linearGradient id="SVGYPnorcPn" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="veqob3-an"/><stop offset="100%" class="ktfvysbch"/></linearGradient></defs><path fill="url(#SVGYPnorcPn)" class="tmbkaq7lv"/><path class="zwpc5bzuc"/>`,
		"fallback": "logos:aws-kms",
	});
}
