...
</style><g class="ft5dv1b6b"><defs><mask id="SVGNjPgJN4M"><path class="k5-vjlrin"/><g class="ivjvz2eii"><path clip-rule="evenodd" class="fqaf-zijl"/><path clip-rule="evenodd" class="a1mo55oec"/><path class="a_8_-56vs"/><path clip-rule="evenodd" class="jg0x75bdh"/></g></mask></defs><circle mask="url(#SVGNjPgJN4M)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:hourglass-circle-filled",
	});
}
