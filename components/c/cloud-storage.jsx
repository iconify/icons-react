...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="wkxt6acwv"/><path class="pisxq2bzc"/><path class="nn__wyblg"/><path class="qp60x_6ng"/><path class="f29b0abyx"/><rect class="cump5ob4y"/><path class="xu65ckbcj"/><path class="gcn7uubzq"/><path class="be6541umh"/><path class="gfdutibsw"/><path class="pkt2tjb2i"/><rect class="tg9o9ccgq"/>`,
		"fallback": "gcp:cloud-storage",
	});
}
