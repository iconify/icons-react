...
</style><circle class="d4gjmmazr"/><path class="lol9h8w8o"/><path class="inwc3bcsc"/><path class="uowwz187x"/><path class="kdkbzs8zw"/><path class="ifo_2abup"/><path class="ssi48u96j"/>`,
		"fallback": "vscode-icons:file-type-dbt-bouncer",
	});
}
