...
</style><g class="s0phu2bbs"><path class="eh4_3ebbt"/><path class="w57l-wb8f"/><path class="v_i-xnbbq"/><path class="oa7ibkb8p"/></g>`,
		"fallback": "iconmind:task-queue-agent-outline-bold",
	});
}
