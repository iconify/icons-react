...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ep0li011l"/><path class="yhjoxpb3w"/><path class="qhbc5obzc"/><path class="c7gk_xbow"/><path class="b66q1vv8t"/><path class="utsav5b7c"/><path class="kc1z3kbnb"/><path class="nsiapccrk"/><path class="g06o9lb3u"/>`,
		"fallback": "fxemoji:turban",
	});
}
