...
</style><g class="nrj6p8qat"><path class="gt7coxqxq"/><path class="gvmht2kii"/><path class="iedujiqkb"/><path class="rvtpkuisl"/></g>`,
		"fallback": "iconmind:diffusion-outline-regular",
	});
}
