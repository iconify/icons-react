...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="sg-nfvl2b"/><path class="calbtt8jv"/><path class="kx11w9bja"/><path class="atebrvb9f"/><path class="o_mfjzbcb"/><path class="g_x-s0bep"/><g class="godm-9bqg"><path class="pb93i9lxk"/><path class="y4cyz538d"/><path class="ox_g8602o"/></g><path class="h70d1nbps"/>`,
		"fallback": "thesvg-color:costco",
	});
}
