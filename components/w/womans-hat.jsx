...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="b64mrabty"/><path class="n0q9xxhuh"/><path class="lvskrhdkw"/><path class="ml85tei4r"/><path class="ryrc9ubzs"/><path class="mequc6b9o"/><g class="jn8qy4bru"><path class="ineptq-at"/><path class="cpm40_b_b"/><path class="vnkhc_ckh"/><path class="zi0eddceh"/><path class="fxo0w5baa"/><path class="pssk1xd2o"/></g>`,
		"fallback": "openmoji:womans-hat",
	});
}
