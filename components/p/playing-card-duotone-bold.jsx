...
</style><g class="s0phu2bbs"><path class="x6guzjh7r"/><path class="xea12qb_o"/><path class="j8arz0w3t"/><path class="r-kal0b4m"/></g>`,
		"fallback": "iconmind:playing-card-duotone-bold",
	});
}
