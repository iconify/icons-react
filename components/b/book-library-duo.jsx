...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="thjuvbz3w"><path class="ytrzu0bnv"/><path class="ebk5plblt"/><path class="xww1raceb"/><path class="jb8k30byf"/><path class="woihu3bvu"/><path class="e4333xbjr"/><path class="geo70jbmy"/><path class="rau942bmd"/><path class="ld-3ezxhi"/><path class="netvhjyhu"/><path class="zpqxxdbkp"/><path class="xh3s9z5ri"/></g>`,
		"fallback": "streamline-stickies-color:book-library-duo",
	});
}
