...
.lxcfn8b-q {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M22.947 33.909v-15l-8.062 10.125h9.937");
}
...
</style><path class="lxcfn8b-q"/><path class="f6_7b22_l"/><path class="wtoegrbgv"/><path class="orx8z1bik"/>`,
		"fallback": "arcticons:calendar-proton-4",
	});
}
