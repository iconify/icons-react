...
</style><path class="av9ta433h"/><circle class="uwdp17aat"/><circle class="mt9hnjich"/><circle class="lidmnccjg"/><path class="yjm1qhb_m"/>`,
		"fallback": "arcticons:kinoteatr",
	});
}
