...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="e7pb2cc9j"/><path class="x101xt1iv"/><path class="sve3dcbkk"/><path class="horqyhbht"/><g class="mnm0pp_et"><path class="iq8ofjb5k"/><path class="nj_h_n1so"/></g>`,
		"fallback": "openmoji:ice-skate",
	});
}
