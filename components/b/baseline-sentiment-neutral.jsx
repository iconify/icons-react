...
.p5mt7yhyo {
  fill: currentColor;
  d: path("M9 15.5h6v1H9z");
}
</style><path class="p5mt7yhyo"/><circle class="mmn7xsb7v"/><circle class="an0_1xo_x"/><path class="nqa-9soic"/>`,
		"fallback": "ic:baseline-sentiment-neutral",
	});
}
