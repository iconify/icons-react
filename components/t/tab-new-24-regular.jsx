...
.ibkzg2b-y {
  d: path("M23 17.5a5.5 5.5 0 1 0-11 0a5.5 5.5 0 0 0 11 0zm-5 .5l.001 2.503a.5.5 0 1 1-1 0V18h-2.505a.5.5 0 1 1 0-1H17v-2.5a.5.5 0 1 1 1 0V17h2.503a.5.5 0 1 1 0 1h-2.502z");
  fill: currentColor;
}
</style><g class="ft5dv1b6b"><path class="dn2eezbnd"/><path class="ibkzg2b-y"/></g>`,
		"fallback": "fluent:tab-new-24-regular",
	});
}
