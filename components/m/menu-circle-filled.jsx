...
</style><g class="ft5dv1b6b"><defs><mask id="SVGfhEiufEz"><path class="k5-vjlrin"/><path clip-rule="evenodd" class="b5vqnzb1n"/></mask></defs><circle mask="url(#SVGfhEiufEz)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:menu-circle-filled",
	});
}
