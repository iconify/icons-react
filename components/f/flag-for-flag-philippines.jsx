...
</style><path class="xnsv5gbgl"/><path class="vubdscbal"/><path class="r66uli3dk"/><g class="hxik4rbqd"><path class="w8w2y4prq"/><circle class="aom7hvbij"/></g>`,
		"fallback": "emojione:flag-for-flag-philippines",
	});
}
