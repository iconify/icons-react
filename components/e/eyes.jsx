...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="sm2n6q3lf"/><path class="xdepcd09o"/><path class="httkegbgj"/><path class="ze22vvbvt"/><path class="cx9fnxbqc"/><path class="w04zi0blq"/><path class="j-cwkltol"/><path class="rsf33p44w"/><path class="rey32xb7e"/><path class="faw3gcbwg"/><path class="lth_ycs5c"/><path class="j-gq87j5l"/><path class="ugx4bebbb"/><path class="vnqpysm8z"/><path class="xc7w04biv"/>`,
		"fallback": "streamline-emojis:eyes",
	});
}
