...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<rect class="q04lytb7o"/><circle class="rzz06rh5q"/><circle class="bgvozzb-q"/><circle class="m7snowbof"/><circle class="v5ytcbb7o"/><circle class="hegua6i7m"/><circle class="x2vp9iblc"/><path class="uxeqhnbef"/><path class="sfrzxibhk"/><g class="jn8qy4bru"><rect class="vnd3c20za"/><circle class="yi8ei_bpc"/><circle class="m3u6eb1wu"/><circle class="nxt6cvbxo"/><circle class="c91-bxbmg"/><circle class="k539-5bdg"/><circle class="mcf5luncd"/></g>`,
		"fallback": "openmoji:pills",
	});
}
