...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="psiglkazx"><path class="dcqj1achm"/><path class="layyr9bfc"/><path class="led535b6d"/><path class="a-i5_5xwr"/><path class="kddvgbcgs"/><circle class="kkqgds_dl"/><circle class="lxg-qzbst"/><circle class="uo4j-r5ke"/><circle class="sbb5v6byu"/></g><path class="ox9fxyz7i"/><path class="wb4o29bmb"/>`,
		"fallback": "gcp:cloud-tpu",
	});
}
