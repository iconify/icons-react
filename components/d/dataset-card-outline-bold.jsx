...
</style><g class="s0phu2bbs"><path class="tkn_9lu9q"/><path class="w2ifj5b6m"/><path class="ctl_2kq5g"/><path class="zpdz8rbaf"/><path class="fymeavbya"/></g>`,
		"fallback": "iconmind:dataset-card-outline-bold",
	});
}
