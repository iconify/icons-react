...
</style><g class="hntgybcog"><path class="b_k8-6b4x"/><path class="ebuv7_btt"/><path class="g-g6w6buq"/><path class="drftkjb-q"/><path class="me7c_bbry"/></g>`,
		"fallback": "iconmind:typing-indicator-outline-thin",
	});
}
