...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="o8c91mrdm"/><path class="av1mwhtjv"/><path class="e2meqjb5q"/><path class="ultmu3bjv"/><path class="aqby02d8t"/><path class="hp87gqr2b"/><path class="k48tkevun"/><path class="c4yf-6z-r"/><path class="ez68l_bhh"/><path class="m4r42ybok"/>`,
		"fallback": "openmoji:mrs-claus-dark-skin-tone",
	});
}
