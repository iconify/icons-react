...
</style><path class="cljzb6x3l"/><path class="j0pl9bc2b"/><path class="jugat8zno"/><path class="ohyxzlbvs"/><path class="ymc0spwiu"/><path class="ovr4dsc6b"/><path class="p0f5fgbmw"/><path class="xcjv2ebbp"/><path class="q1zpp1cfx"/><path class="t84kinbtd"/>`,
		"fallback": "emojione:flag-for-flag-liberia",
	});
}
