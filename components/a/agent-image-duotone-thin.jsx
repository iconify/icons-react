...
</style><g class="hntgybcog"><path class="rv_spwblc"/><path class="richqnb6y"/><path class="cc3l45wyt"/><path class="jsb6lqbli"/></g>`,
		"fallback": "iconmind:agent-image-duotone-thin",
	});
}
