...
</style><g class="hntgybcog"><path class="t1sjjacis"/><path class="veni6hbgn"/><path class="u_41jqbcx"/><path class="epoh96bbt"/><path class="zr69sp0ly"/><path class="i6r2d3rzf"/></g>`,
		"fallback": "iconmind:service-map-outline-thin",
	});
}
