...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="qbwnzkbma"/><path class="zszazhbff"/><path class="ubnjuubwb"/><path class="rd_51wb9j"/><path class="xfv1ohbez"/><path class="k1t1yabts"/><path class="zhzwdnbsy"/><path class="f2_botbnq"/><path class="xkhp8vbxj"/><path class="in-dr0blv"/><path class="kp-e8efib"/><path class="p_e4kccgb"/><path class="jfufoqcmm"/><path class="s01cihu3a"/><path class="zqgyjutiw"/><path class="kb8p7zbfj"/><path class="ns0-bccns"/>`,
		"fallback": "devicon:frankenphp-wordmark",
	});
}
