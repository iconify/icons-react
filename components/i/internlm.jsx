...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="iinq4smdg"/><path class="n29lhivfr"/><path class="cdokmsw5o"/><path class="jolhxob2t"/><path class="sc4doe0dv"/><path class="bf8cleb5t"/><path class="g1998r7tb"/><path class="brtta0bjp"/><path class="jlpj18b4l"/><path class="ui_8ucbwy"/><path class="kbn0_rk7v"/><path class="v-w478b2b"/>`,
		"fallback": "thesvg-color:internlm",
	});
}
