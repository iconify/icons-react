...
</style><path class="vugs6hbmu"/><path class="zwc7umnho"/><circle class="hqz8curwo"/><circle class="vicikxbrc"/><ellipse class="eq-rojw8k"/><ellipse class="ffs_bya1t"/><path class="s3is_zbks"/>`,
		"fallback": "arcticons:fluyo",
	});
}
