...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="rypbqgbia"/><path class="sh0qj4e1q"/><path class="c2gvjcbxi"/><path class="qhhd-ob6o"/><path class="o1h9ra_2m"/><path class="t5j632b6m"/><path class="shsh_hdaq"/><path class="q5m6tkvcs"/><path class="p_e8q9boj"/><path class="t1-cl5b4m"/>`,
		"fallback": "carbon:threshold",
	});
}
