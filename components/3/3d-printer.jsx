...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="c7-56lggy"/><path class="i2iqmwb5u"/><path class="quwjaj2hv"/><path class="ebvh0ix9f"/><path class="i2uk179cg"/><path class="wgd3e6iex"/><path class="wtqkk442y"/><path class="o223pknxn"/><path class="n0wia5x_d"/><path class="fwr2ktotd"/>`,
		"fallback": "openmoji:3d-printer",
	});
}
