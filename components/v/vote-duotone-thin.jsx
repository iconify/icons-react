...
</style><g class="hntgybcog"><path class="wmp4kccwc"/><path class="mg-cr_bbs"/><path class="w2dozdlxo"/><path class="mdotczklu"/><path class="pb5scbb0y"/></g>`,
		"fallback": "iconmind:vote-duotone-thin",
	});
}
