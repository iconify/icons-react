...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="sskr_cc5j"/><path class="o7i-ahbga"/><path class="ul4tunbar"/><path class="z2bj0wbcj"/><path class="wujmewb9m"/><path class="c-7zqsbdi"/><path class="fur2z6b2q"/><path class="awwp9grfn"/><path class="d7nirym-r"/><path class="f_m-shbcv"/><path class="sudtssbtb"/><path class="cmv-wpbjh"/><path class="qej8zn31s"/>`,
		"fallback": "flat-ui:dj",
	});
}
