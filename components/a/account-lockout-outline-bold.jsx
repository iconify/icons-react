...
</style><g class="s0phu2bbs"><path class="xfs8wlfhn"/><path class="ygr1bbcag"/><path class="u7m7z6ojw"/><path class="s9itk2b_k"/></g>`,
		"fallback": "iconmind:account-lockout-outline-bold",
	});
}
