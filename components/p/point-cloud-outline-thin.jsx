...
</style><g class="hntgybcog"><path class="lu0ovacdk"/><path class="oq9ztqbxu"/><path class="fglxyivky"/><path class="lx3jidcux"/><path class="k-jt90-vx"/><path class="tr__z6b9j"/></g>`,
		"fallback": "iconmind:point-cloud-outline-thin",
	});
}
