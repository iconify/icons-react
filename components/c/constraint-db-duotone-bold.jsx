...
</style><g class="s0phu2bbs"><path class="vstipubaj"/><path class="mc5_norht"/><path class="o89tku_be"/><path class="hemk1tbpo"/><path class="g4lz7ob4p"/><path class="y5y9-x5ge"/><path class="ajxlkdb4q"/></g>`,
		"fallback": "iconmind:constraint-db-duotone-bold",
	});
}
