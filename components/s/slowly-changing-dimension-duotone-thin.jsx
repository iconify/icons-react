...
</style><g class="hntgybcog"><path class="eqtg9zhcu"/><path class="jv4nyiume"/><path class="zoomnj6dr"/><path class="lnoc67bvv"/><path class="vefr08bem"/><path class="jfvoq9bhn"/><path class="zdgvfxbbv"/><path class="slz7u0oyn"/><path class="uea_ybysx"/><path class="it83nbbll"/></g>`,
		"fallback": "iconmind:slowly-changing-dimension-duotone-thin",
	});
}
