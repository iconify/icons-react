...
</style><g class="ft5dv1b6b"><defs><mask id="SVGVYNyecjV"><path class="k5-vjlrin"/><g transform="translate(3 3)" class="ivjvz2eii"><path clip-rule="evenodd" class="uafdunbzf"/><rect class="ilr5o7bbz"/></g></mask></defs><circle mask="url(#SVGVYNyecjV)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:flag-circle-filled",
	});
}
