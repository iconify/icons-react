...
Browse all icons: [preview SVG Logos on Iconify](https://icon-sets.iconify.design/logos/)

## Installation

```bash
npm install github:iconify/icons-react#logos
```
...
```jsx
import SampleIcon from '@iconify-react/logos/npm-icon';
...
```jsx
import SampleIcon from '@iconify-react/logos/uikit';
