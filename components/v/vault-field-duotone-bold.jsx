...
</style><g class="s0phu2bbs"><path class="i211t9xib"/><path class="opsvtf7vp"/><path class="xfs8wlfhn"/><path class="ygr1bbcag"/><path class="it1-tib-h"/></g>`,
		"fallback": "iconmind:vault-field-duotone-bold",
	});
}
