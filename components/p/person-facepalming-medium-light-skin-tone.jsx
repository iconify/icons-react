...
</style><path class="baaz3dswb"/><path class="b__xj1bdq"/><path class="ajxgcybdc"/><ellipse class="cx5jr1g5w"/><path class="vhgq2nbtq"/><path class="d7nc192oy"/><path class="f3k0brb1g"/><path class="d67bc6pzm"/><path class="ytaft7bol"/><path class="cog_babio"/><path class="zo5-9mdnb"/><path class="vp4l7jkbz"/><path class="rauqnxf2m"/><path class="pi6u63f_b"/><defs><path id="SVGudEVS6BX" class="zo56_0bpy"/></defs><use href="#SVGudEVS6BX" class="u46is_brm"/>`,
		"fallback": "noto-v1:person-facepalming-medium-light-skin-tone",
	});
}
