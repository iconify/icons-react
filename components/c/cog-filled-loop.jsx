...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="es6gsb"/><path class="mx963o ydovum"/><path class="bvcbdi ydovum"/><path class="u5kw3r ydovum"/><path class="gl0rpz ydovum"/><path class="v88fpx ydovum"/><path class="q0e96w ydovum"/>`,
		"fallback": "line-md:cog-filled-loop",
	});
}
