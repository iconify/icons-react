...
</style><g class="hntgybcog"><path class="m7h1qvb0y"/><path class="ocq6-ebua"/><path class="is1bv_axc"/><path class="cm50vhb_x"/></g>`,
		"fallback": "iconmind:responsive-mode-duotone-thin",
	});
}
