...
</style><g class="s0phu2bbs"><path class="c4my-jbpv"/><path class="ha2bk5bpt"/><path class="r8fcakblc"/><path class="qkea2dbiu"/></g>`,
		"fallback": "iconmind:data-validation-outline-bold",
	});
}
