...
</style><g class="s0phu2bbs"><path class="fovk5-8-n"/><path class="m9ye59-4c"/><path class="jhksy109d"/><path class="nf9-vm8iy"/><path class="xrrcnmb6x"/><path class="c6ayt6bgs"/><path class="lv-mj3bxw"/><path class="oqq60ccjl"/><path class="e54_mjwsr"/></g>`,
		"fallback": "iconmind:map-step-duotone-bold",
	});
}
