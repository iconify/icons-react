...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.b4m0ohb_o {
  d: path("M192 176v48l-64-40l-64 40v-48l64-40Z");
...
</style><g class="cuyn6tgcc"><path class="b4m0ohb_o"/><path class="ftuj3yb7h"/></g>`,
		"fallback": "ph:bookmark-duotone",
	});
}
