...
</style><path class="tl3tdac8p"/><path class="c-m0vcc3k"/><path class="pp9urmbsf"/><circle class="i4a5_qbra"/><path class="x3krmbc6n"/>`,
		"fallback": "emojione:flag-for-flag-new-caledonia",
	});
}
