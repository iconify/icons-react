...
.fi-8e5b8q {
  d: path("M13.5 13.5h8.75v8.75H13.5z");
}
...
.xzictkbiv {
  d: path("M22.25 30.125a4.375 4.375 0 1 0-4.375 4.375h4.375z");
}
...
</style><path class="dgaydki2p"/><g class="y9tr6bcfx"><path class="fi-8e5b8q"/><rect class="hgh2xyb3u"/><circle class="jn8zzponk"/><path class="xzictkbiv"/></g>`,
		"fallback": "arcticons:pix-material-you",
	});
}
