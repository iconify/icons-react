...
</style><g class="s0phu2bbs"><path class="dx3ubrb9h"/><path class="hbtmd5b0k"/><path class="vw_dl18nv"/><path class="da_3coiun"/></g>`,
		"fallback": "iconmind:list-alert-outline-bold",
	});
}
