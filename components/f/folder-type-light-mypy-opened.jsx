...
</style><path class="b69rm_9vp"/><path class="ptoytlc-g"/><path class="jw91py0qw"/><path class="s8fxkabzh"/>`,
		"fallback": "vscode-icons:folder-type-light-mypy-opened",
	});
}
