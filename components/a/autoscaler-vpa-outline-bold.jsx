...
</style><g class="s0phu2bbs"><path class="okud9xj_d"/><path class="ik93a37tn"/><path class="k1llj9blt"/><path class="inae6abkl"/></g>`,
		"fallback": "iconmind:autoscaler-vpa-outline-bold",
	});
}
