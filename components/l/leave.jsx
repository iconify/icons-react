...
</style><g clip-rule="evenodd" class="n1lsf0bnc"><path class="js8u8mbyf"/><path class="gvnbgvb7i"/><path class="scv2whwap"/><path class="uufs5-bfc"/></g>`,
		"fallback": "pepicons-pop:leave",
	});
}
