...
</style><defs><path id="SVGCjwircEr" class="a66j17bbi"/></defs><mask id="SVGd4Xo1w9i" class="n1mjunbsu"><use href="#SVGCjwircEr"/></mask><use href="#SVGCjwircEr" class="heeii1f4x"/><path mask="url(#SVGd4Xo1w9i)" class="nflhq8v3y"/>`,
		"fallback": "logos:storybook-icon",
	});
}
