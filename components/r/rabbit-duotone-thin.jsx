...
</style><g class="hntgybcog"><path class="xocy_1fwz"/><path class="s80d-wbmo"/><path class="litcbzkgt"/><path class="osjmvib6z"/><path class="le7pjtb_z"/><path class="iv17tcb7u"/></g>`,
		"fallback": "iconmind:rabbit-duotone-thin",
	});
}
