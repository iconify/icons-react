...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="a0a9vkbzg"><path class="ic806kb8h"/><path class="hmwcj1thc"/><path class="h19kr0b8c"/><path class="or73ihu0n"/><path class="e47cv6csu"/><path class="jv-k56j0a"/><path class="bubknbbzm"/><path class="igotlz6cn"/><path class="svxjkzbtw"/><path class="vrfkpbbys"/><path class="k6z74gbkx"/><path class="y98vzqcxq"/></g>`,
		"fallback": "icon-park:ungroup",
	});
}
