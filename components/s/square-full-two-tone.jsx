...
</style><g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="i5lvicvhn"/><path class="gtsg3ccob"/></g>`,
		"fallback": "keyline-icons:square-full-two-tone",
	});
}
