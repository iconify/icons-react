...
</style><path class="c4gldibut"/><path class="u0fjfo12g"/><path class="fmi6kqb7z"/><path class="tz-4kebqz"/><path class="mf-6debwy"/><circle class="vxeh-o70a"/><path class="vbq18bipa"/><path class="sf0sfxlmu"/><circle class="qt-d8l05k"/><path class="xhiok0bor"/><path class="i8-gnnkyc"/><path class="tqilwbbyi"/><circle class="auab7e0qj"/><path class="lhzs4hbmj"/><g class="cluxj1brx"><path class="h79pu4bft"/><ellipse class="dkzw2si8o"/><path class="s0b0itbuy"/></g>`,
		"fallback": "emojione:princess-medium-dark-skin-tone",
	});
}
