...
</style><g class="s0phu2bbs"><path class="htj7d_25n"/><path class="qux3mqb3d"/><path class="ljn9xlbjs"/><path class="xu9fnz9ia"/><path class="wr_ld5s1h"/></g>`,
		"fallback": "iconmind:widget-outline-bold",
	});
}
