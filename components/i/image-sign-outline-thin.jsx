...
</style><g class="hntgybcog"><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="hi6fpzbzb"/><path class="r0ac1hbbr"/></g>`,
		"fallback": "iconmind:image-sign-outline-thin",
	});
}
