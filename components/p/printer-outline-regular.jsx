...
</style><g class="nrj6p8qat"><path class="jirei-bba"/><path class="sfh31bcxq"/><path class="nzu-xuz8n"/><path class="qfaf8otig"/></g>`,
		"fallback": "iconmind:printer-outline-regular",
	});
}
