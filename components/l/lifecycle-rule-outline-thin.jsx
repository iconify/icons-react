...
</style><g class="hntgybcog"><path class="cwmo4bc4s"/><path class="m5wi144di"/><path class="nk1txyodw"/><path class="o7fu1nbtq"/><path class="eus9a2f4d"/></g>`,
		"fallback": "iconmind:lifecycle-rule-outline-thin",
	});
}
