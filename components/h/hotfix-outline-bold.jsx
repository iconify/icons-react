...
</style><g class="s0phu2bbs"><path class="gljey2tgk"/><path class="pqzdmxnfr"/><path class="ygm75acdx"/><path class="wf5lx0b1p"/></g>`,
		"fallback": "iconmind:hotfix-outline-bold",
	});
}
