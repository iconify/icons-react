...
</style><circle class="y9zt6mb3r"/><path class="mqv5_xbme"/><path class="y-ll_zlfa"/><path class="iw3kzevrs"/><path class="gs09fjg3h"/>`,
		"fallback": "arcticons:critical-maps",
	});
}
