...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="c9i8f50fi"/><path class="btdwznbdt"/><path class="vsn5h673m"/><path class="b48_fx5yv"/><path class="ek-ccxtkl"/><path class="yo2fez3mw"/><path class="bmn9ambyz"/><circle class="ng98avb_t"/><circle class="rurvrnlhn"/><path class="rt2eomx4r"/><path class="j-y2wybsu"/>`,
		"fallback": "openmoji:crying-cat",
	});
}
