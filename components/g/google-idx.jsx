...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ft5dv1b6b"><rect class="ijfd08bxj"/><rect class="e2g2vwlvv"/><rect class="cl9p6ablh"/><rect class="br05jlb3j"/><rect class="wxt8i2boy"/><rect class="qjle2ebpg"/><rect class="ru2_dftho"/><rect class="jr1zj_bba"/></g>`,
		"fallback": "thesvg-color:google-idx",
	});
}
