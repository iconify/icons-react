...
</style><g class="s0phu2bbs"><path class="xfs8wlfhn"/><path class="ygr1bbcag"/><path class="htl7tccnk"/><path class="vqi6vft7m"/><path class="y0v87rbkg"/></g>`,
		"fallback": "iconmind:secret-k8s-outline-bold",
	});
}
