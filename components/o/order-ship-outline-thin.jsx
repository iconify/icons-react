...
</style><g class="hntgybcog"><path class="g00uv-b-x"/><path class="koh8ckbdb"/><path class="k2mg4f2ls"/><path class="tx7sl_bgm"/></g>`,
		"fallback": "iconmind:order-ship-outline-thin",
	});
}
