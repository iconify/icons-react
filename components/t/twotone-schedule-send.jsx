...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.lbdrmfoie {
  fill: currentColor;
  d: path("m5 10.5l6 1.5l-6 1.5v3.49l5.39-2.27c.6-1.73 1.86-3.16 3.48-3.97L5 7.01z");
...
</style><path class="lbdrmfoie"/><path class="vepszya0v"/><path class="qufhvogco"/>`,
		"fallback": "ic:twotone-schedule-send",
	});
}
