...
.jjhjpffig {
  d: path("M127.941 0v84.43c23.81 0 43.112 19.302 43.112 43.112s-19.302 43.112-43.112 43.112a39.413 39.413 0 0 1 39.413 39.414v38.785c59.746-19.322 96.533-79.262 86.71-141.281C244.243 45.553 190.735-.085 127.942 0");
}

.sav6x4bmf {
  stop-color: var(--svg-color--0052cc, #0052cc);
}
</style><defs><linearGradient id="SVGpDQ3Dcfl" x1="49.928%" x2="49.928%" y1="90.721%" y2="36.288%"><stop offset="18%" class="sav6x4bmf"/><stop offset="100%" class="g_gp7lgqe"/></linearGradient></defs><path class="h9ug6uipz"/><path fill="url(#SVGpDQ3Dcfl)" class="jjhjpffig"/>`,
		"fallback": "logos:sourcetree",
	});
}
