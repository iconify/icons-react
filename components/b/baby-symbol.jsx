...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="mrks0fbpf"/><path class="a1xc9wtzj"/><path class="lnk70ebvn"/><path class="k_aj-u6vn"/><path class="w181286hn"/><path class="g84hzdkte"/><circle class="j2vc_krmp"/><g class="jn8qy4bru"><path class="mmd2f6aax"/><path class="w9c0vm-3u"/><path class="kouts3b-v"/><circle class="vlrdnybbv"/><path class="n8gu1ebhy"/></g>`,
		"fallback": "openmoji:baby-symbol",
	});
}
