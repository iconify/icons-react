...
</style><defs><linearGradient id="SVGYCB4I0lC" x1="43.896%" x2="66.16%" y1="1.951%" y2="95.244%"><stop offset="28%" class="xtrtznbzt"/><stop offset="94%" class="r_lf9ybqi"/></linearGradient><linearGradient id="SVGGyvlDdgG" x1="33.063%" x2="70.362%" y1="15.078%" y2="84.685%"><stop offset="14%" class="bzg--8baj"/><stop offset="37%" class="xtrtznbzt"/></linearGradient><linearGradient id="SVGTkdXRckd" x1="44.416%" x2="56.203%" y1="25.058%" y2="90.203%"><stop offset="28%" class="xtrtznbzt"/><stop offset="94%" class="r_lf9ybqi"/></linearGradient></defs><path fill="url(#SVGYCB4I0lC)" class="iwui5w2ct"/><path fill="url(#SVGGyvlDdgG)" class="o3xjyl5sq"/><path fill="url(#SVGTkdXRckd)" class="cxuevjphi"/><path class="wj8kk3bmp"/><path class="at4v6hb1y"/>`,
		"fallback": "logos:webstorm",
	});
}
