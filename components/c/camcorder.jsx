...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="s7g75ujnv"/><circle class="o6dok5orn"/><circle class="b9k2yzb_d"/><path class="pzfgvwbhd"/><path class="xuf0iabiw"/><path class="osf6o2bkj"/><path class="oueqy_vht"/><path class="z0zkwccdi"/><g class="w1jne4bus"><circle class="sxa6gpb8q"/><path class="pye0iqbag"/></g><circle class="ttqflxbbb"/><circle class="dhy28czew"/>`,
		"fallback": "flat-color-icons:camcorder",
	});
}
