...
</style><g class="s0phu2bbs"><path class="yrm0q7bju"/><path class="xhm7i-rii"/><path class="d8z1r1beo"/><path class="wzx0dxb2r"/><path class="rbp29tbnz"/></g>`,
		"fallback": "iconmind:refresh-token-api-duotone-bold",
	});
}
