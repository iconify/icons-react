...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.b779fibhj {
  d: path("M224 80v112H48a16 16 0 0 1-16-16V80Z");
...
</style><g class="cuyn6tgcc"><path class="b779fibhj"/><path class="dmt4edc6e"/></g>`,
		"fallback": "ph:option-duotone",
	});
}
