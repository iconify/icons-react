...
</style><g class="nrj6p8qat"><path class="hbdbg_bcy"/><path class="lyjarcbwz"/><path class="fkopq9pyc"/><path class="go1co5b_o"/><path class="mxb6569jn"/></g>`,
		"fallback": "iconmind:chat-more-outline-regular",
	});
}
