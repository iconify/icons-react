...
</style><g class="hntgybcog"><path class="is1bv_axc"/><path class="tc8fh3off"/><path class="f2vh026ub"/><path class="fkf_gcbra"/></g>`,
		"fallback": "iconmind:model-comparison-outline-thin",
	});
}
