...
</style><g class="nrj6p8qat"><path class="hrm50umfz"/><path class="lwlflab4b"/><path class="zirb-hbnv"/><path class="n0hr0gbrt"/><path class="s24u-_b8l"/><path class="d-_u6mtyl"/></g>`,
		"fallback": "iconmind:braille-outline-regular",
	});
}
