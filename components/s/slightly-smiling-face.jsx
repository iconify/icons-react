...
</style><path class="r1bq7qb_u"/><circle class="w_ipsacim"/><circle class="ssiuuy_ah"/><path class="tr2ey3b6w"/>`,
		"fallback": "emojione-monotone:slightly-smiling-face",
	});
}
