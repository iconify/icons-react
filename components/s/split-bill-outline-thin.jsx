...
</style><g class="hntgybcog"><path class="jd_dotbnq"/><path class="wgmj3x5ib"/><path class="iwjnwtbxd"/><path class="cta_b6xgu"/></g>`,
		"fallback": "iconmind:split-bill-outline-thin",
	});
}
