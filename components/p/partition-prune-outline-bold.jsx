...
</style><g class="s0phu2bbs"><path class="y76hd_85j"/><path class="tc8fh3off"/><path class="f2kvp6bqh"/><path class="cys9dsbbm"/></g>`,
		"fallback": "iconmind:partition-prune-outline-bold",
	});
}
