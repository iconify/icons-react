...
</style><path class="rt0-05brn"/><path class="b__xj1bdq"/><path class="ajxgcybdc"/><ellipse class="dc4-3jv6z"/><path class="ckt3beb8o"/><path class="a-ecvpo4i"/><path class="t_q08zk1b"/><path class="docvb-b5i"/><path class="ytaft7bol"/><path class="mho3hlbaz"/><path class="zo5-9mdnb"/><path class="vp4l7jkbz"/><path class="kefht4wjs"/><path class="ely15yb3h"/><defs><path id="SVGudEVS6BX" class="zo56_0bpy"/></defs><use href="#SVGudEVS6BX" class="u46is_brm"/>`,
		"fallback": "noto-v1:person-facepalming-medium-dark-skin-tone",
	});
}
