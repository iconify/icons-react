...
</style><g class="s0phu2bbs"><path class="s3lwy2n0b"/><path class="emo-jf0pj"/><path class="h-fyw90ib"/><path class="l23it1b0d"/><path class="t164-vbgd"/></g>`,
		"fallback": "iconmind:bare-metal-outline-bold",
	});
}
