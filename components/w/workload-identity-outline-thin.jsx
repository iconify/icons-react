...
</style><g class="hntgybcog"><path class="okud9xj_d"/><path class="d-61bcbwh"/><path class="h75gqfbny"/><path class="ddrdpbb1j"/></g>`,
		"fallback": "iconmind:workload-identity-outline-thin",
	});
}
