...
</style><path class="j_edqwb9w"/><path class="h0r3857rl"/><path class="sbz9bzb4r"/><path class="ypkc0eh9s"/><path class="o10oelbnr"/>`,
		"fallback": "emojione:mount-fuji",
	});
}
