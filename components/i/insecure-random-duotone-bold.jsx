...
</style><g class="s0phu2bbs"><path class="i211t9xib"/><path class="xfs8wlfhn"/><path class="iml3cbclx"/><path class="kyg_uzbvc"/></g>`,
		"fallback": "iconmind:insecure-random-duotone-bold",
	});
}
