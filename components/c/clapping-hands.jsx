...
</style><path class="mtuniib5h"/><path class="agepc6wgf"/><defs><path id="SVGHS5T6b0Y" class="jusagjbiu"/></defs><clipPath id="SVGmyL66ddH"><use href="#SVGHS5T6b0Y"/></clipPath><path clip-path="url(#SVGmyL66ddH)" class="h-4c6pbhx"/><defs><use href="#SVGHS5T6b0Y" id="SVGN1cpRcQB"/></defs><clipPath id="SVGCNTilnCF"><use href="#SVGN1cpRcQB"/></clipPath><g clip-path="url(#SVGCNTilnCF)" class="t3q4o6ulj"><path class="qoq2pgbqk"/></g>`,
		"fallback": "noto:clapping-hands",
	});
}
