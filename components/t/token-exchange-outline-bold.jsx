...
</style><g class="s0phu2bbs"><path class="a218-cpca"/><path class="l0v-b4kbr"/><path class="az5esj3_g"/><path class="d_yxl29go"/></g>`,
		"fallback": "iconmind:token-exchange-outline-bold",
	});
}
