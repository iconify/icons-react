...
</style><g class="nrj6p8qat"><path class="jrpnc2pnl"/><path class="hiqcqfbaf"/><path class="qye2ovraz"/><path class="elmoo_bpw"/></g>`,
		"fallback": "iconmind:visual-diff-outline-regular",
	});
}
