...
</style><g class="nrj6p8qat"><path class="v-yh3actq"/><path class="rw6ho_bav"/><path class="asewlgb2k"/><path class="mvm7r4bea"/><path class="mtc590bck"/></g>`,
		"fallback": "iconmind:date-range-outline-regular",
	});
}
