...
</style><g class="nrj6p8qat"><path class="vzmtjrkzh"/><path class="fozhwebbv"/><path class="bo51iypxr"/><path class="bo9_g-q3m"/></g>`,
		"fallback": "iconmind:semaphore-outline-regular",
	});
}
