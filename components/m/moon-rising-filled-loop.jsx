...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="jit9cw ydovum"/><path class="gwaamo ydovum"/><path class="ud3ngs ydovum"/><path class="tiiyvt ydovum"/><path class="ydovum z52z6h"/>`,
		"fallback": "line-md:moon-rising-filled-loop",
	});
}
