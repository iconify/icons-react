...
</style><g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="i5lvicvhn"/><path class="gdnqdbb2r"/></g>`,
		"fallback": "keyline-icons:square-arrow-down-left-two-tone",
	});
}
