...
</style><g class="s0phu2bbs"><path class="m7ezp3bui"/><path class="ls7ugdcwr"/><path class="if5ft31dv"/><path class="ki3b7s-pe"/></g>`,
		"fallback": "iconmind:cost-cloud-outline-bold",
	});
}
