...
</style><path class="ux-eufbvc"/><circle class="xrvvu0fts"/><circle class="t3avdfb0o"/><circle class="uqsohbb5z"/><circle class="tnadvnpqb"/>`,
		"fallback": "ic:outline-color-lens",
	});
}
