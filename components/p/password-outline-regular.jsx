...
</style><g class="nrj6p8qat"><path class="murw5tb-p"/><path class="a7vpafiwa"/><path class="dng5kz1zs"/><path class="ync9d6bsc"/></g>`,
		"fallback": "iconmind:password-outline-regular",
	});
}
