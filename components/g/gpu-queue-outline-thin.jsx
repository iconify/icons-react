...
</style><g class="hntgybcog"><path class="kn0tcm93r"/><path class="ymw3aibdo"/><path class="jg5k_rbda"/><path class="h3f_66bxu"/><path class="i3md2ibef"/></g>`,
		"fallback": "iconmind:gpu-queue-outline-thin",
	});
}
