...
</style><path class="ftcofqlpz"/><path class="owyu5pzyw"/><path class="axtpvpb1d"/><path class="ghmrb2bhj"/><path class="c7a0lnbmw"/>`,
		"fallback": "emojione:flag-for-flag-cape-verde",
	});
}
