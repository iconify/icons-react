...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="bi12bsetm"><path class="u9j2jq8qm"/><path class="hfdlftbfd"/><path class="ktvyjx33i"/><path class="efzxyzb1i"/><path class="vn34bdcic"/><path class="wd0-cz21h"/><path class="z14fekb7u"/><path class="ktfjgbc-g"/><path class="jknmelb_y"/></g>`,
		"fallback": "cif:ao",
	});
}
