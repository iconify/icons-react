...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="k1o6qx1og"/><path class="sjg5v_bcc"/><path class="tfs0nacqg"/><path class="ij1kr2uab"/><path class="gz0rl1bzz"/><path class="glt8yjchn"/><path class="pt0nsn86l"/><path class="tjq3jldnn"/><path class="jdzi9ub9o"/><path class="lw-as8b0o"/><path class="ep_vvtmni"/><path class="mjkny2bob"/><path class="bspy-xb-w"/>`,
		"fallback": "streamline-emojis:crossed-flags",
	});
}
