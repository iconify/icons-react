...
</style><g class="hntgybcog"><path class="zpl84_dhy"/><path class="wc595gblk"/><path class="fozhwebbv"/><path class="bo88vlbuz"/></g>`,
		"fallback": "iconmind:get-together-outline-thin",
	});
}
