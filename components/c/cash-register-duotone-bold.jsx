...
</style><g class="s0phu2bbs"><path class="xbwcutbts"/><path class="qh3x50ajr"/><path class="j8133bcoj"/><path class="z6y0gfbug"/><path class="a-v3knb-a"/><path class="qgw5bw59f"/></g>`,
		"fallback": "iconmind:cash-register-duotone-bold",
	});
}
