...
</style><g class="ft5dv1b6b"><defs><mask id="SVGaXFO0KIF"><path class="k5-vjlrin"/><g clip-rule="evenodd" class="kvn14gsjy"><path class="t_vb2bc_v"/><path class="tjy-4lbwr"/></g></mask></defs><circle mask="url(#SVGaXFO0KIF)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:hand-point-open-circle-filled",
	});
}
