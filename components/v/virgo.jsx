...
</style><defs><path id="SVGEuqCNcrv" class="s0b74bbyt"/></defs><circle class="axudp51jy"/><circle class="znafracxo"/><use href="#SVGEuqCNcrv" class="pfsdhbbki"/><path class="iy7cj461x"/><use href="#SVGEuqCNcrv" class="e0ty9gbgt"/>`,
		"fallback": "noto:virgo",
	});
}
