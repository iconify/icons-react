...
</style><g class="ft5dv1b6b"><g clip-path="url(#SVGHcSWxdhd)"><path class="mumfproca"/><path fill="url(#SVG266lbtRN)" class="mkoduxtac"/></g><defs><linearGradient id="SVG266lbtRN" x1="4" x2="19.86" y1="19.003" y2="5.968" gradientUnits="userSpaceOnUse"><stop class="g9790lcds"/><stop offset=".37" class="w7dqnvawf"/><stop offset=".65" class="f100ehoot"/><stop offset=".86" class="ip-98lbei"/><stop offset="1" class="hr1k6kb1p"/></linearGradient><clipPath id="SVGHcSWxdhd"><path class="py7ktqbvf"/></clipPath></defs></g>`,
		"fallback": "token-branded:cell-background",
	});
}
