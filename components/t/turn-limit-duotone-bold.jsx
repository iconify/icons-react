...
</style><g class="s0phu2bbs"><path class="u6glnqdag"/><path class="eid_r_b9d"/><path class="fw_wgnb2f"/><path class="ml617mhdr"/><path class="vgrmyb3pe"/></g>`,
		"fallback": "iconmind:turn-limit-duotone-bold",
	});
}
