...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ipq1z-bjh"><path class="efmll2b9w"/><path class="b1-zrccxf"/><path class="v2njeqw1d"/><path class="p44zvobxz"/><path class="cboq8pb9w"/><path class="xzgidrpom"/><path class="l7e1lbchd"/><path class="cyqn4h1zs"/><path class="wvgv4aclx"/><path class="a-4dztb1w"/><path class="kov4zacea"/></g>`,
		"fallback": "solar:bug-linear",
	});
}
