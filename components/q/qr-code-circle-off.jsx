...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="hf98ojbjs"/><path class="gbqb6oopz"/><path clip-rule="evenodd" class="cj775-wzw"/><path clip-rule="evenodd" class="pts0vxulq"/><path clip-rule="evenodd" class="c4k_5bciy"/><path clip-rule="evenodd" class="tpbhhcc8h"/><path clip-rule="evenodd" class="pm34e9z5u"/><path class="zsuclwbnx"/><path clip-rule="evenodd" class="kspoj7vnd"/></g>`,
		"fallback": "pepicons-pencil:qr-code-circle-off",
	});
}
