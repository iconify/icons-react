...
</style><defs><linearGradient id="SVGqFpXpeGU" x1="50%" x2="50%" y1="-1.02%" y2="100%"><stop offset="0%" class="olsf03bjv"/><stop offset="100%" class="ypshk4bag"/></linearGradient></defs><path fill="url(#SVGqFpXpeGU)" class="xp2iihvxi"/>`,
		"fallback": "logos:vaddy",
	});
}
