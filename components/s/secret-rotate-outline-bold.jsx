...
</style><g class="s0phu2bbs"><path class="d8z1r1beo"/><path class="wzx0dxb2r"/><path class="xedmbxbzm"/><path class="rrzohjbez"/></g>`,
		"fallback": "iconmind:secret-rotate-outline-bold",
	});
}
