...
.xcmg71b3w {
  fill: currentColor;
  d: path("M7 14h3v3H7zm0-7h3v3H7zM5 19h14V5H5zm8-11.5h5v2h-5zm0 7h5v2h-5zM6 6h5v5H6zm0 7h5v5H6z");
  opacity: var(--svg-opacity--0-3, 0.3);
}
</style><path class="xcmg71b3w"/><path class="g8a-6xbac"/>`,
		"fallback": "ic:twotone-ballot",
	});
}
