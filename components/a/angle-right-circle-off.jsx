...
</style><g class="cuyn6tgcc"><path class="nv3b7hbiq"/><path class="lw38hlb5q"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:angle-right-circle-off",
	});
}
