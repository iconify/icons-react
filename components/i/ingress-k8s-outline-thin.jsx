...
</style><g class="hntgybcog"><path class="ttpxlcc5b"/><path class="wfmdw-bov"/><path class="m3ubefbgj"/><path class="z55just5o"/><path class="qjx5s3xna"/></g>`,
		"fallback": "iconmind:ingress-k8s-outline-thin",
	});
}
