...
.fcdo9oj1y {
  stop-color: var(--svg-color--b5b0ab, #b5b0ab);
}
...
.gj7qosu4g {
  stop-color: var(--svg-color--fffefa, #fffefa);
}
...
.sd3h04bxb {
  d: path("M4.322 15.664a5.2 5.2 0 0 0-.066 1.708c.027.223.044.414.033.42c-.027.027-.366-.328-.53-.557a5.2 5.2 0 0 1-.6-1.232l-.103-.366l-.01-.038a3.4 3.4 0 0 1-.044-.655c.501.104.96.355 1.32.72");
}
...
</style><g class="ft5dv1b6b"><path fill="url(#SVGPXyTFdTd)" class="zmrzsmhvw"/><path fill="url(#SVGIkONqcBB)" class="sd3h04bxb"/><path class="bd1-yjdsp"/><defs><linearGradient id="SVGPXyTFdTd" x1="18.622" x2="7.13" y1="4.368" y2="19.219" gradientUnits="userSpaceOnUse"><stop class="fcdo9oj1y"/><stop offset=".26" class="dmcj5hxgo"/><stop offset=".54" class="htwnv68rs"/><stop offset=".84" class="gj7qosu4g"/><stop offset="1" class="vc--wpv5i"/></linearGradient><linearGradient id="SVGIkONqcBB" x1="12.011" x2="13.863" y1="17.337" y2="-10.602" gradientUnits="userSpaceOnUse"><stop class="almpnlbcv"/><stop offset=".33" class="vc--wpv5i"/></linearGradient></defs></g>`,
		"fallback": "token-branded:ibat",
	});
}
