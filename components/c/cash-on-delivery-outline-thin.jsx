...
</style><g class="hntgybcog"><path class="g00uv-b-x"/><path class="koh8ckbdb"/><path class="k2mg4f2ls"/><path class="zzd_26bmd"/><path class="vdiixtbot"/></g>`,
		"fallback": "iconmind:cash-on-delivery-outline-thin",
	});
}
