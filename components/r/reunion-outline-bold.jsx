...
</style><g class="s0phu2bbs"><path class="mn-a1zb6m"/><path class="e2kgfl2ea"/><path class="s25-orfog"/><path class="jv3d31_7h"/><path class="mqnae981n"/></g>`,
		"fallback": "iconmind:reunion-outline-bold",
	});
}
