...
</style><g class="s0phu2bbs"><path class="wl0ht0yem"/><path class="fim5wvb3d"/><path class="j5z_xpbsk"/><path class="lhhiiffss"/></g>`,
		"fallback": "iconmind:active-active-outline-bold",
	});
}
