...
</style><path class="wznnebk3i"/><path class="s6btn_vru"/><path class="hycm7lx4i"/><path class="shmmsqb6b"/>`,
		"fallback": "arcticons:keeper-password-manager",
	});
}
