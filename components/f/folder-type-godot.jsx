...
</style><path class="rw0vs8wac"/><path class="u0a487b8n"/><path class="qfkmslkqh"/><path class="q_j4m0b2k"/><path class="hhh5u8bzi"/><path class="iecohtb2j"/><path class="i60wxqb9h"/>`,
		"fallback": "vscode-icons:folder-type-godot",
	});
}
