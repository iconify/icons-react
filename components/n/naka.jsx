...
</style><g class="ft5dv1b6b"><path class="kwuuvwbzr"/><path class="nfeujor-m"/><path class="novumccsd"/><path class="x152bzbjv"/><path class="zmnhakbwg"/></g>`,
		"fallback": "token-branded:naka",
	});
}
