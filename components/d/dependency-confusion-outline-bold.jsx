...
</style><g class="s0phu2bbs"><path class="iymet_cml"/><path class="bb_62lblh"/><path class="okqksmbze"/><path class="lxtc-wp5b"/><path class="s-cqkabbd"/></g>`,
		"fallback": "iconmind:dependency-confusion-outline-bold",
	});
}
