...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ft5dv1b6b"><path class="clw_24bxa"/><path class="i_m7w2fwr"/><path class="dpijw6b8v"/><path class="eujbzuv9i"/><path class="ozwg07bnd"/><path class="dwegpzbuy"/><path class="emxzobi8p"/><path class="h57kj0bhw"/><path class="v6wn2gbsl"/></g>`,
		"fallback": "streamline-stickies-color:airport-railroad",
	});
}
