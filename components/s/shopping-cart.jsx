...
</style><path class="fqyxw5byy"/><path class="o_-aw9bjb"/><circle class="k0g_w2bev"/><path class="gu-wa5b2a"/><circle class="ogvbrorqg"/><path class="j2slkh9-v"/>`,
		"fallback": "twemoji:shopping-cart",
	});
}
