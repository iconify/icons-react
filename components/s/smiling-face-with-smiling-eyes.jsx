...
</style><circle class="rhvdvboaq"/><g class="nv_n5pb_p"><circle class="f97bvyy1m"/><circle class="fi-bbccoy"/></g><path class="jdzv6p5dq"/>`,
		"fallback": "emojione:smiling-face-with-smiling-eyes",
	});
}
