...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="avep9i2uu"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:circle-big-circle-off",
	});
}
