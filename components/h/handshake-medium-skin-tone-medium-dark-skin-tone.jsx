...
</style><path class="jcmp73b3n"/><path class="vhbcblygw"/><defs><path id="SVGU67dBeQS" class="l439n0bap"/></defs><clipPath id="SVG617RIbte"><use href="#SVGU67dBeQS"/></clipPath><g clip-path="url(#SVG617RIbte)" class="byeg-0b8a"><path class="o4yqbwbdl"/></g><defs><use href="#SVGU67dBeQS" id="SVGCPeKAdMZ"/></defs><clipPath id="SVG3ABvZdad"><use href="#SVGCPeKAdMZ"/></clipPath><g clip-path="url(#SVG3ABvZdad)" class="lip7wrrrl"><path class="oqad6y8ry"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="k4qe_xbxk"><path class="s2_2_ccsc"/></g><defs/><g clip-path="url(#SVG3ABvZdad)" class="u0e24bcck"><path class="trz1g0bjh"/></g>`,
		"fallback": "noto:handshake-medium-skin-tone-medium-dark-skin-tone",
	});
}
