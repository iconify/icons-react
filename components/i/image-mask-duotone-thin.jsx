...
</style><g class="hntgybcog"><path class="nogsotb5y"/><path class="xmpryg7fh"/><path class="k_2z93bzc"/><path class="o72p0hsyz"/><path class="vdjbxw5wp"/><path class="n3p0zmbop"/></g>`,
		"fallback": "iconmind:image-mask-duotone-thin",
	});
}
