...
</style><path class="x6vp2hbzz"/><circle class="t8-_arz4f"/><circle class="pt3nek-ut"/><path class="vv2p67bzj"/>`,
		"fallback": "ic:round-face-retouching-natural",
	});
}
