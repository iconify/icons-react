...
</style><g class="hntgybcog"><path class="v-yh3actq"/><path class="rw6ho_bav"/><path class="asewlgb2k"/><path class="mvm7r4bea"/><path class="mtc590bck"/></g>`,
		"fallback": "iconmind:date-range-outline-thin",
	});
}
