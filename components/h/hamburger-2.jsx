...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="dszo__bml"/><path class="ba2ea0bdj"/><path class="i4rs8ybyd"/><path class="gq07ev17p"/><path class="d5-ua5fuy"/><path class="p-y9q9bqk"/><path class="uosti5b5r"/><path class="nlweg2tas"/><path class="roys2bbur"/><path class="j197p57ls"/><path class="my0h9jskl"/><path class="mtpekf8az"/>`,
		"fallback": "streamline-emojis:hamburger-2",
	});
}
