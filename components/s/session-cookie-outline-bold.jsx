...
</style><g class="s0phu2bbs"><path class="wqh892bhx"/><path class="u84sg0ngq"/><path class="wvuc0ff5n"/><path class="y6kfzfgng"/></g>`,
		"fallback": "iconmind:session-cookie-outline-bold",
	});
}
