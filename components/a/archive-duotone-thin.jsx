...
</style><g class="hntgybcog"><path class="eqtg9zhcu"/><path class="ejkik-fut"/><path class="jfvoq9bhn"/><path class="lds96gber"/><path class="ae0h5kb0o"/></g>`,
		"fallback": "iconmind:archive-duotone-thin",
	});
}
