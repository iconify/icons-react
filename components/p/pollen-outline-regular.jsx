...
</style><g class="nrj6p8qat"><path class="dx5s6zbrc"/><path class="lu0ovacdk"/><path class="fglxyivky"/><path class="lx3jidcux"/><path class="tr__z6b9j"/><path class="oq9ztqbxu"/></g>`,
		"fallback": "iconmind:pollen-outline-regular",
	});
}
