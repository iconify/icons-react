...
</style><path class="uvy_l3b5i"/><path class="fnl-we-jy"/><path class="ivvhgh-6y"/><path class="alo7wou8m"/><path class="ldduf345s"/>`,
		"fallback": "emojione-v1:flag-for-flag-faroe-islands",
	});
}
