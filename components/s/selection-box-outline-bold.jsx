...
</style><g class="s0phu2bbs"><path class="vj0y8fbql"/><path class="sh5dclbup"/><path class="v2maedbuw"/><path class="f-g8rrj2k"/><path class="zn7ywxs2s"/></g>`,
		"fallback": "iconmind:selection-box-outline-bold",
	});
}
