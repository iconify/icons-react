...
</style><path class="qj_u975nk"/><path class="mq11znbhv"/><ellipse class="kvpe9yqiv"/><ellipse class="g6yb9jbru"/><ellipse class="w2d6gzbxc"/><ellipse class="jh_h5pn7f"/><ellipse class="ia3hdkptg"/><circle class="w4zl266-a"/><ellipse class="x8l2yit6v"/><ellipse class="r_vxiqcmd"/><ellipse class="mr-z_gkjy"/><ellipse class="sapf6s7wb"/>`,
		"fallback": "emojione-monotone:shield",
	});
}
