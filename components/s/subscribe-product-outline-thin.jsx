...
</style><g class="hntgybcog"><path class="bpciasb2z"/><path class="c11_n0b6s"/><path class="k3juqlbuw"/><path class="o7-7k5bqs"/><path class="kl5egs07h"/></g>`,
		"fallback": "iconmind:subscribe-product-outline-thin",
	});
}
