...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="l_fp5xfkt"/><path class="begs6-bpt"/><path class="x0ntp389p"/><path class="fuuvgbcxy"/><path class="lpowxxrtt"/><path class="zpsyk8qlw"/><path class="lad2-rbdy"/><path class="ko9q05_gd"/><path class="ff7b4ab9l"/><path class="esaqbacdn"/>`,
		"fallback": "streamline-emojis:glasses-2",
	});
}
