...
</style><g class="hntgybcog"><path class="nzpsuduik"/><path class="edg0x3nuq"/><path class="xsyfe-byx"/><path class="qfgxpvbvs"/><path class="ehef6tbzw"/></g>`,
		"fallback": "iconmind:attention-mask-outline-thin",
	});
}
