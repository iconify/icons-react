...
</style><g class="s0phu2bbs"><path class="h1mhbbbek"/><path class="g_sn6dbji"/><path class="oxrxwybca"/><path class="bg96ko_da"/><path class="z9p0k9q-r"/></g>`,
		"fallback": "iconmind:qos-outline-bold",
	});
}
