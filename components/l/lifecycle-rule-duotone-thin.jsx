...
</style><g class="hntgybcog"><path class="zrhfpjbsn"/><path class="n_mmwtwrp"/><path class="wh3qwbbqb"/><path class="cwmo4bc4s"/><path class="m5wi144di"/><path class="nk1txyodw"/><path class="o7fu1nbtq"/><path class="eus9a2f4d"/></g>`,
		"fallback": "iconmind:lifecycle-rule-duotone-thin",
	});
}
