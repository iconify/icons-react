...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="y6kdebcam"/><linearGradient id="SVG7HG7ud6F" x1="7.159" x2="457.488" y1="486.848" y2="36.519" gradientTransform="matrix(1 0 0 -1 0 514)" gradientUnits="userSpaceOnUse"><stop offset="0" class="ajve05jvp"/><stop offset=".064" class="jzqnxsibh"/><stop offset=".171" class="noss25brg"/><stop offset=".307" class="iixyjvb8y"/><stop offset=".465" class="ji0d7tbsj"/><stop offset=".567" class="shvnb2gfn"/><stop offset=".865" class="npd9_gltl"/><stop offset=".994" class="r0by-xb6c"/></linearGradient><path fill="url(#SVG7HG7ud6F)" class="uc66ndbxz"/>`,
		"fallback": "selfhst:homepage",
	});
}
