...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="rn051tbpi"/><path clip-rule="evenodd" class="lljequbmk"/><circle class="fuqlczbzs"/><g class="qj4npqwtq"><path clip-rule="evenodd" class="a37drjooo"/><path class="sn-weov4c"/></g><path class="gqq1qhs1i"/><path clip-rule="evenodd" class="tgmblfj6m"/><path class="f71e01bah"/><path clip-rule="evenodd" class="j0i6m9b-q"/><g class="z04drlb1l"><path class="kr0p7ac9r"/><path class="km_zi0b9r"/><path class="ik0ho9_ch"/></g>`,
		"fallback": "openmoji:firefox-developer",
	});
}
