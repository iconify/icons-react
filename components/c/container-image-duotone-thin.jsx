...
</style><g class="hntgybcog"><path class="j14g7qigh"/><path class="ta-02xxrq"/><path class="u07omib2v"/><path class="v1-fmxxhj"/><path class="y8im8ujjz"/><path class="azf2grb_w"/></g>`,
		"fallback": "iconmind:container-image-duotone-thin",
	});
}
