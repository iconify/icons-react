...
</style><g class="cuyn6tgcc"><path class="adtorrbbm"/><path class="vw-i6hb8g"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:angle-left-circle-off",
	});
}
