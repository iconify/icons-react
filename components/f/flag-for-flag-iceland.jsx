...
</style><path class="oh0y5ezvp"/><path class="x_e4y3b_i"/><path class="v75_3fwkw"/><path class="alo7wou8m"/><path class="ldduf345s"/>`,
		"fallback": "emojione-v1:flag-for-flag-iceland",
	});
}
