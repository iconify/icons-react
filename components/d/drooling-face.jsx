...
</style><path class="mcv_hbcsu"/><path class="m1ba5kbfu"/><path class="qifwdrb6p"/><path class="t8owr_b_o"/><path class="ur4vbqiim"/>`,
		"fallback": "noto-v1:drooling-face",
	});
}
