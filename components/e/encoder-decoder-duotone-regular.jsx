...
</style><g class="nrj6p8qat"><path class="siqrysbwb"/><path class="okcmurbzx"/><path class="pquf1ccxc"/><path class="qv4k8z3yq"/><path class="ajw5g_mzy"/></g>`,
		"fallback": "iconmind:encoder-decoder-duotone-regular",
	});
}
