...
</style><g class="nrj6p8qat"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="l4henmbwb"/><path class="wv-y1zfrk"/></g>`,
		"fallback": "iconmind:cluster-autoscaler-outline-regular",
	});
}
