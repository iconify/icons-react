...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="znl28j2op"/><path class="t1186ipnq"/><path class="ds1zjk7oo"/><path class="qlqrucbwh"/><path class="u3ssa0b3j"/><path class="l88wxbbuk"/><path class="af4vrlb7s"/><path class="tkqrfxbol"/><path class="kx6eqccwi"/><path class="z3wqvux_r"/>`,
		"fallback": "streamline-emojis:game-dice",
	});
}
