...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="umm606kxf"><path class="vi2iu3bye"/><path class="p0ol1ibxv"/><path class="c2xscmr7x"/><path class="rdkcglbxs"/><path class="epokxgdxy"/><path class="n8229fbep"/><path class="c38hj8m4i"/><path class="ywv68_bhz"/><path class="gl13dqbgs"/></g>`,
		"fallback": "streamline-stickies-color:filming-movie",
	});
}
