...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path class="ksftgvi8o"/><path class="nto1szbpo"/><path class="r2tsejtjj"/><path class="vrgkp6b-p"/><path class="makwdgb9t"/><path class="n8_82nb7h"/><path class="wa9mqbyjw"/><path class="nmj5cvb8z"/><path class="zw6slkb9c"/><path class="mp-jq_phq"/><path class="pwl_9dbdj"/></g>`,
		"fallback": "healthicons:qr-code",
	});
}
