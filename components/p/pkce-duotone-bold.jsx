...
</style><g class="s0phu2bbs"><path class="n7c_b1bsn"/><path class="s_z-4bu9m"/><path class="a218-cpca"/><path class="kcomyoe5y"/><path class="lhus_vb3v"/></g>`,
		"fallback": "iconmind:pkce-duotone-bold",
	});
}
