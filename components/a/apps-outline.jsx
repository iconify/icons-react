...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<rect class="didjmw4im"/><rect class="fj1bi7lzz"/><rect class="l93nljbqm"/><rect class="p_2l-y_6b"/><rect class="vsxzpib0o"/><rect class="o-p--zlby"/><rect class="fbn_o650w"/><rect class="yevjxeg7s"/><rect class="ute29oton"/>`,
		"fallback": "ion:apps-outline",
	});
}
