...
</style><g class="hntgybcog"><path class="dx3ubrb9h"/><path class="hbtmd5b0k"/><path class="or_n_9b8r"/><path class="zh6w8c3yc"/></g>`,
		"fallback": "iconmind:error-analysis-outline-thin",
	});
}
