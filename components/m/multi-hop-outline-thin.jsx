...
</style><g class="hntgybcog"><path class="zjs6ad-6z"/><path class="tdux9oy4s"/><path class="iwpbli9gm"/><path class="h57xi_b4m"/><path class="et81l2oxt"/></g>`,
		"fallback": "iconmind:multi-hop-outline-thin",
	});
}
