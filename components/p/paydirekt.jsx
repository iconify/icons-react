...
</style><path class="j98an1bqd"/><path class="ijzs-cbfw"/><circle class="zhhqkac-a"/><circle class="k556a5r6t"/><circle class="fdpxrx7_h"/><circle class="weeben4ob"/>`,
		"fallback": "arcticons:paydirekt",
	});
}
