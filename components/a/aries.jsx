...
.vt7wmbskt {
  ...
  cy: 32px;
  r: 30px;
  fill: var(--svg-color--d8544a, #d8544a);
}
</style><circle class="vt7wmbskt"/><path class="oelnqg-ph"/>`,
		"fallback": "emojione:aries",
	});
}
