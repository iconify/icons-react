...
</style><g class="nrj6p8qat"><path class="okud9xj_d"/><path class="ik93a37tn"/><path class="ync9d6bsc"/><path class="knng32dgc"/></g>`,
		"fallback": "iconmind:kube-secret-mount-outline-regular",
	});
}
