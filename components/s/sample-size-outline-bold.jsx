...
</style><g class="s0phu2bbs"><path class="viv5gg8xx"/><path class="tip34zbqw"/><path class="hv3ppsbji"/><path class="m0hvambgh"/><path class="a7vpafiwa"/><path class="n3p0zmbop"/></g>`,
		"fallback": "iconmind:sample-size-outline-bold",
	});
}
