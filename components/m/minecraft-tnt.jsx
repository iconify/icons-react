...
.yqdg3taaf {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M31.535 32.316v-4.297l2.912 2.631v-4.297M20.768 15.399l6.464-3.732m-6.484-.012l6.504 3.756");
}
</style><path class="jt3nzbkaa"/><path class="tjy1rabhv"/><path class="g1vv27uhj"/><path class="yqdg3taaf"/>`,
		"fallback": "arcticons:minecraft-tnt",
	});
}
