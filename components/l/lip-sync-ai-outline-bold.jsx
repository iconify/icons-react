...
</style><g class="s0phu2bbs"><path class="fp0jerb6p"/><path class="tqfrzx00u"/><path class="dwqtbeylw"/><path class="n2txk9b4m"/></g>`,
		"fallback": "iconmind:lip-sync-ai-outline-bold",
	});
}
