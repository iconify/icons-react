...
</style><g class="s0phu2bbs"><path class="jrpnc2pnl"/><path class="hiqcqfbaf"/><path class="qye2ovraz"/><path class="elmoo_bpw"/></g>`,
		"fallback": "iconmind:visual-diff-outline-bold",
	});
}
