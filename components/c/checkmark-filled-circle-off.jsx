...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="xr8jic2rx"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:checkmark-filled-circle-off",
	});
}
