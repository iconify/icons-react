...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="u9j1rqkok"/><path class="wtj0ngwad"/><path class="vmi9hybwc"/><circle class="k9-av-ajg"/><g class="to5_hpm1w"><path class="xbfh9wciz"/><circle class="qyeo-ltmv"/><path class="cvmxdqbew"/><path class="s8uuktobp"/></g>`,
		"fallback": "openmoji:hot-water-bottle",
	});
}
