...
</style><g class="hntgybcog"><path class="vo1-lv2pt"/><path class="oz3eccbug"/><path class="c4khiwgvb"/><path class="iq7hdacem"/><path class="gi1v2vyju"/></g>`,
		"fallback": "iconmind:etf-outline-thin",
	});
}
