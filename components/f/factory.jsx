...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ae849gbxa"><path class="h_yh9cbxe"/><path class="ld72s1b-f"/><path class="r46d0mb1s"/><path class="wufpt-b_b"/><path class="clcuiq-1j"/></g><g class="dcqdxh5zc"><path class="i0s3g0b3a"/><path class="xfn5rqbrl"/><path class="dgmmt-bic"/></g>`,
		"fallback": "openmoji:factory",
	});
}
