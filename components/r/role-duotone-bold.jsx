...
</style><g class="s0phu2bbs"><path class="kr5if0b2e"/><path class="y249ggb8a"/><path class="ppbx_abyw"/><path class="v-u0ijc7h"/><path class="kuxgvn7ri"/></g>`,
		"fallback": "iconmind:role-duotone-bold",
	});
}
