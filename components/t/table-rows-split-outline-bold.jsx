...
</style><g class="s0phu2bbs"><path class="n48w5yb-p"/><path class="x26a8iq1c"/><path class="wshbdfbhg"/><path class="s-gg8lbxh"/></g>`,
		"fallback": "iconmind:table-rows-split-outline-bold",
	});
}
