...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="enm7lobdg"/><path class="y2dyzwbxm"/><path class="jk6b_1b5n"/><path class="rpcu2eb_o"/><path class="gl4wu7gfm"/><path class="r4kl5ub6x"/><path class="yw9fk78yr"/><path class="cjan1r8hj"/><path class="j01tanbql"/><path class="m274zabew"/><path class="nqw9n8t6j"/><path class="md0lnzbhs"/>`,
		"fallback": "fxemoji:princess",
	});
}
