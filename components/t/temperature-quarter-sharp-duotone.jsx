...
</style><g class="gp_8x1bzb"><path class="rqh4y-aib"/><path class="fybusacbg"/><path class="k8te4qbon"/></g>`,
		"fallback": "keyline-icons:temperature-quarter-sharp-duotone",
	});
}
