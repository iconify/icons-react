...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="almky1j9k"/><path class="dbq485b4e"/><path class="ocif-h9bu"/><path class="s_f6m4b-b"/><path class="juu6lxbqs"/><path class="sl77u0bky"/><path class="k0yck8bya"/><path class="zk1t1geue"/><path class="obb2b4b8m"/><path class="u43ge0bpk"/><path class="uvrdfrv3g"/><path class="ahtjw4bef"/><path class="fnlu9hb9z"/>`,
		"fallback": "streamline-emojis:sleepy-face",
	});
}
