...
</style><path class="c4k59ubbf"/><path class="f7wmt7b7a"/><path class="msypc_bme"/><path class="ukynw26ne"/>`,
		"fallback": "vscode-icons:folder-type-cursor-opened",
	});
}
