...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="y5_xompqk"/><path class="gbuimde2x"/><path class="hx9jhfcwq"/><path class="pdv0sysfc"/><path class="jxxcfogxm"/><path class="phl73fpua"/><path class="vnvfio82l"/><path class="qia0tm_3b"/><path class="o741ygbfl"/><path class="eaqjuccml"/><path class="qdyx-4lnb"/>`,
		"fallback": "streamline-emojis:crocodile",
	});
}
