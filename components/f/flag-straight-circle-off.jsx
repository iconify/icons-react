...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="z_isvdb9s"/><path clip-rule="evenodd" class="n-j83ac6a"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:flag-straight-circle-off",
	});
}
