...
</style><g class="s0phu2bbs"><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="oqj-o0b2r"/><path class="miurf-h0g"/></g>`,
		"fallback": "iconmind:image-bloat-outline-bold",
	});
}
