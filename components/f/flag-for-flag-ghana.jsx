...
</style><path class="hxyghocib"/><path class="n8-91eb0z"/><path class="p5rts3bzh"/><path class="lzqp3jbyp"/>`,
		"fallback": "emojione-v1:flag-for-flag-ghana",
	});
}
