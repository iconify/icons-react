...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="j2gi4sbgz"/><path class="z2kaiubfz"/><path class="jdbwfib5v"/><path class="karpw4_lv"/><path class="d_02ilbrx"/><path class="gf9vqbb-r"/><path class="pzr7cw64u"/><path class="coeixwbwa"/><path class="fdfww4n-u"/><path class="vmii1jg-c"/><path class="xo4rdccie"/>`,
		"fallback": "streamline-emojis:writing-hand-2",
	});
}
