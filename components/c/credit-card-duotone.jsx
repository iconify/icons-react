...
.txk7dfbxr {
  d: path("M232 96v96a8 8 0 0 1-8 8H32a8 8 0 0 1-8-8V96Z");
  opacity: var(--svg-opacity--0-2, 0.2);
}
</style><g class="cuyn6tgcc"><path class="txk7dfbxr"/><path class="r5n8sobdl"/></g>`,
		"fallback": "ph:credit-card-duotone",
	});
}
