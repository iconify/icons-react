...
.ok19ndbjd {
  fill: currentColor;
  d: path("M9.37 5.51A7.4 7.4 0 0 0 9.1 7.5c0 4.08 3.32 7.4 7.4 7.4c.68 0 1.35-.09 1.99-.27A7.01 7.01 0 0 1 12 19c-3.86 0-7-3.14-7-7c0-2.93 1.81-5.45 4.37-6.49");
  opacity: var(--svg-opacity--0-3, 0.3);
}
</style><path class="ok19ndbjd"/><path class="ej6ruwiek"/>`,
		"fallback": "ic:twotone-dark-mode",
	});
}
