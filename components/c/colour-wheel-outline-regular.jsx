...
</style><g class="nrj6p8qat"><path class="o_ssmh9ez"/><path class="acyg6nb1v"/><path class="aymrypeyx"/><path class="sim8sii7h"/></g>`,
		"fallback": "iconmind:colour-wheel-outline-regular",
	});
}
