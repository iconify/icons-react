...
</style><g class="ft5dv1b6b"><defs><mask id="SVGbieogcNI"><path class="k5-vjlrin"/><path clip-rule="evenodd" class="vjobiob5y"/></mask></defs><circle mask="url(#SVGbieogcNI)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:hand-open-circle-filled",
	});
}
