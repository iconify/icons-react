...
</style><g class="hntgybcog"><path class="fa9joccbo"/><path class="dmqg6xbxr"/><path class="pwc0rzflc"/><path class="rhtl3vb5u"/><path class="hjz9frcqe"/></g>`,
		"fallback": "iconmind:lineage-table-outline-thin",
	});
}
