...
</style><g class="hntgybcog"><path class="jfvoq9bhn"/><path class="zdgvfxbbv"/><path class="slz7u0oyn"/><path class="uea_ybysx"/><path class="it83nbbll"/><path class="coh5p5slf"/></g>`,
		"fallback": "iconmind:change-log-table-outline-thin",
	});
}
