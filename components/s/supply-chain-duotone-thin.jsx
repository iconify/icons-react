...
</style><g class="hntgybcog"><path class="xmmrcy3kl"/><path class="mdbq_bc-v"/><path class="pf60fj32d"/><path class="g00uv-b-x"/><path class="koh8ckbdb"/><path class="k2mg4f2ls"/></g>`,
		"fallback": "iconmind:supply-chain-duotone-thin",
	});
}
