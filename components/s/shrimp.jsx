...
</style><path class="duo7qmypo"/><path class="k-1c8jbkn"/><path class="ell6s5bck"/><path class="bhzjyknfs"/><g class="hq2-vcghy"><path class="yhagnub6s"/><path class="oj350igkv"/></g>`,
		"fallback": "emojione:shrimp",
	});
}
