...
</style><g class="nrj6p8qat"><path class="yw3lpkbij"/><path class="ox_05kl4h"/><path class="moaogwbtx"/></g>`,
		"fallback": "keyline-icons:circle-bar-chart-2-down-two-tone",
	});
}
