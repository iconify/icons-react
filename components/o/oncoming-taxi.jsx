...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="hxacjozka"/><path class="t1r2aqims"/><path class="hux_ebo4x"/><rect class="yofyyhbac"/><path class="rxtzpqcuc"/><path class="f7m4pp5mx"/><path class="l8h_7njyz"/><rect class="xnlqgwwyp"/><rect class="fx2b8tbhl"/><rect class="hmz0x8tsw"/><rect class="o8w4n4bij"/><path class="t78m6z3fh"/><path class="k-aajnbxo"/>`,
		"fallback": "openmoji:oncoming-taxi",
	});
}
