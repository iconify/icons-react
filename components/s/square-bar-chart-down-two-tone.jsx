...
</style><g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="i5lvicvhn"/><path class="ha5537f-v"/></g>`,
		"fallback": "keyline-icons:square-bar-chart-down-two-tone",
	});
}
