...
</style><path class="qgmarabri"/><defs><path id="SVGj4RhqdHG" class="ym5hd8uxu"/></defs><clipPath id="SVGVvzxRcij"><use href="#SVGj4RhqdHG"/></clipPath><path clip-path="url(#SVGVvzxRcij)" class="mtfxi0b0a"/><path class="m9qq38euu"/><path class="pn7ejcbdj"/><path class="h3mqiybse"/><path class="p994exote"/><path class="dyl53bc0n"/><path class="irll21b2u"/><path class="p2haj7bfv"/><path class="m17szdbuz"/>`,
		"fallback": "logos:github-octocat",
	});
}
