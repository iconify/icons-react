...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="jl18hibwg"/><path class="cczkb59al"/><path class="bl0w-qb9y"/><path class="gbd3bpbxc"/><path class="hh5xn1iiv"/><path class="zdzqo99bn"/><path class="gc4xpp_ha"/><path class="kmr-zacvh"/><path class="q_-lxeb9s"/><g class="v4oj9cbzl"><path class="qtnfeibme"/><path class="mtvhovbvm"/></g><path class="a0l28o64q"/>`,
		"fallback": "flag:gr-4x3",
	});
}
