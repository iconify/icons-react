...
</style><g class="nrj6p8qat"><path class="qz_by4b2x"/><path class="gc9dmfy3u"/><path class="zzazs-rvi"/><path class="ll_i_4bra"/><path class="ud-rllqqn"/></g>`,
		"fallback": "iconmind:model-fork-outline-regular",
	});
}
