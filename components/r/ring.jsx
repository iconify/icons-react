...
.mvuchqb2d {
  ...
  d: path("M30.38 45.83a39.9 39.9 0 0 0-18.6 15.52m33.55-18.43c-2.63 0-5.21.26-7.7.75");
}

.nbccsacyh {
  fill: var(--svg-color--0288d1, #0288d1);
  d: path("m122.64 52.91l3.58-17.45l-11.51.76z");
}

.o9zkktvro {
  fill: var(--svg-color--b3e5fc, #b3e5fc);
  d: path("m75.33 52.67l47.31.24l-23.97-7.85z");
}

.oo4xh-bby {
  fill: var(--svg-color--eee, #eee);
  d: path("M1521.1 50.53c-.01-2.6-.17-5.16-.47-7.62c-2-16.35-11.24-30.55-24.12-37.07c-6.06-3.06-12.39-4.29-18.93-3.66c-12.49 1.25-25.33 8.45-32.73 20.82c-17.74 29.67-6.38 65.56-3.38 71.66c15.34 31.17 40.12 33.83 52.62 32.82c13.58-1.1 29.43-6.61 31.69-12.81c.53-1.47.46-3.06-.2-4.48c-1.3-2.75-3.95-2.49-4.82-2.41l-.99.11l-.26.01c-3.78-.05-5.44-1.02-6.59-3.81c-1.75-4.27-.31-10.54 1.15-15.52c3-10.23 7.11-24.25 7.03-38.04m-151.31 58.7c2.59-13.72 4.41-27.8 4.7-41.75c.25-12.21 1.22-24.62 5.55-36.04s12.44-21.87 23.68-26.66c4.59-1.96 9.56-2.79 14.53-2.63v116.37c-1.92.03-3.83.36-5.63 1.09c-4.62 1.87-8.32 4.16-13.28 4.54c-4.87.37-9.15-3.17-13.94-4.11c-2.9-.57-5.98-.14-8.61 1.19c-1.74.88-3.28 2.14-5.07 2.9s-4.04.94-5.56-.27c1.35-4.83 2.69-9.69 3.63-14.63");
}

.p-5dzsb5o {
  fill: var(--svg-color--81d4fa, #81d4fa);
  d: path("M82.94 29.33L75.09 5.36l16.69 7.93z");
}

.p5_txqbtd {
  fill: var(--svg-color--2f2f2f, #2f2f2f);
  d: path("M1798.56 45.01c1.74-.29 3.59-.51 5.37-.34c1.81.19 3.58 1 5.45.76c1.22-.15 2.53-.95 3.24-1.86c1.51-1.92 1.66-4.42.82-6.6a7.9 7.9 0 0 0-3.25-3.87c-3.71-2.25-9.03-.83-12.15 1.91c-3.2 2.8-5.53 7.56-4.02 9.65c.9 1.26 3.44.52 4.54.35m-21.66 0c-1.74-.29-3.59-.51-5.37-.34c-1.81.19-3.58 1-5.45.76c-1.22-.15-2.53-.95-3.24-1.86c-1.51-1.92-1.66-4.42-.82-6.6a7.9 7.9 0 0 1 3.25-3.87c3.71-2.25 9.03-.83 12.15 1.91c3.2 2.8 5.53 7.56 4.02 9.65c-.9 1.26-3.44.52-4.54.35m22.11 5.52c-4.56.41-6.36 3.04-12.06 3.04v14.68c6.12 0 12.43-3.48 15.53-7.35c3.5-4.36 3.34-10.97-3.47-10.37m-24.12 0c4.56.41 6.36 3.04 12.06 3.04v14.68c-6.12 0-12.43-3.48-15.53-7.35c-3.49-4.36-3.33-10.97 3.47-10.37");
}

.pnyjew-wp {
  fill: var(--svg-color--bdbdbd, #bdbdbd);
  d: path("m76.27 51.73l-1.05-20.59s-1.43.13-2.08 2.86c-.61 2.56-2.16 15.05-2.16 15.05l4.26 3.71z");
}

.qt1krkbjx {
  fill: var(--svg-color--64b5f6, #64b5f6);
  d: path("m100.8 27.2l-9.02-13.91l-8.84 16.04z");
}

.v9i7eeb-d {
  d: path("M1677.44 43.69c2.18-.37 4.52-.65 6.75-.42c2.28.24 4.5 1.26 6.85.96c1.53-.19 3.18-1.19 4.08-2.33c1.9-2.41 2.09-5.55 1.03-8.3c-.77-1.97-2.18-3.73-4.09-4.87c-4.67-2.83-11.35-1.04-15.27 2.4c-4.02 3.53-6.96 9.51-5.06 12.13c1.14 1.58 4.33.65 5.71.43m-27.22 0c-2.18-.37-4.52-.65-6.75-.42c-2.28.24-4.5 1.26-6.85.96c-1.53-.19-3.18-1.19-4.08-2.33c-1.9-2.41-2.09-5.55-1.03-8.3c.77-1.97 2.18-3.73 4.09-4.87c4.67-2.83 11.35-1.04 15.27 2.4c4.02 3.53 6.96 9.51 5.06 12.13c-1.14 1.58-4.33.65-5.71.43m27.79 6.95c-5.73.51-8.92 4.97-15.16 4.97v17.31c7.7 0 15.63-4.38 19.52-9.24c4.4-5.49 4.2-13.8-4.36-13.04");
}

.w70g95b7f {
  fill: var(--svg-color--e1f5fe, #e1f5fe);
  d: path("m98.67 45.06l-23.34 7.61l7.61-23.34z");
}

.wkc9libcb {
  fill: var(--svg-color--fff, #fff);
  d: path("M1341.43 88.37c-4.51 3.56-10.12 5.12-15.36 7.26c-5.81 2.38-11.47 4.88-17.46 6.8c-6.45 2.08-12.95 4.04-19.37 6.21c-9.43 3.18-19.51 4.99-29.46 4.68c-5.51-.17-10.98-.98-16.38-2.14c-3.43-.74-6.9-1.99-9.64-4.24c-1.79-1.47-3.32-3.46-4-5.69c-.34-1.14-.4-2.32-.17-3.48c.44-2.26 1.56-1.72 2.51-.14c1.15 1.92 2.86 3.15 4.75 4.27c2.09 1.22 4.36 2.09 6.68 2.76c1.73.51 3.5.9 5.28 1.22c5.99 1.08 12.1.95 18.14.39c11.36-1.05 22.24-4.78 32.74-9.04c3.17-1.28 6.3-2.62 9.45-3.96c5.42-2.31 10.74-4.83 16.12-7.25c4.97-2.24 10.37-3.85 15.14-6.48c.62-.34 1.18-.99 1.67-.33c.65.86.22 3.49.18 4.69v.14c0 1.31.34 3.42-.82 4.33");
}

.y__vajbal {
  fill: var(--svg-color--e1f5fe, #e1f5fe);
  d: path("m100.8 27.2l13.91 9.02l-16.04 8.84z");
}

.y_635obni {
  fill: var(--svg-color--1e88e5, #1e88e5);
  d: path("m75.33 52.67l-.24-47.31l7.85 23.97z");
}
</style><path class="akp5meilr"/><path class="arqwvacdj"/><path class="lnmul0o2v"/><g class="ehej3-bmx"><path class="v9i7eeb-d"/><path class="m-mmdxitw"/></g><path class="p5_txqbtd"/><path class="kz0cbv3ut"/><path class="bf27uxmif"/><path class="oo4xh-bby"/><path class="m7d-ehg4r"/><path class="i6nwpjbhn"/><path class="bgeg8bb7s"/><path class="e_is_vb-u"/><path class="wkc9libcb"/><path class="cled55bgx"/><path class="mvuchqb2d"/><path class="dglqgkbvz"/><path class="c0qx-b-5z"/><path class="p-5dzsb5o"/><path class="qt1krkbjx"/><path class="nbccsacyh"/><path class="abfxywbpz"/><path class="y__vajbal"/><path class="ec-wdobjy"/><path class="ad_a04rbg"/><path class="y_635obni"/><path class="o9zkktvro"/><path class="w70g95b7f"/><path class="hgjl2db_q"/><path class="cfyyamq8n"/><path class="pnyjew-wp"/>`,
		"fallback": "noto-v1:ring",
	});
}
