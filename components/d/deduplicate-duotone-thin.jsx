...
</style><g class="hntgybcog"><path class="wbetb-bqz"/><path class="hqz06wx0a"/><path class="lycull7vp"/><path class="e5cr-sbks"/></g>`,
		"fallback": "iconmind:deduplicate-duotone-thin",
	});
}
