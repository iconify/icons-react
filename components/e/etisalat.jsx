...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<defs><clipPath id="SVGVuw56c3z" clipPathUnits="userSpaceOnUse"><path class="mq-s6_k8h"/></clipPath></defs><g clip-path="url(#SVGVuw56c3z)" transform="matrix(1.25 0 0 -1.25 -606.563 1019.8)"><path class="pn0mpqb7o"/><path class="qkknwzg5f"/><path class="afnhwvbml"/><path class="cih3tm64b"/><path class="l39leo64h"/><path class="ohyomgxoa"/></g>`,
		"fallback": "thesvg-color:etisalat",
	});
}
