...
</style><g class="nrj6p8qat"><path class="sqwju3bsh"/><path class="du3agkbjb"/><path class="fquh7rbnp"/><path class="stuivn6rm"/><path class="w3y_atbbp"/></g>`,
		"fallback": "iconmind:ride-share-outline-regular",
	});
}
