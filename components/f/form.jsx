...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ft5dv1b6b"><rect class="zu_deu4_z"/><path clip-rule="evenodd" class="zduf8wb2t"/><path class="nwp2-7bok"/><path clip-rule="evenodd" class="hf_cjtbhq"/><path class="x4c7ywban"/><path clip-rule="evenodd" class="czzmpj-0h"/><path class="uugt7l2vg"/><path clip-rule="evenodd" class="hso07ebiz"/><path class="ieugtgy_a"/><path clip-rule="evenodd" class="ffi0gl6-p"/><path class="levvisiyu"/><path clip-rule="evenodd" class="lxzaqtbfn"/><path class="fo9h3fbil"/></g>`,
		"fallback": "icon-park-outline:form",
	});
}
