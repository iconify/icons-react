...
</style><path class="e85ncgbbi"/><path class="vbxe0xtoi"/><path class="m34tzdyvu"/><path class="p4n42sbjb"/><circle class="bfw895bdy"/><path class="pwz_r9b1r"/><path class="ibxyp27ik"/><path class="cezq7acdg"/>`,
		"fallback": "twemoji:flag-argentina",
	});
}
