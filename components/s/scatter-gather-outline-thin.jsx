...
</style><g class="hntgybcog"><path class="zuquf0b8s"/><path class="fcstqn4mf"/><path class="b7emas-0s"/><path class="qgv_f1esc"/></g>`,
		"fallback": "iconmind:scatter-gather-outline-thin",
	});
}
