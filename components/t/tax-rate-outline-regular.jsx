...
</style><g class="nrj6p8qat"><path class="jd_dotbnq"/><path class="kq98nmbqp"/><path class="pm5zs9u8l"/><path class="y4a8ig_7t"/></g>`,
		"fallback": "iconmind:tax-rate-outline-regular",
	});
}
