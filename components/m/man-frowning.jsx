...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="yj-n85ffv"/><path class="uiico6v5s"/><path class="wu5jmy22e"/><path class="iyfihfbby"/><path class="uqdu66o3d"/><path class="bswg7-4lf"/><path class="m0a2dvb6x"/><path class="cxy6m0boi"/>`,
		"fallback": "openmoji:man-frowning",
	});
}
