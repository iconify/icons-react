...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="oxiqij2so"/><path class="hctuqi6df"/><path class="ghbwb443t"/><path class="umu3b5bii"/><path class="i0kh6nb5l"/><path class="x0496cm5b"/><path class="cmisr-b0t"/><path class="wjtxzkb0a"/><path class="znhal3b0h"/><path class="oov513btg"/><path class="h2dso6bcq"/><path class="pr25ocopu"/>`,
		"fallback": "streamline-emojis:bell-with-slash",
	});
}
