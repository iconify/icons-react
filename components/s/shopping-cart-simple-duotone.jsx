...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.a6m3no42x {
  d: path("m232 72l-25.63 92.28A16 16 0 0 1 191 176H92.16a16 16 0 0 1-15.41-11.72L51.11 72Z");
...
</style><g class="cuyn6tgcc"><path class="a6m3no42x"/><path class="wp--p_bah"/></g>`,
		"fallback": "ph:shopping-cart-simple-duotone",
	});
}
