...
</style><g class="hntgybcog"><path class="b-fhdniix"/><path class="eoa7zubuy"/><path class="kut6h2oks"/><path class="mtc590bck"/><path class="ceatt7y_b"/></g>`,
		"fallback": "iconmind:secret-leak-outline-thin",
	});
}
