...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="p8f5tl6jz"/><path class="e568wybne"/><path class="iq9nxyvhz"/><path class="bpcj3b8rg"/><path class="kdkjsdbjr"/><path class="nt_3igl7z"/><path class="uisz24b9i"/><path class="is3w311ky"/><path class="w7m2f1f1z"/><path class="cvmuodbxy"/>`,
		"fallback": "openmoji:deaf-woman-dark-skin-tone",
	});
}
