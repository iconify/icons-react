...
.snlqakb_k {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("m12.389 11.363l-1.634 1.995l.842 2.62l3.003.54l1.793-2.104");
}
</style><circle class="cpk0fnbgt"/><path class="a_m2c6btx"/><path class="snlqakb_k"/>`,
		"fallback": "arcticons:contactstoolkit",
	});
}
