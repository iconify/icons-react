...
</style><g class="hntgybcog"><path class="sqmravmye"/><path class="hbdbg_bcy"/><path class="lyjarcbwz"/><path class="cspceacnq"/><path class="doxmgbcyh"/></g>`,
		"fallback": "iconmind:semantic-duotone-thin",
	});
}
