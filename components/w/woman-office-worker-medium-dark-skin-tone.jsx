...
</style><path class="lilgt_v7n"/><path class="v14rkgb-e"/><path class="hus4d3gtc"/><path class="lyyspibig"/><path class="xn8b1hbpi"/><path class="nighzlb7s"/><path class="imxoxcbeq"/><path class="evfk0db6z"/><path class="trm47jbwf"/><path class="edmiq0w2m"/><path class="n1aueobzi"/><path class="tmki56pov"/><path class="lbypczb4x"/><path class="aoidqwb_m"/><path class="dtzfa4fkn"/><path class="d8slpbc8t"/>`,
		"fallback": "twemoji:woman-office-worker-medium-dark-skin-tone",
	});
}
