...
</style><g class="hntgybcog"><path class="v1p3s7bgt"/><path class="dvdaq001f"/><path class="e5z2csb_e"/><path class="zl16vzbgk"/><path class="y6b-2ywbl"/><path class="clpojkoko"/></g>`,
		"fallback": "iconmind:flamegraph-duotone-thin",
	});
}
