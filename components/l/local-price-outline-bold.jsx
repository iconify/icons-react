...
</style><g class="s0phu2bbs"><path class="pywr_yykw"/><path class="m0hvambgh"/><path class="zohykibek"/><path class="kl5egs07h"/></g>`,
		"fallback": "iconmind:local-price-outline-bold",
	});
}
