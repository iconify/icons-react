...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="wddso9fzw"/><path class="dkghol79r"/><path class="mysmt_bix"/><path class="kg9stkl6v"/><path class="c83p2dbqh"/><path class="tpqw742pr"/><path class="puovqsbqe"/><path class="gric1hicz"/><path class="pjhu3gbol"/><path class="nlc7kbc0v"/><path class="gtnjkhbvu"/><path class="j-mf60-7d"/><path class="j1d3zubbk"/><path class="pq_9pbcaq"/><path class="ptmjoubsm"/><path class="gyg7q313g"/>`,
		"fallback": "openmoji:woman-supervillain-medium-dark-skin-tone",
	});
}
