...
</style><g class="nrj6p8qat"><path class="keqc2pbxm"/><path class="ph-bhccoq"/><path class="igam7_b3d"/><path class="hlqoyz1hh"/></g>`,
		"fallback": "iconmind:people-group-outline-regular",
	});
}
