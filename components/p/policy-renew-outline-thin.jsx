...
</style><g class="hntgybcog"><path class="y4_6s7b5v"/><path class="wuvisubmw"/><path class="ajw5g_mzy"/><path class="pz3wsjbwy"/></g>`,
		"fallback": "iconmind:policy-renew-outline-thin",
	});
}
