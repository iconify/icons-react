...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.cfziknqsa {
  fill: none;
  stroke: currentColor;
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M32.38 29.25A17 17 0 0 0 24 27.31a17 17 0 0 0-8.38 1.94m0-14.25A17 17 0 0 0 24 17a17 17 0 0 0 8.38-2");
}
...
</style><path class="g-8g8_b-y"/><circle class="uk-8h_hlj"/><path class="cfziknqsa"/><ellipse class="czdyafgvs"/><path class="jiysjjbfw"/>`,
		"fallback": "arcticons:dnsfilter",
	});
}
