...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<ellipse class="p1o9_5b1f"/><ellipse class="q4_jiabge"/><path class="qg4jwebgh"/><path class="d9j05mb-b"/><path class="wdv1_e5jp"/><path class="x6e9icbov"/><path class="z-j6sfb_x"/><g class="x8poo_bjf"><path class="z82y8_ccv"/><ellipse class="sk86tzbrp"/><path class="jm_jscbmv"/><path class="fpflvybck"/><path class="c89x67bly"/><path class="ng-9v7brm"/></g>`,
		"fallback": "openmoji:motorcycle",
	});
}
