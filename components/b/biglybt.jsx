...
</style><path class="rc9e0ac8z"/><circle class="jlfa6jbpo"/><circle class="fk-0mtb1s"/><path class="fglakrbkp"/><path class="r-g_-cbjs"/>`,
		"fallback": "arcticons:biglybt",
	});
}
