...
</style><g class="nrj6p8qat"><path class="zrr506boc"/><path class="rvbcncc6z"/><path class="htj7d_25n"/><path class="wr_ld5s1h"/><path class="k5psmhbss"/></g>`,
		"fallback": "iconmind:ungroup-duotone-regular",
	});
}
