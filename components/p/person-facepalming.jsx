...
</style><path class="xq2yr6dif"/><path class="b__xj1bdq"/><path class="ajxgcybdc"/><ellipse class="e_lq7ccni"/><path class="kc1ole-jg"/><path class="xux9dyblw"/><path class="v3349f6jz"/><path class="ytknhqb6w"/><path class="ytaft7bol"/><path class="y2wl4gbnt"/><path class="zo5-9mdnb"/><g class="az_6riylm"><path class="l8wngdepz"/><path class="a84t9pber"/></g><path class="cgj2nvdah"/><defs><path id="SVGudEVS6BX" class="zo56_0bpy"/></defs><use href="#SVGudEVS6BX" class="u46is_brm"/>`,
		"fallback": "noto-v1:person-facepalming",
	});
}
