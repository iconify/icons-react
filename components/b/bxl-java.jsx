...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="gjr34e1qi"/><path class="eaqx1m-bn"/><path class="ks6aw7bxz"/><path class="knf9nqbjp"/><path class="c0b58zj3s"/><path class="uvo7drb9g"/><path class="tzm-1ebaz"/><path class="l8puabb1y"/>`,
		"fallback": "bx:bxl-java",
	});
}
