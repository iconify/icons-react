...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.bin13jbhb {
  d: path("M104 164a36 36 0 1 1-36-36a36 36 0 0 1 36 36m84-36a36 36 0 1 0 36 36a36 36 0 0 0-36-36");
...
</style><g class="cuyn6tgcc"><path class="bin13jbhb"/><path class="z1w0cebfw"/></g>`,
		"fallback": "ph:eyeglasses-duotone",
	});
}
