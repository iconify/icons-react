...
.h-h5b9dfo {
  ...
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M24 22.25v-9.09m-1.5 12.89l-6.55 6.56");
}
...
</style><circle class="tsa4-2-ul"/><path class="h-h5b9dfo"/><circle class="fd85t5b_y"/><path class="eq9z-9bbu"/>`,
		"fallback": "arcticons:amdroid",
	});
}
