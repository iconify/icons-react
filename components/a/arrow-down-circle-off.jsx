...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="dht1embev"/><path clip-rule="evenodd" class="ccm1qksvr"/><path clip-rule="evenodd" class="dnowwob-k"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:arrow-down-circle-off",
	});
}
