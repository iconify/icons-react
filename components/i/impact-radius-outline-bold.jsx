...
</style><g class="s0phu2bbs"><path class="iaozfqbuj"/><path class="n3p0zmbop"/><path class="n8nvttn9v"/><path class="w3wwgzpqd"/></g>`,
		"fallback": "iconmind:impact-radius-outline-bold",
	});
}
