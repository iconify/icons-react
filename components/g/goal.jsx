...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<defs><path id="SVGmzXNO21H" class="s5p0wubvd"/></defs><circle class="v230kntxc"/><circle class="s0ipvyb2o"/><path class="td_8ombsx"/><path clip-rule="evenodd" class="uf1a92b4r"/><path class="dw8wazx1r"/><path clip-rule="evenodd" class="j-pmiab7w"/><use href="#SVGmzXNO21H" clip-rule="evenodd" class="d2kvgvbvc"/><path clip-rule="evenodd" class="yzav82jaa"/><use href="#SVGmzXNO21H" clip-rule="evenodd" class="d2kvgvbvc"/><path class="shzx9ib5h"/><path class="tcfbe2eti"/>`,
		"fallback": "flat-ui:goal",
	});
}
