...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<defs><linearGradient id="SVGEA8ikeAY" x1="22.034" x2="17.118" y1="9.773" y2="14.842" gradientTransform="translate(1.136 -13.247)scale(3.90869)" gradientUnits="userSpaceOnUse"><stop offset=".176" class="sav6x4bmf"/><stop offset="1" class="g_gp7lgqe"/></linearGradient><linearGradient id="SVGAArkrb3e" x1="16.641" x2="10.957" y1="15.564" y2="21.094" gradientTransform="translate(1.136 -13.247)scale(3.90869)" gradientUnits="userSpaceOnUse"><stop offset=".176" class="sav6x4bmf"/><stop offset="1" class="g_gp7lgqe"/></linearGradient></defs><path class="msrio9b7d"/><path fill="url(#SVGEA8ikeAY)" class="zev6kv9bt"/><path fill="url(#SVGAArkrb3e)" class="moekc8fww"/><path class="tnwkr8b1s"/>`,
		"fallback": "devicon:jira-wordmark",
	});
}
