...
</style><g class="hntgybcog"><path class="f965_vb7r"/><path class="pq9ly31-r"/><path class="ib0uz7xmw"/><path class="zuquf0b8s"/><path class="fcstqn4mf"/></g>`,
		"fallback": "iconmind:star-schema-outline-thin",
	});
}
