...
</style><g class="hntgybcog"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="c_vx4nbon"/><path class="t04j2mb6v"/></g>`,
		"fallback": "iconmind:fleet-cluster-outline-thin",
	});
}
