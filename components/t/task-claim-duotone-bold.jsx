...
</style><g class="s0phu2bbs"><path class="d43w9ob6g"/><path class="skbifdbcx"/><path class="xprtucb6d"/><path class="z8dv2-h-v"/></g>`,
		"fallback": "iconmind:task-claim-duotone-bold",
	});
}
