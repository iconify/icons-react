...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="lq320zf_x"/><path class="t9j2repmk"/><path class="c9-klwxag"/><path class="tey_ov27w"/><path class="h2-6m2w-z"/><path class="skn-k9yba"/><path class="bw4xunb6i"/><path class="ao8w-3b5l"/><path class="f6xagccdm"/>`,
		"fallback": "ion:ios-finger-print",
	});
}
