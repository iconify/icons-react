...
</style><g class="nrj6p8qat"><path class="r63fawbfm"/><path class="h-3eqtbix"/><path class="unky6y77u"/></g>`,
		"fallback": "keyline-icons:app-window-minus-duotone",
	});
}
