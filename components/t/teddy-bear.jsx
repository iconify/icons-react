...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="od-kebojv"/><path class="w1usx9wox"/><path class="od4_0bxsi"/><path class="wx3pult5d"/><path class="rb4ewebvj"/><path class="y89a3hbvr"/><path class="g4o-8hbkx"/><path class="u9yh_jb_g"/><path class="uzs1o5buo"/><path class="vi3y68brs"/><path class="vgn8j_1tq"/><path class="r1nr39ark"/>`,
		"fallback": "openmoji:teddy-bear",
	});
}
