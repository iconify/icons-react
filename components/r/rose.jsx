...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="bc05y7byk"/><path class="lfv0dpbac"/><path class="cqy64qb2c"/><path class="gwr12-lnr"/><path class="lcqbjjb_b"/><path class="kvb2hobqr"/><path class="pg8tri08o"/><path class="jqz0l7bct"/><g class="jn8qy4bru"><path class="czifj6bwv"/><path class="r6_341jec"/><path class="x9dk8ccls"/></g>`,
		"fallback": "openmoji:rose",
	});
}
