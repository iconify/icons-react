...
</style><g class="s0phu2bbs"><path class="j7zm7nyun"/><path class="p_1t9wune"/><path class="a3b7rvb1p"/><path class="ltriwmbuu"/><path class="u0hfy7bsd"/></g>`,
		"fallback": "iconmind:private-favorites-duotone-bold",
	});
}
