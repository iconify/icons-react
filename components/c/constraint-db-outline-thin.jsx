...
</style><g class="hntgybcog"><path class="hemk1tbpo"/><path class="g4lz7ob4p"/><path class="y5y9-x5ge"/><path class="ajxlkdb4q"/></g>`,
		"fallback": "iconmind:constraint-db-outline-thin",
	});
}
