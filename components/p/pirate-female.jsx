...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="eiklb5bft"/><path class="p2ptgwmyo"/><path class="vg4u1tbxy"/><path class="t-r5kc3vi"/><path class="s7vsdmb4w"/><path class="bfeqj77tf"/><path class="dgzie2vss"/><path class="hr0z8jzso"/><path class="qlxs49bht"/><path class="qjslbsb_g"/><path class="w7lmrabou"/><path class="eyw7cbc_p"/><path class="dr040bknr"/><path class="q1w0enbok"/>`,
		"fallback": "openmoji:pirate-female",
	});
}
