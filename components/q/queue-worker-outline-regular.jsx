...
</style><g class="nrj6p8qat"><path class="dfcdzc65k"/><path class="spper1bzy"/><path class="fevuzkbbx"/><path class="tl2fjsrpp"/><path class="r46fmvbqs"/></g>`,
		"fallback": "iconmind:queue-worker-outline-regular",
	});
}
