...
</style><path class="vl1n9jbct"/><path class="vuzkeij-u"/><path class="rx9n9u1rd"/><path class="w7mt37bfq"/><path class="btwmgtb1r"/><path class="ums4zgbdw"/>`,
		"fallback": "emojione:hammer-and-pick",
	});
}
