...
</style><g class="ft5dv1b6b"><defs><mask id="SVGKs5vXIss"><path class="k5-vjlrin"/><path clip-rule="evenodd" class="hx57ubbfk"/></mask></defs><circle mask="url(#SVGKs5vXIss)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:bookmark-circle-filled",
	});
}
