...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="a7lgu_bae"/><path class="ffshr2bmr"/><path class="eg0obsd6y"/><path class="ysa52ub7p"/><path class="q6x6qabvt"/><path class="gpmwy-bmr"/><path class="zdhaa4bew"/><path class="r3zq_9bdi"/><path class="ke6te4biu"/>`,
		"fallback": "fxemoji:wedding",
	});
}
