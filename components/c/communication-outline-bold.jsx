...
</style><g class="s0phu2bbs"><path class="y-c_3vbcr"/><path class="grk37x-os"/><path class="f9zkr6_8j"/><path class="kscrclbnc"/></g>`,
		"fallback": "iconmind:communication-outline-bold",
	});
}
