...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="gx0dbj1_t"/><path class="g5ofsz1wb"/><path class="ttn0nflmq"/><path class="pi3rnhqpy"/><path class="kqhlo7vwc"/><path class="x0hndkqdu"/><path class="x9hpz0byk"/><path class="x_09k3byu"/><path class="kmhbf6b9g"/>`,
		"fallback": "fxemoji:potoffood",
	});
}
