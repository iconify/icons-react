...
</style><g clip-rule="evenodd" class="n1lsf0bnc"><path class="bw1pvkb1e"/><path class="slorjqbuy"/><path class="rd9culn5u"/></g>`,
		"fallback": "pepicons-pop:lock-closed",
	});
}
