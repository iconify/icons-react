...
</style><g class="ft5dv1b6b"><g clip-path="url(#SVGHcSWxdhd)"><path class="om-y_pbvv"/><path class="m_jo28vao"/></g><defs><clipPath id="SVGHcSWxdhd"><path class="py7ktqbvf"/></clipPath></defs></g>`,
		"fallback": "token-branded:nxt-background",
	});
}
