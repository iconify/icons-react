...
</style><g class="s0phu2bbs"><path class="lu1q1nb0a"/><path class="zirb-hbnv"/><path class="y_b-hlbjs"/><path class="nke_cgbmx"/></g>`,
		"fallback": "iconmind:dedupe-window-outline-bold",
	});
}
