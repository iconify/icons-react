...
</style><path class="lilgt_v7n"/><path class="v14rkgb-e"/><path class="hus4d3gtc"/><path class="lyyspibig"/><path class="xn8b1hbpi"/><path class="nighzlb7s"/><path class="imxoxcbeq"/><path class="w4va03bqv"/><path class="orn2i4b4s"/><path class="x6nzphb3w"/><path class="pu3q4nb4a"/><path class="tmki56pov"/><path class="kcz03n36z"/><path class="aoidqwb_m"/><path class="o28i77v_p"/><path class="s1r74kbwq"/>`,
		"fallback": "twemoji:woman-office-worker-light-skin-tone",
	});
}
