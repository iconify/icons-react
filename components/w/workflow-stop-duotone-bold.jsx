...
</style><g class="s0phu2bbs"><path class="r8kprgqqs"/><path class="d8og-sfns"/><path class="f21or-k3k"/><path class="gujomac1p"/><path class="d2pmuibhx"/></g>`,
		"fallback": "iconmind:workflow-stop-duotone-bold",
	});
}
