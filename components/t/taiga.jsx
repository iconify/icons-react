...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="xb3f2j55h"/><path class="noe9hiqgk"/><path class="apu5y4tyo"/><path class="mevuwlowl"/><path class="dwoj5bsjh"/><path class="llp-wub4l"/><path class="fjozvrjsf"/><path class="hfqfnls-v"/><path class="ojg9upbpn"/>`,
		"fallback": "selfhst:taiga",
	});
}
