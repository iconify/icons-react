...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="ptmz_cbiu"/><path clip-rule="evenodd" class="m6y0inb2y"/><path class="dv7e1wf3g"/><path clip-rule="evenodd" class="qci9-xbfy"/><path class="xedf9ccsf"/></g>`,
		"fallback": "pepicons-pop:hourglass-off",
	});
}
