...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ubtt0-b3g"/><path class="du55hrmeb"/><path class="vt00uqbmj"/><path class="b1hs--7gh"/><path class="t-dv3dbyc"/><g class="to5_hpm1w"><path class="kdj4d0wwt"/><path class="gfbc12aky"/><path class="zj9lv8b2i"/><path class="md07lkssk"/><path class="tfxtefb8p"/></g>`,
		"fallback": "openmoji:toolbox",
	});
}
