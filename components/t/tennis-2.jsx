...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="w3bxgtpkh"/><path class="zyxli4b-u"/><path class="ugclvgbnt"/><path class="rlqvp4bbw"/><path class="d_qd_acsh"/><path class="g64732bny"/><path class="wn_rrxntm"/><path class="b8thn_byl"/><path class="v0j3y9bak"/><path class="sfnxqqbts"/><path class="n_spm6bkq"/><path class="cmy8ohbis"/><path class="h8u5pzn6q"/><path class="s9lar-bjc"/>`,
		"fallback": "streamline-emojis:tennis-2",
	});
}
