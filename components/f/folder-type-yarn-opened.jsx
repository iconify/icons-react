...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.iicx13b3r {
  fill: var(--svg-color--7abddc, #7abddc);
...
</style><path class="iicx13b3r"/><path class="oqiqno76k"/><path class="n3wxoacoi"/>`,
		"fallback": "vscode-icons:folder-type-yarn-opened",
	});
}
