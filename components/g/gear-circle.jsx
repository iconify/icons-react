...
</style><g clip-rule="evenodd" class="n1lsf0bnc"><path class="e7j_bac0y"/><path class="c_29xg85m"/><path class="hvy6dhsgw"/><path class="yo6u3qdpx"/><path class="beald-bpf"/><path class="ds1wwcb6g"/><path class="xc2uuebwp"/><path class="fkrd__5kj"/><path class="ohcwhxbmk"/><path class="i3nmseojk"/><path class="rvqxv0trm"/><path class="as2l66jmd"/><path class="pnlznccnf"/><path class="vzs6pmbra"/><path class="v3zzoj81i"/><path class="vt1yfcbhl"/><path class="hdxpysbbn"/></g>`,
		"fallback": "pepicons-pop:gear-circle",
	});
}
