...
</style><path class="bsrxtp84l"/><path class="otmfxl_fp"/><path class="zxwe9rbjf"/><path class="nfqgfdcwm"/><path class="xmtv4sbmz"/><linearGradient id="SVGDG7eAefe" x1="63.983" x2="63.983" y1="9.647" y2="23.14" gradientUnits="userSpaceOnUse"><stop offset=".181" class="zhpn9ibhz"/><stop offset="1" class="akxgx7b6i"/></linearGradient><path fill="url(#SVGDG7eAefe)" class="y_901zbnl"/>`,
		"fallback": "noto:womans-clothes",
	});
}
