...
</style><g class="s0phu2bbs"><path class="fmr2g_bno"/><path class="aff9hemvj"/><path class="mz4c5lb-h"/><path class="osjmvib6z"/><path class="tdux9oy4s"/></g>`,
		"fallback": "iconmind:token-price-outline-bold",
	});
}
