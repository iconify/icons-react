...
</style><g class="hntgybcog"><path class="tfnum6bjl"/><path class="z55just5o"/><path class="b4373m80b"/><path class="ryzx2-jfe"/></g>`,
		"fallback": "iconmind:subquestion-outline-thin",
	});
}
