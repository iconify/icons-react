...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ft5dv1b6b"><path class="hpcowpb6e"/><path class="q7g5d0brm"/><path class="hma38p_xj"/><path class="q4yzhl9sa"/><path class="d7ux6pr_q"/><path class="ef-3b9bib"/><path class="ggv91acnn"/><path class="iohi8v49p"/><path class="hawt4_bml"/><path class="zj6wuk5mt"/></g>`,
		"fallback": "cif:zm",
	});
}
