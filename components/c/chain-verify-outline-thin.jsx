...
</style><g class="hntgybcog"><path class="dx3ubrb9h"/><path class="hbtmd5b0k"/><path class="f3dzzgb6f"/><path class="mozf0_3vd"/></g>`,
		"fallback": "iconmind:chain-verify-outline-thin",
	});
}
