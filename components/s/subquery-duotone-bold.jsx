...
</style><g class="s0phu2bbs"><path class="f-t_rcb_j"/><path class="wy-cuvhpa"/><path class="k6fi9qmtq"/><path class="ffrry4bnq"/><path class="tu0fdo1xi"/></g>`,
		"fallback": "iconmind:subquery-duotone-bold",
	});
}
