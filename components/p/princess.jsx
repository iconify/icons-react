...
</style><path class="mtkbmvb0t"/><path class="k3j23u15h"/><path class="x04c8ob2s"/><path class="tz-4kebqz"/><path class="mf-6debwy"/><circle class="vxeh-o70a"/><path class="vbq18bipa"/><path class="sf0sfxlmu"/><path class="dmh6p2e8v"/><path class="xhiok0bor"/><path class="lmnxjtb6o"/><path class="xlwwcfb8f"/><circle class="auab7e0qj"/><path class="tnvypib4j"/><g class="cluxj1brx"><path class="h79pu4bft"/><ellipse class="dkzw2si8o"/><path class="s0b0itbuy"/></g>`,
		"fallback": "emojione:princess",
	});
}
