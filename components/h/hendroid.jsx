...
</style><rect transform="rotate(-18 24.436 20.407)" class="uvvovbvvt"/><path class="clzdolbio"/><path class="rop2cbcsa"/>`,
		"fallback": "arcticons:hendroid",
	});
}
