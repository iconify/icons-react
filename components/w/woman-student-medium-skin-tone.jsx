...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="y5d6z6k4q"/><path class="w36xs4bmj"/><path class="vj6i9wbld"/><path class="kr0w9-x7g"/><path class="b59u9-3to"/><path class="dwmpcvqft"/><path class="g4bbsrbxx"/><path class="wm_50-bmx"/><path class="xfc260btm"/><path class="p49keiefj"/><path class="sf3c92bgp"/><path class="a0kj8nqpa"/><path class="j-c90d2bf"/><path class="gnps_ulef"/>`,
		"fallback": "openmoji:woman-student-medium-skin-tone",
	});
}
