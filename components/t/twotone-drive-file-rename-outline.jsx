...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.m440u6hyr {
  fill: currentColor;
  d: path("M12.06 10.02L5 17.08V18h.92l7.06-7.06z");
...
</style><path class="m440u6hyr"/><path class="xdha8xbyf"/>`,
		"fallback": "ic:twotone-drive-file-rename-outline",
	});
}
