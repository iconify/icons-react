...
</style><path class="hkzb8-iiz"/><path class="brh4mtinz"/><path class="sgx-kdjjp"/><path class="hh86o0bil"/>`,
		"fallback": "vscode-icons:folder-type-api-opened",
	});
}
