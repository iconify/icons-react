...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uovx574fu"/><path class="z_p7_rbpw"/><path class="q_ofj8bpx"/><path class="qkk5e_94p"/><path class="mrwe6jbac"/><path class="my5_-ab6h"/><path class="m07299bvs"/><path class="m5nb45sse"/><path class="ir736-b5n"/><path class="m0umjrrfh"/><path class="ndacgyb-x"/><path class="ukbj9-z2l"/>`,
		"fallback": "streamline-emojis:man-dancing-1",
	});
}
