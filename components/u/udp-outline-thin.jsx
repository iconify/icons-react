...
</style><g class="hntgybcog"><path class="hnwta_3qv"/><path class="bb7inz33j"/><path class="nqnw98byf"/><path class="l1jjkky7x"/><path class="iee2p0bnv"/></g>`,
		"fallback": "iconmind:udp-outline-thin",
	});
}
