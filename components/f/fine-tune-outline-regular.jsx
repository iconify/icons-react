...
</style><g class="nrj6p8qat"><path class="iaozfqbuj"/><path class="l0zc9ibud"/><path class="kr1cz4b8j"/><path class="mvm7r4bea"/><path class="xaev2ybax"/></g>`,
		"fallback": "iconmind:fine-tune-outline-regular",
	});
}
