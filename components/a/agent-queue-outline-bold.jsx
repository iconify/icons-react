...
</style><g class="s0phu2bbs"><path class="skbifdbcx"/><path class="qvj-m-brn"/><path class="xvljocc-j"/></g>`,
		"fallback": "iconmind:agent-queue-outline-bold",
	});
}
