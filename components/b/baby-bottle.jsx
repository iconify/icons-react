...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="kpell_bnj"/><path class="h05yo-b6v"/><path class="dm6pc3bie"/><path class="iz8shub3a"/><path class="fc4to3b3k"/><path class="yb2rg1bhk"/><path class="f9gxfnbmi"/><path class="w2zbl4b8h"/><path class="fxdkscl3y"/><path class="n8c8vcpcd"/><path class="eeqkcfb1w"/><path class="kf-y9lb3k"/>`,
		"fallback": "streamline-emojis:baby-bottle",
	});
}
