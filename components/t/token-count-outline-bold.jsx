...
</style><g class="s0phu2bbs"><path class="ctt_dn_1e"/><path class="wae8aklke"/><path class="oib43sizw"/><path class="fezibpbwf"/></g>`,
		"fallback": "iconmind:token-count-outline-bold",
	});
}
