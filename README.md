# @iconify-react/material-icon-theme
...
Browse all icons: [preview Material Icon Theme on Iconify](https://icon-sets.iconify.design/material-icon-theme/)

## Installation

```bash
npm install github:iconify/icons-react#material-icon-theme
```
...
```jsx
import SampleIcon from '@iconify-react/material-icon-theme/zip';
...
```jsx
import SampleIcon from '@iconify-react/material-icon-theme/email';
