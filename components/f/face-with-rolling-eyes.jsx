...
</style><circle class="q1m2erv2p"/><circle class="i9i44z3-b"/><circle class="s2-a01xcc"/><path class="jkw7_vxjd"/>`,
		"fallback": "twemoji:face-with-rolling-eyes",
	});
}
