...
</style><g class="hntgybcog"><path class="n9mu2_d4r"/><path class="sturihscz"/><path class="mk93lqrnh"/><path class="hzm2gxbyj"/><path class="ywoqp9dou"/></g>`,
		"fallback": "iconmind:task-merge-outline-thin",
	});
}
