...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="n7nav39uz"/><path class="hymq4nb6l"/><path class="qaxuarf-g"/><path class="qx0eaxbxn"/><path class="qgqqdb9ll"/><g class="p5dp2obtj"><circle class="an1yj1b5g"/><circle class="q-emlgbgj"/></g><path class="hel-72bhc"/><path class="p8w024bmu"/><path class="y1gs7fqdn"/><path class="ajykg2t2z"/>`,
		"fallback": "flat-ui:storage",
	});
}
