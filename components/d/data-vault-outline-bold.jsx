...
</style><g class="s0phu2bbs"><path class="enrpg0aoq"/><path class="dfcdzc65k"/><path class="kwx_mgnfk"/><path class="aeyekmbly"/><path class="kdmnrabtq"/><path class="i98jgvxhu"/></g>`,
		"fallback": "iconmind:data-vault-outline-bold",
	});
}
