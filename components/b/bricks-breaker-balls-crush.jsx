...
</style><path class="oafewvbwy"/><path class="hrfa-tbtq"/><circle class="cugg4120k"/><circle class="w4h258_1n"/><circle class="rx4758bsa"/><circle class="uk6xadbpc"/><circle class="uyka6jbyy"/>`,
		"fallback": "arcticons:bricks-breaker-balls-crush",
	});
}
