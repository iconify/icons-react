...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.cbvomiyis {
  fill: var(--svg-color--a3aeff, #a3aeff);
...
.cyo699t7q {
  ...
  stroke-width: var(--svg-stroke-width--0-336px, 0.336px);
...
</style><path class="cbvomiyis"/><path class="l_xr03cls"/><path class="cyo699t7q"/>`,
		"fallback": "vscode-icons:folder-type-histoire-opened",
	});
}
