...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uymgdabjo"/><path class="tr1ltub0d"/><path class="elu0hh3sy"/><path class="khgxz9-2m"/><path class="bygepacgl"/><path class="q6juo_5pm"/><path class="tr_t-5blw"/><path class="gse483bgh"/><path class="gey7r2b7m"/><path class="ujvkhtb4s"/><path class="sj5c0zbjz"/><path class="b6yab4c0l"/><path class="m2b-h3x9d"/>`,
		"fallback": "streamline-emojis:victory-hand-2",
	});
}
