...
</style><path class="a-iqiquou"/><path class="dqgvah66f"/><path class="xietzojdi"/><path class="bn6ebpb5p"/><path class="ypu3u7t5k"/>`,
		"fallback": "ic:twotone-22mp",
	});
}
