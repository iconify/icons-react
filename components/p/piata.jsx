...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ft5dv1b6b"><path class="ve3tn9l8m"/><path class="lb-mqxbym"/><path class="u3wpiacmr"/><path class="pdjwq3bto"/><path class="obbvddrhk"/><path class="zh-h97rag"/><path class="ukelonb2u"/><path class="dwelsd12k"/><path class="zyww4bc3d"/><path class="n1rpv0zxy"/><path class="wy1qrqzqp"/><path class="gfoncdb0z"/></g>`,
		"fallback": "fluent-emoji-flat:piata",
	});
}
