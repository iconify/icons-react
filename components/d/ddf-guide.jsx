...
</style><circle class="sx-y9j8pk"/><circle class="himk38dep"/><circle class="f92abbvtk"/><path class="grzk6pbta"/>`,
		"fallback": "arcticons:ddf-guide",
	});
}
