...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="y340dqb_o"/><path class="g9obdub0m"/><path class="gzrk74b3c"/><path class="du0d4fbst"/><path class="p1k-ruboo"/><path class="m-6rtq9pc"/><path class="scg9l48-k"/><path class="dc384956g"/><path class="xylam0brg"/><ellipse class="suaze9bxy"/><path class="b9fvq8bov"/><path class="wdlvdtb4e"/>`,
		"fallback": "openmoji:ninja-medium-skin-tone",
	});
}
