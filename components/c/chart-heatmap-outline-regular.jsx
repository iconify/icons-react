...
</style><g class="nrj6p8qat"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="n708z7b3q"/><path class="ia7llpjvs"/><path class="edletn6ej"/></g>`,
		"fallback": "iconmind:chart-heatmap-outline-regular",
	});
}
