...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ft5dv1b6b"><path class="bwxel6kbw"/><path class="pzc-_efde"/><path class="c1i-ngbwj"/><path class="tsxczdbaj"/><path class="it050r_gq"/><path class="ro7erzbtg"/><path class="hv5-7-2hz"/><path class="q8l70i9oy"/><path class="p9tjy5byb"/><path class="d9c3mjtvs"/><path class="mqe055b1h"/><path class="b_n8a2tpp"/><path class="putpn5yaa"/><path class="jygkq4bgd"/><path class="t6zrekb9r"/><path class="ggatab37r"/><path class="u-4ohm-0f"/><path class="pwsmohb9w"/><path class="q2mqeta8x"/></g>`,
		"fallback": "fluent-emoji-flat:man-vampire-medium-dark",
	});
}
