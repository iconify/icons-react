...
</style><g class="s0phu2bbs"><path class="siqrysbwb"/><path class="okcmurbzx"/><path class="ylas06exf"/><path class="pquf1ccxc"/><path class="qv4k8z3yq"/><path class="y0y0ccsoe"/><path class="c4e1y7wvc"/></g>`,
		"fallback": "iconmind:foreign-key-duotone-bold",
	});
}
