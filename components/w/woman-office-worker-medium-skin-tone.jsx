...
</style><path class="lilgt_v7n"/><path class="v14rkgb-e"/><path class="hus4d3gtc"/><path class="lyyspibig"/><path class="xn8b1hbpi"/><path class="nighzlb7s"/><path class="imxoxcbeq"/><path class="r_fpmumxg"/><path class="dacb27btj"/><path class="nhumvpc1c"/><path class="pba-6gjae"/><path class="tmki56pov"/><path class="kcz03n36z"/><path class="aoidqwb_m"/><path class="t7ae1ruec"/><path class="dlyxx6btf"/>`,
		"fallback": "twemoji:woman-office-worker-medium-skin-tone",
	});
}
