...
</style><path class="iwettlg_h"/><path class="jmbb6c_5u"/><path class="snsim-bny"/><path class="x4qn95d4o"/><path class="qh1bmacyc"/><path class="w5-vg6iws"/><path class="mo5r4wbzu"/><path class="j2cdgfbun"/><circle class="ut_t21syf"/><circle class="o5-krulhj"/><circle class="u3kv_m4fm"/><path class="s3r0xjhrz"/><path class="v659t6b-x"/><path class="zl1pysbcl"/><path class="s54ifmfzm"/><path class="brkjq0r0m"/>`,
		"fallback": "twemoji:person-juggling-medium-dark-skin-tone",
	});
}
