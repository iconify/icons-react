...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="ghk5u4t2l"/><path clip-rule="evenodd" class="p1p9b5d6c"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:triangle-right-filled-circle-off",
	});
}
