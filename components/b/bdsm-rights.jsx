...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="t8wglebks"/><path class="oyh4rg2md"/><path class="gt-yp80yx"/><path class="jogg0qbdp"/><path class="mp6isz_2x"/><path class="zvbuzfbpw"/><path class="bz4fsabar"/><path class="ne8kuwtcn"/><path class="nb9859jtm"/><circle class="g9ptqnxrn"/><path class="ou4uqk1ur"/><path class="d5psre68v"/><path class="joaxlubzy"/><circle class="mohkkvb_h"/><circle class="pqof5ixdm"/><circle class="xzt2n1bya"/><path class="qy525jbwx"/>`,
		"fallback": "openmoji:bdsm-rights",
	});
}
