...
</style><g class="hntgybcog"><path class="okud9xj_d"/><path class="skpdqenaf"/><path class="f69zonn4h"/><path class="o95xao2-k"/></g>`,
		"fallback": "iconmind:role-binding-outline-thin",
	});
}
