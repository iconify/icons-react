...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="u30nek7ul"/><path class="grfp3vt9i"/><path class="ybvlt96vk"/><path class="qr2ys-55b"/><path class="q1qt4x1gb"/><path class="ac3fwosdn"/><path class="u11r70bjs"/><path class="ijyd8j7qo"/><path class="vrf1ej0us"/><path class="f_jm0xg_b"/>`,
		"fallback": "ei:spinner",
	});
}
