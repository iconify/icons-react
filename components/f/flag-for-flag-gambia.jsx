...
</style><path class="rsz0kbczt"/><path class="lyoabd47f"/><path class="t42tkekqp"/><path class="vpvs36pfv"/>`,
		"fallback": "emojione-v1:flag-for-flag-gambia",
	});
}
