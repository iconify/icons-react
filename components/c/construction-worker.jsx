...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="h-tvg3bpo"/><path class="km1xvactx"/><path class="t_a9febzj"/><path class="oinfjuh6p"/><path class="h7nt01b3z"/><path class="vxk2wxb0y"/><path class="gxc_kpwvz"/><path class="hmssbcb4e"/><path class="hbd7q74jh"/><path class="bu-vjvbyr"/><path class="shjygqb2u"/><path class="b_8_gebrp"/><path class="z9z1scb-r"/>`,
		"fallback": "streamline-emojis:construction-worker",
	});
}
