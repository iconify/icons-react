...
</style><g class="nrj6p8qat"><path class="r63fawbfm"/><path class="hhyy_kb5v"/><path class="unky6y77u"/></g>`,
		"fallback": "keyline-icons:app-window-cursor-two-tone",
	});
}
