...
</style><g class="hntgybcog"><path class="ldfz2pair"/><path class="p9lsl5b4g"/><path class="a_ozcqb_k"/><path class="up37trbfb"/><path class="w_lhjwijw"/></g>`,
		"fallback": "iconmind:dependency-duotone-thin",
	});
}
