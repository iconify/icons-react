...
</style><path class="h57zgdbru"/><path class="zceiobbfc"/><path class="ywamjmb_b"/><circle class="psznu452q"/><path class="y0n-k0qev"/>`,
		"fallback": "arcticons:remote-support",
	});
}
