...
</style><g class="s0phu2bbs"><path class="ni20md-jo"/><path class="j6o0shbiv"/><path class="uesvxd39h"/><path class="de5nl5bes"/><path class="i4k43hw6j"/></g>`,
		"fallback": "iconmind:mcp-resource-update-outline-bold",
	});
}
