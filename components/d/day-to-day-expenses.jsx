...
</style><path class="m6vr5p7of"/><path class="a6sah8blj"/><path class="is2vlfytl"/><path class="sn3n0eket"/>`,
		"fallback": "arcticons:day-to-day-expenses",
	});
}
