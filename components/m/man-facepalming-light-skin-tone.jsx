...
</style><path class="qfjz-2jgs"/><path class="zlioanbmh"/><path class="ytaft7bol"/><path class="n9lxxfbsz"/><path class="z29zl9s2e"/><path class="mlzkd7hlm"/><path class="e5pajjych"/><path class="cdqygsysg"/><path class="r1dlllpqg"/><path class="j50c26dju"/><path class="ttgs26b_q"/><defs><path id="SVGSNtVgdHr" class="xzf-9nlkm"/></defs><use href="#SVGSNtVgdHr" class="ega13mbxo"/>`,
		"fallback": "noto-v1:man-facepalming-light-skin-tone",
	});
}
