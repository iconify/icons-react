...
</style><g class="s0phu2bbs"><path class="nzpsuduik"/><path class="n-7t0yb1r"/><path class="qfgxpvbvs"/><path class="me177l4bh"/><path class="o5ex3bb1u"/></g>`,
		"fallback": "iconmind:bottom-nav-outline-bold",
	});
}
