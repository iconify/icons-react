...
.k2trdrbbx {
  fill: var(--svg-color--d7598b, #d7598b);
  d: path("M94.14 63.12c.38 2.07-.89 14.1-1.37 25.61c-.64 15.29-1.05 31.21-2.94 33.1c-3.24 3.24 13.18-15.09 13.12-14.72c-.06.38 1.38-5.11 1.59-6.79c.6-4.77 4.03-46.6 4.75-56.2z");
}

.kzq-l5bcm {
  fill: var(--svg-color--d7598b, #d7598b);
  d: path("M39.63 115.21c5.7 3.31 18.94 7.54 18.94 7.54c-2.94-3.31-2.61-14.36-2.86-20.6c-.63-16.17.16-21.76 1.76-25.92c3.19-8.3 21.11-26.66 21.15-27.03c-2.11-.42-8.24.75-10.29.01c-2.5-.9-4.85-1.67-7.52-1.99c-1.16-.14-2.43-.34-3.43-.98c-.55-.35-1.08-1.01-1.8-.78c-.47.15-.83.72-1.17 1.05c-.45.44-.95.83-1.46 1.21c-1.01.76-2.07 1.46-2.98 2.34c-1.02 1-1.88 2.14-2.98 3.05c-.92.75-1.95 1.47-2.77 2.32c-1.2 1.25-5.59 6.42-6.7 7.68c-2.03 2.3-3.21 5.18-3.77 8.17c-.63 3.33.29 11.75 1.1 18.74c1.57 13.45 1.16 23.08 4.78 25.19");
}

.o4yycrbwa {
  fill: var(--svg-color--f79329, #f79329);
  d: path("M81.89 81.81c.61-1.56 1.47-3.04 2.71-4.43l22.92-25.62c5.1-5.7 10.19-11.4 15.29-17.1l-8.67 57.93l-30.64 36.45l-5.32 3.46c.5-.33.26-4.76.29-5.34c.23-4.24.46-8.48.7-12.72c.35-6.47.71-12.95 1.06-19.42c.24-4.54.07-9.13 1.66-13.21");
}

.tdsnpabru {
  fill: var(--svg-color--d7598b, #d7598b);
  d: path("m18.49 40.48l75 31.61l14.96-17.12l-75.49-29.9z");
}

.xvy97m_0i {
  d: path("M15.41 53.97c-.23.37-4.89 4.26-3.25 10.94c1.63 6.67 8.75 37.85 8.75 37.85s.76 3.45 5.94 5.85c4.28 1.98 34.43 13.52 44.8 17.48c2.19.84 8.32 3.72 13.27-1.65c6.94-7.54 25.49-29.82 25.49-29.82s1.96-1.63 2.72-7.01c.57-4.01 5.37-33.37 6.17-41.34c.28-2.75 2.09-10.34-3.26-13.06c-5.36-2.72-52.68-17.8-52.68-17.8s-5.9-3.11-10.31 1.05c-15.24 14.4-37.64 37.51-37.64 37.51");
}
</style><defs><path id="SVGwOA0Bcky" class="xvy97m_0i"/></defs><use href="#SVGwOA0Bcky" class="j71m3fb1u"/><clipPath id="SVGFTbK9diq"><use href="#SVGwOA0Bcky"/></clipPath><path clip-path="url(#SVGFTbK9diq)" class="o4yycrbwa"/><path clip-path="url(#SVGFTbK9diq)" class="kzq-l5bcm"/><g clip-path="url(#SVGFTbK9diq)"><path class="k2trdrbbx"/></g><path clip-path="url(#SVGFTbK9diq)" class="cm-iwqbax"/><path clip-path="url(#SVGFTbK9diq)" class="tdsnpabru"/><path class="ei9_62b6d"/><path class="bufq8epcj"/>`,
		"fallback": "noto-v1:wrapped-gift",
	});
}
