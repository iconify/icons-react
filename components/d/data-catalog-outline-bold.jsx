...
</style><g class="s0phu2bbs"><path class="c4my-jbpv"/><path class="jgtyhzr6z"/><path class="g4lz7ob4p"/><path class="n6-318bus"/></g>`,
		"fallback": "iconmind:data-catalog-outline-bold",
	});
}
