...
</style><g class="s0phu2bbs"><path class="nw4fq7bfc"/><path class="n72a3uxbb"/><path class="wbwmlebvk"/><path class="ktxjg3b2q"/><path class="gd2yi5bin"/></g>`,
		"fallback": "iconmind:composer-attach-duotone-bold",
	});
}
