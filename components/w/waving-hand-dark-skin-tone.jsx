...
</style><path class="ethn561sd"/><defs><path id="SVGz28WJcgm" class="l5sjkmeex"/></defs><clipPath id="SVGNiarLeAP"><use href="#SVGz28WJcgm"/></clipPath><g clip-path="url(#SVGNiarLeAP)" class="t_nvrsbrc"><path class="s2adjebey"/><path class="n7rgt-bbs"/></g><defs><use href="#SVGz28WJcgm" id="SVGN2ejHeeZ"/></defs><clipPath id="SVGBT5vpbfx"><use href="#SVGN2ejHeeZ"/></clipPath><g clip-path="url(#SVGBT5vpbfx)"><path class="hyz0x52gt"/></g><path class="ctlgj-vhp"/>`,
		"fallback": "noto:waving-hand-dark-skin-tone",
	});
}
