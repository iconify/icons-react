...
</style><g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="i5lvicvhn"/><path class="au_dfmb3e"/></g>`,
		"fallback": "keyline-icons:square-bar-chart-2-horizontal-start-two-tone",
	});
}
