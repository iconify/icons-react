...
</style><g class="hntgybcog"><path class="wpo12_pus"/><path class="cf6epupol"/><path class="riz4hpmhz"/><path class="os75_tbot"/><path class="rebfvp9ta"/></g>`,
		"fallback": "iconmind:task-steal-duotone-thin",
	});
}
