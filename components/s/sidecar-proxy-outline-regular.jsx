...
</style><g class="nrj6p8qat"><path class="ux97gqb3r"/><path class="v-t99u-wl"/><path class="etqzyebuj"/><path class="ra-gd-w0u"/></g>`,
		"fallback": "iconmind:sidecar-proxy-outline-regular",
	});
}
