...
</style><g class="hntgybcog"><path class="y4_6s7b5v"/><path class="wew0vnk_n"/><path class="lgr612izs"/><path class="ync9d6bsc"/></g>`,
		"fallback": "iconmind:locker-pickup-outline-thin",
	});
}
