...
</style><g class="s0phu2bbs"><path class="i211t9xib"/><path class="w_mi5xczu"/><path class="xfs8wlfhn"/><path class="iml3cbclx"/><path class="ckctb4ljv"/><path class="wxrq2_b_h"/><path class="ivqg9reic"/></g>`,
		"fallback": "iconmind:side-channel-duotone-bold",
	});
}
