...
</style><defs><radialGradient id="SVGZmFlvcVj" cx="-492.035" cy="-883.37" r="13.998" gradientTransform="matrix(.866 -.5 -.3 -.52 177.106 -689.033)" gradientUnits="userSpaceOnUse"><stop offset="0" class="ua0yixyyu"/><stop offset=".267" class="rw1y23b0q"/><stop offset=".45" class="iyd87np1j"/><stop offset=".608" class="jfed5ub3o"/><stop offset=".753" class="hnguna-ln"/><stop offset=".886" class="sx75em_0g"/><stop offset="1" class="v_-03ifmw"/></radialGradient></defs><path fill="url(#SVGZmFlvcVj)" class="akvh75i4y"/>`,
		"fallback": "vscode-icons:file-type-rust",
	});
}
