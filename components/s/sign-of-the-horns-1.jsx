...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="uymgdabjo"/><path class="oktbcfj8p"/><path class="ui3cnrbuw"/><path class="j5w405x1h"/><path class="uq_kl96tg"/><path class="wk6khywwt"/><path class="bmgmwsbbx"/><path class="g8s19q3vm"/><path class="gshl7wb2d"/><path class="al-b-_b7r"/><path class="tyui6h1dl"/><path class="o68phk17j"/><path class="rl45-177t"/>`,
		"fallback": "streamline-emojis:sign-of-the-horns-1",
	});
}
