...
.tkdfkgv2l {
  ...
  d: path("M33.7 45v-6.4H20v-5.3L34.5 13h5.4v20.2H44v5.4h-4.1V45zm0-11.8V22.3L26 33.2z");
}
</style><path class="rl1cpz9vl"/><path class="f_xx2xjft"/><path class="tkdfkgv2l"/>`,
		"fallback": "emojione:keycap-4",
	});
}
