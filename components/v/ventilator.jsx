...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ti1p9jbdh"/><path class="p3yrybykg"/><path class="c8vyrqbad"/><circle class="r-l4vxabu"/><path class="ye31__byc"/><circle class="wsj8aubbi"/><path class="rytpg5s0w"/><path class="wo_-pcbhr"/><path class="coo-60n9a"/>`,
		"fallback": "openmoji:ventilator",
	});
}
