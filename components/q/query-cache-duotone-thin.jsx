...
</style><g class="hntgybcog"><path class="x15-b37rj"/><path class="mc5_norht"/><path class="c4my-jbpv"/><path class="qkea2dbiu"/><path class="g4lz7ob4p"/><path class="i4ksfdyrv"/></g>`,
		"fallback": "iconmind:query-cache-duotone-thin",
	});
}
