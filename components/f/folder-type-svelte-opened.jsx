...
</style><path class="y-y1ngwls"/><path class="b3bag_bja"/><path class="zazi__pfw"/><path class="pav86w_yu"/>`,
		"fallback": "vscode-icons:folder-type-svelte-opened",
	});
}
