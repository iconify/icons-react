...
</style><g class="hntgybcog"><path class="v1-fmxxhj"/><path class="h1cr44bva"/><path class="mvm7r4bea"/><path class="yd9az-bht"/></g>`,
		"fallback": "iconmind:image-digest-outline-thin",
	});
}
