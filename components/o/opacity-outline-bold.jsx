...
</style><g class="s0phu2bbs"><path class="vyks9vbfn"/><path class="emo-jf0pj"/><path class="aqrpc1aqy"/><path class="a_lj6jt5i"/><path class="a-9s6wb0y"/><path class="l23it1b0d"/></g>`,
		"fallback": "iconmind:opacity-outline-bold",
	});
}
