...
</style><g class="ft5dv1b6b"><path class="e_rjh1cfl"/><path class="xvjivybyz"/><path class="dgzfjnb0n"/><path class="z70afl_me"/><path clip-rule="evenodd" class="ksag4bb-q"/></g>`,
		"fallback": "pepicons-pop:stars-circle-off",
	});
}
