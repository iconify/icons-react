...
</style><g class="hntgybcog"><path class="pxmcfjbnu"/><path class="bh4gsivfq"/><path class="u552kxblg"/><path class="pdpzifbii"/></g>`,
		"fallback": "iconmind:throw-error-outline-thin",
	});
}
