...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.b6fvvdb1l {
  d: path("M252.171 158.954c-17.102 68.608-86.613 110.314-155.123 93.211c-68.61-17.102-110.316-86.61-93.213-155.119C20.937 28.438 90.347-13.268 158.957 3.835c68.51 17.002 110.317 86.51 93.214 155.119");
}
...
.lammahrfi {
  stop-color: var(--svg-color--f7931a, #f7931a);
}

.z_f3_kbfd {
  stop-color: var(--svg-color--f9aa4b, #f9aa4b);
}
</style><defs><linearGradient id="SVG7OTKbbrK" x1="49.973%" x2="49.973%" y1="-.024%" y2="99.99%"><stop offset="0%" class="z_f3_kbfd"/><stop offset="100%" class="lammahrfi"/></linearGradient></defs><path fill="url(#SVG7OTKbbrK)" class="b6fvvdb1l"/><path class="hsury1bto"/>`,
		"fallback": "logos:bitcoin",
	});
}
