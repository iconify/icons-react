...
</style><g class="s0phu2bbs"><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="fmv013bbw"/><path class="bxyszcb7e"/></g>`,
		"fallback": "iconmind:ablation-outline-bold",
	});
}
