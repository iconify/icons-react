...
</style><g class="hntgybcog"><path class="ffw_pwyfz"/><path class="kfdmhd64i"/><path class="tcxfk34nj"/><path class="lzdsnnb7v"/><path class="iedujiqkb"/><path class="n3p0zmbop"/></g>`,
		"fallback": "iconmind:dense-search-outline-thin",
	});
}
