...
</style><g class="hntgybcog"><path class="p68ditb-x"/><path class="s3elztrvy"/><path class="gcyir0cbn"/><path class="qbme7ibis"/><path class="arrljibna"/></g>`,
		"fallback": "iconmind:sponge-duotone-thin",
	});
}
