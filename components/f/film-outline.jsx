...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<rect class="u1_j1h4hu"/><rect class="h2oga0fsc"/><rect class="a52uhabfd"/><rect class="i9o8nmusb"/><rect class="nza-pnb1g"/><rect class="yoedkcbmm"/><rect class="irh-l4bms"/><rect class="trhi45bgg"/><rect class="hb31-hltx"/><rect class="lfbm3sxvu"/><rect class="mpjs23bgd"/>`,
		"fallback": "famicons:film-outline",
	});
}
