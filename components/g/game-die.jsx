...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="wom-q7bxg"/><path class="v8yyxwekg"/><path class="mmsm-4b5v"/><path class="r1zjn8keh"/><circle class="mycfl4a0v"/><circle class="epb-heb6n"/><circle class="p3rgnibqe"/><circle class="rfc8t4bhw"/><circle class="f3xzq7xsj"/><ellipse class="i3n3w6btv"/>`,
		"fallback": "openmoji:game-die",
	});
}
