...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.fkui-l26v {
  stop-color: var(--svg-color--6fc3ce, #6fc3ce);
}
...
.h-ve5pble {
  stop-color: var(--svg-color--f96962, #f96962);
}
