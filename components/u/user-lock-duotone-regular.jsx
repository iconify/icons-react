...
</style><g class="nrj6p8qat"><path class="kr5if0b2e"/><path class="ozoo-24et"/><path class="ppbx_abyw"/><path class="v-u0ijc7h"/><path class="uwoqp4t1z"/><path class="wepfk1i9t"/></g>`,
		"fallback": "iconmind:user-lock-duotone-regular",
	});
}
