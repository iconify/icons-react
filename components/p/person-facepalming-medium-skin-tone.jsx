...
</style><path class="xq2yr6dif"/><path class="b__xj1bdq"/><path class="ajxgcybdc"/><ellipse class="e_lq7ccni"/><path class="c_yy9achv"/><path class="lq196jboc"/><path class="s3gmrybdl"/><path class="ytknhqb6w"/><path class="ytaft7bol"/><path class="ehodk0edp"/><path class="zo5-9mdnb"/><path class="vp4l7jkbz"/><path class="sw0cbbbbi"/><path class="k9evr75rs"/><defs><path id="SVGudEVS6BX" class="zo56_0bpy"/></defs><use href="#SVGudEVS6BX" class="u46is_brm"/>`,
		"fallback": "noto-v1:person-facepalming-medium-skin-tone",
	});
}
