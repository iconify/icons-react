...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.bd2beqwnl {
  d: path("M3.926 18a5.52 5.52 0 0 1 4.295-5.38a5.5 5.5 0 0 0-1.227-.142a5.522 5.522 0 1 0 0 11.044c.422 0 .832-.052 1.227-.142A5.52 5.52 0 0 1 3.926 18");
}
...
</style><path class="imhpp79qe"/><path class="ry16btbeg"/><path class="jte9ogj6j"/><path class="bvubfybsi"/><path class="v6_qfgb0t"/><g class="n1mjunbsu"><path class="bd2beqwnl"/><path class="oc3im_b9b"/></g>`,
		"fallback": "twemoji:flag-comoros",
	});
}
