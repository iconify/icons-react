...
</style><g class="nrj6p8qat"><path class="yw3lpkbij"/><path class="ox_05kl4h"/><path class="ertschztb"/></g>`,
		"fallback": "keyline-icons:circle-chevrons-up-two-tone",
	});
}
