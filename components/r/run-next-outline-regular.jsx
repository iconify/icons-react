...
</style><g class="nrj6p8qat"><path class="d5czi6rdr"/><path class="l-z02yb4d"/><path class="zm2dyvb-o"/><path class="gbpohbcrz"/></g>`,
		"fallback": "iconmind:run-next-outline-regular",
	});
}
