...
</style><g class="nrj6p8qat"><path class="iaozfqbuj"/><path class="n3p0zmbop"/><path class="n8nvttn9v"/><path class="w3wwgzpqd"/></g>`,
		"fallback": "iconmind:impact-radius-outline-regular",
	});
}
