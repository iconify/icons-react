...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="psv_8pbss"/><path clip-rule="evenodd" class="xa34w7bwr"/><path clip-rule="evenodd" class="i_r1_acgo"/><path class="chz07ibxv"/><path clip-rule="evenodd" class="oeulkf_kp"/><path class="ozv6h8gfo"/><path class="b2tngprxw"/><path class="zsuclwbnx"/><path clip-rule="evenodd" class="kspoj7vnd"/></g>`,
		"fallback": "pepicons-print:bicycle-circle-off",
	});
}
