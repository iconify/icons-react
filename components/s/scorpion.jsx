...
</style><path class="m35r1-bid"/><g class="dbhyolblu"><path class="ikbad75dl"/><path class="howzl3boi"/></g><ellipse class="j1jwsfbud"/><ellipse class="hcpuc87by"/><ellipse class="d938ha-wo"/><ellipse class="v78jwib9j"/><path class="r0sk2mj-a"/><path class="w2k66c8ko"/><path class="zlb2h_bmj"/>`,
		"fallback": "emojione:scorpion",
	});
}
