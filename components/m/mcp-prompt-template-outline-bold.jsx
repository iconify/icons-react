...
</style><g class="s0phu2bbs"><path class="ni20md-jo"/><path class="j6o0shbiv"/><path class="uesvxd39h"/><path class="nlzvizopl"/><path class="n4fl2qbbh"/></g>`,
		"fallback": "iconmind:mcp-prompt-template-outline-bold",
	});
}
