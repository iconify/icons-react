...
</style><g class="ft5dv1b6b"><defs><mask id="SVGDek0lcuR"><path class="k5-vjlrin"/><path clip-rule="evenodd" class="oig13ac2c"/></mask></defs><circle mask="url(#SVGDek0lcuR)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:phone-circle-filled",
	});
}
