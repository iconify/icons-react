...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<circle class="s6iikjgcv"/><path class="s2dm0dd0i"/><path class="e63b1f_jd"/><path class="oj4v3_b9i"/><g class="lb80qlbob"><path class="ky3t62bns"/><path class="vs75iw7pq"/><path class="g7iwtbc9y"/><path class="qtfp1d0ur"/></g>`,
		"fallback": "openmoji:star-struck",
	});
}
