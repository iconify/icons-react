...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="cwj6f7u_l"/><path class="t0m985t7g"/><path class="lpguzdbpl"/><g class="doj9dq_jg"><path class="y_379bc7e"/><path class="yjgtr0bfm"/><path class="xy1_0ioir"/></g>`,
		"fallback": "openmoji:volcano",
	});
}
