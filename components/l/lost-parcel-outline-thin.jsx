...
</style><g class="hntgybcog"><path class="j534ltbcb"/><path class="m1mjigbsi"/><path class="d1zyr9bfc"/><path class="ik7mf4b_l"/><path class="jlojnsdlu"/></g>`,
		"fallback": "iconmind:lost-parcel-outline-thin",
	});
}
