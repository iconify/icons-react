...
</style><g class="s0phu2bbs"><path class="crgm97xoy"/><path class="k4qo1xe9v"/><path class="x4bmljlar"/><path class="wtfq6b2ta"/><path class="ui32hib9b"/><path class="htavkzbpk"/></g>`,
		"fallback": "iconmind:shuttle-bus-outline-bold",
	});
}
