...
</style><g class="nrj6p8qat"><path class="edllzuogn"/><path class="ps2g__eqt"/><path class="iaozfqbuj"/><path class="m8y64tbqv"/><path class="epou1mbuy"/></g>`,
		"fallback": "iconmind:perplexity-duotone-regular",
	});
}
