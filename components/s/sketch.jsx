...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="hi31eib1s"/><path class="a5notdz6b"/><path class="gh65jv65k"/><path class="iitbkh92y"/><path class="vn9r7dcbi"/><path class="jvcf3m1mi"/><path class="mxj57qx3u"/>`,
		"fallback": "devicon:sketch",
	});
}
