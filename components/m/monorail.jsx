...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="i4y5ai05a"/><path class="gokp5ee5s"/><path class="po6jcjbna"/><path class="dz6f1bb_n"/><path class="sx_lc4b2y"/><path class="ktfexs44h"/><path class="n79901pmr"/><path class="a3z88gbeh"/><path class="g66mgdbsg"/><path class="x1piabs4t"/>`,
		"fallback": "fxemoji:monorail",
	});
}
