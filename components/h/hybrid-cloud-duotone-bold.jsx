...
</style><g class="s0phu2bbs"><path class="esolkqbpc"/><path class="yudi3ibqw"/><path class="c-pcdbceg"/><path class="gsfn67b3j"/></g>`,
		"fallback": "iconmind:hybrid-cloud-duotone-bold",
	});
}
