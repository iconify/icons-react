...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="h32t530tv"/><path class="n9cednr3v"/><path class="kwyd7xbpw"/><path class="puupefb6e"/><path class="hj-m2_btf"/><path class="k5lwg8mlg"/><path class="rrtud298x"/><path class="e28ga4b7y"/><path class="eu5plsbge"/><path class="xhar8hbrz"/>`,
		"fallback": "fxemoji:hushed",
	});
}
