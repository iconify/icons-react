...
</style><g class="s0phu2bbs"><path class="n7c_b1bsn"/><path class="wfyw8dbnu"/><path class="a218-cpca"/><path class="enrpg0aoq"/><path class="mxzk029nb"/></g>`,
		"fallback": "iconmind:entitlement-duotone-bold",
	});
}
