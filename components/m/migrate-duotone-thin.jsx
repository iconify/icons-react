...
</style><g class="hntgybcog"><path class="g7esaduey"/><path class="bkrxi4g3s"/><path class="k-sgg11ok"/><path class="bwxeoibzi"/><path class="x1_r36phd"/><path class="ct75s-bnk"/></g>`,
		"fallback": "iconmind:migrate-duotone-thin",
	});
}
