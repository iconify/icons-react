...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="ft5dv1b6b"><path class="k-1vj1voz"/><path class="sdgnrbb3f"/><path class="xnx_zun1j"/><path class="vmeptgtdi"/><path class="ty7j3abrd"/><path class="m4ay3wsta"/><path class="fv_3uybpi"/></g>`,
		"fallback": "cif:lk",
	});
}
