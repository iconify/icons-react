...
</style><g class="s0phu2bbs"><path class="bazq81bsf"/><path class="hceeinb8d"/><path class="d3xn50bni"/><path class="znz1wcbkt"/><path class="gte-olbep"/><path class="jz3tcofhe"/></g>`,
		"fallback": "iconmind:capability-card-duotone-bold",
	});
}
