...
.pdgal68-s {
  ...
  cy: 128px;
  r: 128px;
  fill: var(--svg-color--f05537, #f05537);
}
</style><circle class="pdgal68-s"/><path class="jg4r9tbst"/>`,
		"fallback": "logos:eventbrite-icon",
	});
}
