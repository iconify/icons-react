...
</style><g class="s0phu2bbs"><path class="f3-m7qb5w"/><path class="nmmwlmbbe"/><path class="mcxx_8bkd"/><path class="gxazl9btk"/><path class="dngdujbqm"/><path class="nc3tobbpg"/><path class="pdc4gobyf"/><path class="j2hnp9b4t"/></g>`,
		"fallback": "iconmind:qr-duotone-bold",
	});
}
