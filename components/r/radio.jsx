...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="f91zpx8rd"/><path class="albikqbom"/><path clip-rule="evenodd" class="pgdgbrbtm"/></g>`,
		"fallback": "pepicons-pop:radio",
	});
}
