...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.gc88f_biy {
  fill: var(--svg-color--5dadec, #5dadec);
  d: path("M16 31c0 2.762-2.238 5-5 5s-5-2.238-5-5s4-10 5-10s5 7.238 5 10");
}
...
</style><path class="tg31urbgg"/><ellipse class="yc03psz8h"/><ellipse class="ki_opobqm"/><path class="ny_cz1bhw"/><path class="gc88f_biy"/>`,
		"fallback": "twemoji:crying-face",
	});
}
