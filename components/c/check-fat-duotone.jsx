...
.v6i-t8bdc {
  d: path("m237.66 85.26l-128.4 128.4a8 8 0 0 1-11.32 0l-71.6-72a8 8 0 0 1 0-11.31l24-24a8 8 0 0 1 11.32 0L104 147.43l98.34-97.09a8 8 0 0 1 11.32 0l24 23.6a8 8 0 0 1 0 11.32");
  opacity: var(--svg-opacity--0-2, 0.2);
}
</style><g class="cuyn6tgcc"><path class="v6i-t8bdc"/><path class="kd1rvwbmj"/></g>`,
		"fallback": "ph:check-fat-duotone",
	});
}
