...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="f7198bctx"/><path class="n9zqrtbkl"/><path class="mkou0eiju"/><path class="m5s9adcvt"/><path class="pc-fri0qn"/><path class="p7mobnb3b"/><path class="l802ly51o"/><path class="eoh6a2spy"/><path class="hta3tub1j"/>`,
		"fallback": "fxemoji:grin",
	});
}
