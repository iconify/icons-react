...
</style><g class="nrj6p8qat"><path class="f7up_jefg"/><path class="lgr612izs"/><path class="drftkjb-q"/><path class="ync9d6bsc"/><path class="rf0c3ccmk"/></g>`,
		"fallback": "iconmind:pet-passport-outline-regular",
	});
}
