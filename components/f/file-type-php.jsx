...
</style><defs><radialGradient id="SVGQRCVdbYF" cx="-16.114" cy="20.532" r="18.384" gradientTransform="translate(26.52 -9.307)" gradientUnits="userSpaceOnUse"><stop offset="0" class="vc--wpv5i"/><stop offset=".5" class="irf8jsb_m"/><stop offset="1" class="c0xyygbvy"/></radialGradient></defs><ellipse fill="url(#SVGQRCVdbYF)" class="o-8j_8bbh"/><ellipse class="thg87tb9y"/><path class="d16305b7h"/><path class="iet3d9fbx"/>`,
		"fallback": "vscode-icons:file-type-php",
	});
}
