...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="bfkdn5b6p"/><path clip-rule="evenodd" class="vvmz4aczs"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:chain-circle-off",
	});
}
