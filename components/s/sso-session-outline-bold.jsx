...
</style><g class="s0phu2bbs"><path class="a218-cpca"/><path class="txy3rzbds"/><path class="c4uh67boo"/><path class="g45hqpb0s"/></g>`,
		"fallback": "iconmind:sso-session-outline-bold",
	});
}
