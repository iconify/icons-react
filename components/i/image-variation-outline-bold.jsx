...
</style><g class="s0phu2bbs"><path class="d9acmebfe"/><path class="x6s5o0ble"/><path class="ulvbol07x"/><path class="uberx3r9c"/></g>`,
		"fallback": "iconmind:image-variation-outline-bold",
	});
}
