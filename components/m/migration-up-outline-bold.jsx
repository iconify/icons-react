...
</style><g class="s0phu2bbs"><path class="jfvoq9bhn"/><path class="slz7u0oyn"/><path class="h7bcztycq"/><path class="bi-wyob_j"/></g>`,
		"fallback": "iconmind:migration-up-outline-bold",
	});
}
