...
</style><g class="s0phu2bbs"><path class="duisldofr"/><path class="zmc7aqkcp"/><path class="rrzohjbez"/><path class="jlojnsdlu"/><path class="sts7iebwd"/></g>`,
		"fallback": "iconmind:lost-luggage-outline-bold",
	});
}
