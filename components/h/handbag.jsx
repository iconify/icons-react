...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="eb6v_57wt"/><path class="uryqb4bco"/><circle class="y9indi7op"/><circle class="rq5og3b1j"/><circle class="nzsppacsp"/><circle class="e8nezy4nr"/><path class="jd78y-y4c"/><path class="mlb0clbsd"/><path class="c_ovs66ix"/>`,
		"fallback": "fxemoji:handbag",
	});
}
