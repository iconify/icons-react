...
</style><g class="nrj6p8qat"><path class="ni20md-jo"/><path class="j6o0shbiv"/><path class="uesvxd39h"/><path class="wshbdfbhg"/><path class="kl5egs07h"/></g>`,
		"fallback": "iconmind:mcp-retry-policy-outline-regular",
	});
}
