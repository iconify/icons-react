...
</style><g class="nrj6p8qat"><path class="lu1q1nb0a"/><path class="zirb-hbnv"/><path class="y_b-hlbjs"/><path class="nke_cgbmx"/></g>`,
		"fallback": "iconmind:dedupe-window-outline-regular",
	});
}
