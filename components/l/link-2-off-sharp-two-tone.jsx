...
</style><g class="gp_8x1bzb"><path class="a8f231k-x"/><path class="ahhqo1b4s"/><path class="ellalvbgp"/></g>`,
		"fallback": "keyline-icons:link-2-off-sharp-two-tone",
	});
}
