...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="xxwufeuhl"/><path class="e8ze8e3mv"/><path class="w8gke-bva"/><path class="x3izv4lxo"/><path class="jryj7tbzs"/><path class="dmsdrxn0c"/><g class="g2csbibpu"><path class="pibvpmbno"/><path class="r3ax8lv9l"/><path class="f8ta1tzfw"/><path class="gp3uhms_x"/></g><path class="pwqemb6qx"/><path class="nyj65vnrt"/><path class="ohy9vs5ik"/>`,
		"fallback": "thesvg-color:abarth",
	});
}
