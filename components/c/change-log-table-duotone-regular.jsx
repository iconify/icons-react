...
</style><g class="nrj6p8qat"><path class="eqtg9zhcu"/><path class="jv4nyiume"/><path class="zoomnj6dr"/><path class="lnoc67bvv"/><path class="vefr08bem"/><path class="zolr6ns8h"/><path class="jfvoq9bhn"/><path class="zdgvfxbbv"/><path class="slz7u0oyn"/><path class="uea_ybysx"/><path class="it83nbbll"/><path class="coh5p5slf"/></g>`,
		"fallback": "iconmind:change-log-table-duotone-regular",
	});
}
