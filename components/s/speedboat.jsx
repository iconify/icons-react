...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="rj-g3rb9m"/><path class="zj02sxbpd"/><path class="c705-lf_d"/><path class="e1ft14bwt"/><path class="ftfel_but"/><g class="doj9dq_jg"><path class="eogpkjw6f"/><path class="swqn_zbxc"/><path class="l7zrq5b0w"/></g>`,
		"fallback": "openmoji:speedboat",
	});
}
