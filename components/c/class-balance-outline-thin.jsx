...
</style><g class="hntgybcog"><path class="xaafqhbdh"/><path class="uuhg5tbuk"/><path class="rjnrdobeg"/><path class="rcu9plbzq"/><path class="sm8qqabeo"/><path class="ex075abcq"/></g>`,
		"fallback": "iconmind:class-balance-outline-thin",
	});
}
