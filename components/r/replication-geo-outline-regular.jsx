...
</style><g class="nrj6p8qat"><path class="hj9iwxbta"/><path class="jw66ugylr"/><path class="s994z3b0d"/><path class="c9-0s6xhx"/><path class="olqfcgidt"/><path class="i0wu9pzyn"/></g>`,
		"fallback": "iconmind:replication-geo-outline-regular",
	});
}
