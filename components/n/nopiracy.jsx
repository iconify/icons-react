...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="z81wmyb4t"/><path class="is5sjnbbs"/><path class="t7kqpqb5f"/><path class="bneip4coj"/><path class="d27i39itw"/><path class="cyghbobbo"/><path class="n8u4pachu"/><path class="xt5mimbcb"/>`,
		"fallback": "fxemoji:nopiracy",
	});
}
