...
</style><g class="hntgybcog"><path class="c4my-jbpv"/><path class="qkea2dbiu"/><path class="ha2bk5bpt"/><path class="l7-tgmbes"/><path class="jaql6vb1s"/></g>`,
		"fallback": "iconmind:anomaly-data-outline-thin",
	});
}
