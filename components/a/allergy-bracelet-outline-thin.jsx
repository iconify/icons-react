...
</style><g class="hntgybcog"><path class="qrhxojbpd"/><path class="hv3ppsbji"/><path class="iyj_k-bwo"/><path class="jlojnsdlu"/></g>`,
		"fallback": "iconmind:allergy-bracelet-outline-thin",
	});
}
