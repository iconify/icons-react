...
</style><g class="hntgybcog"><path class="n92hyrp1a"/><path class="ik93a37tn"/><path class="vjdmi0bfh"/><path class="qh-87afpi"/><path class="bo51iypxr"/></g>`,
		"fallback": "iconmind:blossom-outline-thin",
	});
}
