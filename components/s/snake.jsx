...
</style><defs><path id="SVGFvHEkaWd" class="joauv2bxb"/></defs><use href="#SVGFvHEkaWd" class="r_7iy-bjc"/><path class="a86ctrjoo"/><path class="kuq5qgbtx"/><path class="yqzoa-b0p"/>`,
		"fallback": "noto-v1:snake",
	});
}
