...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="fq4cpvbdm"/><path class="v2k4sclck"/><path class="ay8ig0b9c"/><circle class="yjkly-lka"/><path class="r2sm1wdfq"/><path class="nxpvtilbz"/><ellipse class="e7ln2bc_r"/><ellipse class="v0jh4abtu"/><circle class="grj57-beo"/><path class="luk8zs-ky"/>`,
		"fallback": "flag:nc-1x1",
	});
}
