...
</style><path class="eouzd2b5m"/><defs><path id="SVGyRSiz3ZI" class="tuigsnr-c"/></defs><clipPath id="SVGg8BHKevx"><use href="#SVGyRSiz3ZI"/></clipPath><g clip-path="url(#SVGg8BHKevx)" class="zlqwn85jm"><path class="ud_koobjq"/><path class="p2vykcvbo"/></g><defs><use href="#SVGyRSiz3ZI" id="SVGIiOWWbQa"/></defs><clipPath id="SVGyYC8dcBl"><use href="#SVGIiOWWbQa"/></clipPath><g clip-path="url(#SVGyYC8dcBl)" class="j9_i7vu4q"><path class="fawb-zbbe"/></g>`,
		"fallback": "noto:vulcan-salute-medium-light-skin-tone",
	});
}
