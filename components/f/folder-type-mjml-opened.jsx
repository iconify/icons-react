...
</style><path class="umtsrjbqm"/><path class="cvu4dqbmo"/><path class="evz-qzr-s"/><path class="x01pbmbfu"/>`,
		"fallback": "vscode-icons:folder-type-mjml-opened",
	});
}
