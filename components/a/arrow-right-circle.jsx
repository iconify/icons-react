...
</style><g clip-rule="evenodd" class="n1lsf0bnc"><path class="upsxrvbtk"/><path class="o9zwovhzi"/><path class="uq4c1ccfc"/><path class="hdxpysbbn"/></g>`,
		"fallback": "pepicons-pop:arrow-right-circle",
	});
}
