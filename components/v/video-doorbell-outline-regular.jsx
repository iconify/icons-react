...
</style><g class="nrj6p8qat"><path class="h4gumgb9f"/><path class="acyg6nb1v"/><path class="ikiprn9sq"/><path class="jlojnsdlu"/></g>`,
		"fallback": "iconmind:video-doorbell-outline-regular",
	});
}
