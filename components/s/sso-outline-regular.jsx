...
</style><g class="nrj6p8qat"><path class="hvxngl_cs"/><path class="bfl7ipbld"/><path class="e1-kupvjo"/><path class="b0jxq8rov"/><path class="fiap06mao"/></g>`,
		"fallback": "iconmind:sso-outline-regular",
	});
}
