...
</style><g class="s0phu2bbs"><path class="jgpu15buw"/><path class="ozi-k-boi"/><path class="pr-75-r8g"/><path class="x72vanbdm"/></g>`,
		"fallback": "iconmind:page-search-outline-bold",
	});
}
