...
</style><g class="nrj6p8qat"><path class="v1p3s7bgt"/><path class="dvdaq001f"/><path class="e5z2csb_e"/><path class="zl16vzbgk"/><path class="y6b-2ywbl"/><path class="clpojkoko"/></g>`,
		"fallback": "iconmind:flamegraph-duotone-regular",
	});
}
