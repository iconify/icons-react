...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="yzo9_wa1v"/><path class="t_j776bmu"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:equal-circle-off",
	});
}
