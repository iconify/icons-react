...
</style><path class="vubfsjbph"/><path class="rm8_wpbce"/><path class="k12m-svgc"/><path class="t3qrec6fg"/><path class="ceh7c3bzt"/>`,
		"fallback": "emojione-v1:flag-for-flag-western-sahara",
	});
}
