...
</style><path class="aloo1dp-q"/><defs><path id="SVGxNRKtcgC" class="p1lt0lbaa"/></defs><clipPath id="SVGO4QYacOU"><use href="#SVGxNRKtcgC"/></clipPath><g clip-path="url(#SVGO4QYacOU)" class="t_nvrsbrc"><path class="up3gfibjm"/></g><defs><use href="#SVGxNRKtcgC" id="SVG5QiDydfz"/></defs><clipPath id="SVGpoTh5cSd"><use href="#SVG5QiDydfz"/></clipPath><g clip-path="url(#SVGpoTh5cSd)"><path class="di4thepzx"/></g>`,
		"fallback": "noto:backhand-index-pointing-right-dark-skin-tone",
	});
}
