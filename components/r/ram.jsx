...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="alzw6obap"/><path class="iss0nmxmg"/><path class="h5dgtzeqk"/><path class="tqns4_b3k"/><path class="rm8fpxb6b"/><path class="nb-uywbdu"/><path class="aa6fl948s"/><path class="y-i41cciz"/><path class="e66rv6b1v"/><path class="ircgzcioi"/><path class="eb157xb0d"/><path class="aiz2f5ahe"/>`,
		"fallback": "streamline-emojis:ram",
	});
}
