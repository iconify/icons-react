...
</style><g class="s0phu2bbs"><path class="pkgcrzeui"/><path class="wg52owbxx"/><path class="osgxtfl6n"/><path class="sdxd6sb1r"/><path class="utktsvfze"/></g>`,
		"fallback": "iconmind:workflow-duotone-bold",
	});
}
