...
</style><g class="s0phu2bbs"><path class="h7689ssil"/><path class="cf6epupol"/><path class="rmp_51owx"/><path class="pfe6vjb3x"/></g>`,
		"fallback": "iconmind:email-agent-duotone-bold",
	});
}
