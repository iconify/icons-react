...
</style><g class="hntgybcog"><path class="a218-cpca"/><path class="enrpg0aoq"/><path class="icp673bbo"/><path class="tbr41ebiu"/></g>`,
		"fallback": "iconmind:trial-period-outline-thin",
	});
}
