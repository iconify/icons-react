...
</style><path class="tn4u01b2f"/><path class="jig1crbnz"/><path class="bh5jb4b1d"/><path class="i8dojvbwj"/><path class="nqylgub1s"/><circle class="akd7u9b6c"/>`,
		"fallback": "twemoji:spouting-whale",
	});
}
