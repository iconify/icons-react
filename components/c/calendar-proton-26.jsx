...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.ejt0h4euu {
  fill: none;
  stroke: currentColor;
  stroke-linecap: round;
  stroke-linejoin: round;
  d: path("M30.313 20.761a4.55 4.55 0 0 0-4.074-1.852h-.37a4.98 4.98 0 0 0-5 5v5");
}
...
</style><path class="oagjj4b-u"/><circle class="gvast2brf"/><path class="ejt0h4euu"/><path class="f6_7b22_l"/><path class="wtoegrbgv"/><path class="orx8z1bik"/>`,
		"fallback": "arcticons:calendar-proton-26",
	});
}
