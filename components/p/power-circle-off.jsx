...
</style><g class="cuyn6tgcc"><g transform="translate(3 3)"><path class="qi4azoban"/><rect class="t9nly_bze"/><path class="xedf9ccsf"/></g><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:power-circle-off",
	});
}
