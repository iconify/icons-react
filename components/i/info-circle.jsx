...
</style><g class="cuyn6tgcc"><path clip-rule="evenodd" class="it5wk5bgi"/><path class="hksrydaxc"/><path clip-rule="evenodd" class="kphejjb8s"/></g>`,
		"fallback": "pepicons-pop:info-circle",
	});
}
