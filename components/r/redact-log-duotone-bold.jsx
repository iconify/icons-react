...
</style><g class="s0phu2bbs"><path class="ots31sbwo"/><path class="itvzmsbxb"/><path class="jd_dotbnq"/><path class="h2fnwccfy"/><path class="vutv-xbjy"/></g>`,
		"fallback": "iconmind:redact-log-duotone-bold",
	});
}
