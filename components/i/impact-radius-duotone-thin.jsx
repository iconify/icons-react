...
</style><g class="hntgybcog"><path class="edllzuogn"/><path class="k_2z93bzc"/><path class="iaozfqbuj"/><path class="n3p0zmbop"/><path class="n8nvttn9v"/><path class="w3wwgzpqd"/></g>`,
		"fallback": "iconmind:impact-radius-duotone-thin",
	});
}
