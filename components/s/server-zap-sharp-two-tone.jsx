...
</style><g class="gp_8x1bzb"><path class="wu4br8bxj"/><path class="fjhmvebfg"/><path class="r0sazqbgm"/></g>`,
		"fallback": "keyline-icons:server-zap-sharp-two-tone",
	});
}
