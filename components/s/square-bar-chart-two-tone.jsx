...
</style><g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="i5lvicvhn"/><path class="fs29jeblr"/></g>`,
		"fallback": "keyline-icons:square-bar-chart-two-tone",
	});
}
