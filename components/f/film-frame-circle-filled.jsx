...
</style><g class="ft5dv1b6b"><defs><mask id="SVGpetigbaF"><path class="k5-vjlrin"/><path clip-rule="evenodd" class="qltkoreqp"/></mask></defs><circle mask="url(#SVGpetigbaF)" class="bd9gczbnq"/></g>`,
		"fallback": "pepicons-pop:film-frame-circle-filled",
	});
}
