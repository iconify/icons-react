...
</style><g clip-rule="evenodd" class="n1lsf0bnc"><path class="ec_fit1mn"/><path class="k4rlholep"/><path class="hdxpysbbn"/></g>`,
		"fallback": "pepicons-pop:hash-circle",
	});
}
