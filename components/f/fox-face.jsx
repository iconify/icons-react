...
</style><path class="xs06d3c5d"/><path class="jdj8klb6o"/><path class="mo9xbgbvo"/><path class="vbvd86bjh"/><path class="xycx8rbfi"/><path class="qp2f8bbtg"/><path class="dm4xuz8fh"/><path class="fx9z5wbjr"/><path class="vgpgokjeo"/><circle class="jn75w-3uq"/><circle class="m33rxzb-x"/>`,
		"fallback": "noto-v1:fox-face",
	});
}
