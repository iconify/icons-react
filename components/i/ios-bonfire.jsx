...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="d4217jzxg"/><path class="zhjwxhxow"/><path class="jfi18-b_j"/><path class="bawl8kb6w"/><path class="n109qknsp"/><path class="o-ny1ab1r"/><path class="rg3j6ubse"/><path class="klz5gil6u"/><path class="szwoy0b_y"/><path class="nsanmccuc"/><path class="wfdeg838f"/>`,
		"fallback": "ion:ios-bonfire",
	});
}
