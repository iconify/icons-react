...
</style><g class="hntgybcog"><path class="sqwju3bsh"/><path class="du3agkbjb"/><path class="fquh7rbnp"/><path class="jqdaf4bpj"/><path class="vqi6vft7m"/></g>`,
		"fallback": "iconmind:car-breakdown-outline-thin",
	});
}
