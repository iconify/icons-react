...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="lnkhkh"/><path class="qa-o7h taf2xz vlmmxw"/><path class="ab0nvj qa-o7h"/><path class="qa-o7h taf2xz vxmw1k"/><path class="qa-o7h taf2xz zswq1o"/>`,
		"fallback": "line-md:document-list-twotone",
	});
}
