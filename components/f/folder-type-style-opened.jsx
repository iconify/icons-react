...
</style><path class="sim0rbi4g"/><path class="z86jnui4p"/><path class="q9p-6ibjk"/><path class="aa47f0b6z"/><path class="im1dm_s0h"/><path class="d1tpkwano"/>`,
		"fallback": "vscode-icons:folder-type-style-opened",
	});
}
