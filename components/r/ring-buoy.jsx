...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="ydb7nlglf"/><path class="cdp4_6how"/><path class="a280g0kbr"/><path class="wvkuzy2ta"/><path class="oiyhuybvl"/><path class="eke9pz7ef"/><g class="hzhb0bcwn"><path class="ls75cqbfb"/><path class="t5bdlnnlr"/><path class="rjora20pa"/><circle class="jw0urr1wj"/></g>`,
		"fallback": "openmoji:ring-buoy",
	});
}
