...
</style><g class="nrj6p8qat"><path class="lwaj0vjwi"/><path class="i5lvicvhn"/><path class="exuxly8wg"/></g>`,
		"fallback": "keyline-icons:square-chevron-left-two-tone",
	});
}
