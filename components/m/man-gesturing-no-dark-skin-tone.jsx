...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="dqyg5fb7y"/><g class="e_raf5bng"><path class="qkc0uib3d"/><path class="r6bbinbfq"/><path class="xwow0vj_h"/></g><path class="j7p67wbop"/><path class="unwr40b3e"/><path class="ux36gu8vw"/><path class="u9f-mk44g"/><path class="ah890qb1c"/><path class="v4_wszbam"/>`,
		"fallback": "openmoji:man-gesturing-no-dark-skin-tone",
	});
}
