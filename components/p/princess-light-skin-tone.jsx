...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="hwtf52b2y"/><path class="kbuay5b_y"/><g class="eztqw9biy"><path class="jlaf5jb2q"/><path class="tj2_hylcq"/></g><path class="kq0me1j7s"/><path class="sjv8lrb5m"/><path class="ixy0vklsb"/><path class="hniumccqz"/><path class="t_mrjsbkh"/><path class="xuv5lg21j"/>`,
		"fallback": "openmoji:princess-light-skin-tone",
	});
}
