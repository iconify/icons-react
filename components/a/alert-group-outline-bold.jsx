...
</style><g class="s0phu2bbs"><path class="k70w93buq"/><path class="f4yp5uw0u"/><path class="v7xfanbfw"/><path class="q3f0f47al"/><path class="ytpwexbvl"/></g>`,
		"fallback": "iconmind:alert-group-outline-bold",
	});
}
