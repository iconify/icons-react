...
</style><g class="hntgybcog"><path class="d5czi6rdr"/><path class="azs8m69dm"/><path class="m6nkjhiin"/><path class="if5ft31dv"/></g>`,
		"fallback": "iconmind:event-alert-outline-thin",
	});
}
