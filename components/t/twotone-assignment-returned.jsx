...
.xz4lj2b2d {
  fill: currentColor;
  d: path("M5 19h14V5H5zm5-7V8h4v4h3l-5 5l-5-5z");
  opacity: var(--svg-opacity--0-3, 0.3);
}
</style><path class="xz4lj2b2d"/><path class="oi8hf5-0f"/>`,
		"fallback": "ic:twotone-assignment-returned",
	});
}
