...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<style>.hfx5gt0rf {
  fill: var(--svg-color--f3fdff, #f3fdff);
  fill-rule: evenodd;
...
.y1019vnjp {
  fill: var(--svg-color--375c70, #375c70);
  d: path("M27.917 6h-9.679l-2 4H5v17h25V6ZM28 24H7V12h21Zm.1-14h-7.81l.952-2H28v2Zm-2.233 4H.273l3.86 13h25.594Z");
}
</style><path class="y1019vnjp"/><path class="lpbatjjbe"/><path class="hfx5gt0rf"/>`,
		"fallback": "vscode-icons:folder-type-mysql-opened",
	});
}
