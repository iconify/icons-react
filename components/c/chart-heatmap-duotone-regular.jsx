...
</style><g class="nrj6p8qat"><path class="qnpznt65u"/><path class="p1zm8jh9k"/><path class="hh7m_9dhg"/><path class="j_briu5fm"/><path class="r4a2gm0bv"/><path class="sxw4-zbyq"/><path class="yhswpf2nj"/><path class="qarcjib7d"/><path class="z1gyoabnz"/><path class="n708z7b3q"/><path class="ia7llpjvs"/><path class="edletn6ej"/></g>`,
		"fallback": "iconmind:chart-heatmap-duotone-regular",
	});
}
