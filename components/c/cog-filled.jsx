...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<path class="es6gsb"/><path class="bqutxz ydovum"/><path class="prvkak ydovum"/><path class="hei83p ydovum"/><path class="v5gemm ydovum"/><path class="iyp6bw ydovum"/><path class="nxuu_a ydovum"/>`,
		"fallback": "line-md:cog-filled",
	});
}
