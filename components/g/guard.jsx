...
</style><path class="w-gmplbzv"/><path class="e8gedzito"/><g class="n1mjunbsu"><circle class="ed6fmyb9l"/><circle class="fqau1xbcn"/></g><g class="fbp0m0b1e"><path class="cm3wbab7c"/><circle class="h3w494vbn"/></g><circle class="lupbmxb8l"/><circle class="u6l8n6jdv"/><circle class="unarhpbhk"/><path class="x6nrrsbcx"/>`,
		"fallback": "emojione:guard",
	});
}
