...
</style><g class="hntgybcog"><path class="pywr_yykw"/><path class="m0hvambgh"/><path class="v4hdeje_n"/><path class="bje48wbgy"/></g>`,
		"fallback": "iconmind:partner-offer-outline-thin",
	});
}
