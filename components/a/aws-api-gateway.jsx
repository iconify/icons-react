...
</style><defs><linearGradient id="SVGyDrnJbhE" x1="0%" x2="100%" y1="100%" y2="0%"><stop offset="0%" class="i__ch2t6w"/><stop offset="100%" class="r7ikv4bnu"/></linearGradient></defs><path fill="url(#SVGyDrnJbhE)" class="tmbkaq7lv"/><path class="ceo1onb5e"/>`,
		"fallback": "logos:aws-api-gateway",
	});
}
