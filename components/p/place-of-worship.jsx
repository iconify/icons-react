...
</style><defs><path id="SVGot2GnbJt" class="xu2a0eeoq"/></defs><path class="dpvarpbiq"/><path class="q-_fbfbpi"/><use href="#SVGot2GnbJt" class="e0ty9gbgt"/><path class="wxcl08hvi"/><use href="#SVGot2GnbJt" class="pfsdhbbki"/><path class="x96f7yyhd"/><circle class="q7wbt2f6b"/>`,
		"fallback": "noto:place-of-worship",
	});
}
