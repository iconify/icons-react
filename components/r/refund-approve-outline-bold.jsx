...
</style><g class="s0phu2bbs"><path class="jd_dotbnq"/><path class="o7jy28bce"/><path class="cpsm-qevf"/><path class="myn7q3llc"/></g>`,
		"fallback": "iconmind:refund-approve-outline-bold",
	});
}
