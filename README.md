...
```bash
npm install github:iconify/icons-react#feather
```
...
```jsx
import SampleIcon from '@iconify-react/feather/check-circle';
...
```jsx
import SampleIcon from '@iconify-react/feather/award';
...
```jsx
import SampleIcon from '@iconify-react/feather/home';
