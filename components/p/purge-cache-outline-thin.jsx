...
</style><g class="hntgybcog"><path class="zp4rqbtqe"/><path class="ml5vh8o3m"/><path class="ngom1s3yg"/><path class="v7v_f9j5h"/></g>`,
		"fallback": "iconmind:purge-cache-outline-thin",
	});
}
