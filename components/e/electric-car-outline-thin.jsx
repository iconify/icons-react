...
</style><g class="hntgybcog"><path class="sqwju3bsh"/><path class="du3agkbjb"/><path class="fquh7rbnp"/><path class="lsv292bxl"/></g>`,
		"fallback": "iconmind:electric-car-outline-thin",
	});
}
