...
</style><g class="hntgybcog"><path class="okud9xj_d"/><path class="n-059ea3n"/><path class="olmwgycdy"/><path class="x1_r36phd"/></g>`,
		"fallback": "iconmind:memory-semantic-outline-thin",
	});
}
