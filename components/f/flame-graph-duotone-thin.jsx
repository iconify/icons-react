...
</style><g class="hntgybcog"><path class="mrnfg4bkt"/><path class="yxzri4b1c"/><path class="rc0rl8bwc"/><path class="yyb29bl_l"/><path class="zh3pv9siu"/><path class="oml_wvb5b"/></g>`,
		"fallback": "iconmind:flame-graph-duotone-thin",
	});
}
