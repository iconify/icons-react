...
</style><g class="hntgybcog"><path class="b0hkzgbgd"/><path class="wuk2mlziz"/><path class="iwjnwtbxd"/><path class="cta_b6xgu"/><path class="yvxn-ueef"/></g>`,
		"fallback": "iconmind:workspace-share-outline-thin",
	});
}
