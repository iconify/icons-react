...
Browse all icons: [preview Noto Emoji (v1) on Iconify](https://icon-sets.iconify.design/noto-v1/)

## Installation

```bash
npm install github:iconify/icons-react#noto-v1
```
...
```jsx
import SampleIcon from '@iconify-react/noto-v1/face-with-open-mouth';
...
```jsx
import SampleIcon from '@iconify-react/noto-v1/no-entry';
