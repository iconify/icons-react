...
</style><path class="nrplabgej"/><defs><path id="SVGKWyaFZun" class="myeaa8bof"/></defs><clipPath id="SVGJDYcnGqI"><use href="#SVGKWyaFZun"/></clipPath><g clip-path="url(#SVGJDYcnGqI)" class="byeg-0b8a"><path class="zkoo3518s"/></g><defs><use href="#SVGKWyaFZun" id="SVG6ObibegY"/></defs><clipPath id="SVGHoDwib4P"><use href="#SVG6ObibegY"/></clipPath><g clip-path="url(#SVGHoDwib4P)" class="lip7wrrrl"><path class="hi_dlcbdf"/></g>`,
		"fallback": "noto:backhand-index-pointing-left-medium-skin-tone",
	});
}
