...
</style><g class="hntgybcog"><path class="vyks9vbfn"/><path class="r7xk8o29f"/><path class="a7vpafiwa"/><path class="zwn7edcbm"/></g>`,
		"fallback": "iconmind:partition-table-outline-thin",
	});
}
