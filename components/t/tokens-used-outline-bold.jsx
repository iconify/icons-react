...
</style><g class="s0phu2bbs"><path class="nmu7_wbat"/><path class="a7vpafiwa"/><path class="n3p0zmbop"/><path class="zwn7edcbm"/></g>`,
		"fallback": "iconmind:tokens-used-outline-bold",
	});
}
