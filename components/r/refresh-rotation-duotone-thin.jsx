...
</style><g class="hntgybcog"><path class="n7c_b1bsn"/><path class="a218-cpca"/><path class="jippdzaqj"/><path class="p7ecc1bwl"/></g>`,
		"fallback": "iconmind:refresh-rotation-duotone-thin",
	});
}
