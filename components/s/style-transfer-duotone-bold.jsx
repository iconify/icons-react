...
</style><g class="s0phu2bbs"><path class="mzsthfbrb"/><path class="nzpsuduik"/><path class="e3qnmubmt"/><path class="n1_qdeb8t"/></g>`,
		"fallback": "iconmind:style-transfer-duotone-bold",
	});
}
