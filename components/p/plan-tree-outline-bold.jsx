...
</style><g class="s0phu2bbs"><path class="ffl_tubrp"/><path class="fl42iabgs"/><path class="s4opvo9pz"/><path class="siocq_7mf"/><path class="iic1bs66d"/></g>`,
		"fallback": "iconmind:plan-tree-outline-bold",
	});
}
