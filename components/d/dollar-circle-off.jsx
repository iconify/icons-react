...
function Component({width, height, ...props}) {
	return createElement(Icon, {
		...
		height,
		viewBox,
		"content": `<g class="cuyn6tgcc"><path clip-rule="evenodd" class="psv_8pbss"/><g clip-rule="evenodd" class="pr0chacef"><path class="krn98ygon"/><path class="kydpb1b4o"/><path class="f_-i_ry_m"/></g><path clip-rule="evenodd" class="k7pccuzxd"/><path clip-rule="evenodd" class="o5-822bcv"/><path clip-rule="evenodd" class="jkbahmb3n"/><path class="zsuclwbnx"/><path clip-rule="evenodd" class="kspoj7vnd"/></g>`,
		"fallback": "pepicons-print:dollar-circle-off",
	});
}
