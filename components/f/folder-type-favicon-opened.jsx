...
</style><path class="csyfxks9z"/><circle class="fi_zd0r9l"/><circle class="gg2gvfbwf"/><path class="lw9ofs1oy"/>`,
		"fallback": "vscode-icons:folder-type-favicon-opened",
	});
}
